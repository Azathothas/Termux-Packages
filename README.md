...
| **artalk** | 2.8.6-1 | A self-hosted comment system | https://artalk.js.org/ |
...
| **command-not-found** | 2.4.0-29 | Suggest installation of packages in interactive shell sessions | https://github.com/termux/command-not-found |
...
| **libzim** | 9.2.1 | The ZIM library is the reference implementation for the ZIM file format. | https://openzim.org |
...
| **neovim** | 0.10.0 | Ambitious Vim-fork focused on extensibility and agility (nvim) | https://neovim.io/ |
...
| **newsboat** | 2.35 | RSS/Atom feed reader for the text console | https://newsboat.org/ |
...
| **qemu-common** | 1:8.2.5-1 | A set common files used by the QEMU emulators | https://www.qemu.org |
| **qemu-system-aarch64-headless** | 1:8.2.5-1 | A generic and open source machine emulator and virtualizer (headless) | https://www.qemu.org |
| **qemu-system-arm-headless** | 1:8.2.5-1 | A generic and open source machine emulator and virtualizer (headless) | https://www.qemu.org |
| **qemu-system-i386-headless** | 1:8.2.5-1 | A generic and open source machine emulator and virtualizer (headless) | https://www.qemu.org |
| **qemu-system-m68k-headless** | 1:8.2.5-1 | A generic and open source machine emulator and virtualizer (headless) | https://www.qemu.org |
| **qemu-system-ppc-headless** | 1:8.2.5-1 | A generic and open source machine emulator and virtualizer (headless) | https://www.qemu.org |
| **qemu-system-ppc64-headless** | 1:8.2.5-1 | A generic and open source machine emulator and virtualizer (headless) | https://www.qemu.org |
| **qemu-system-riscv32-headless** | 1:8.2.5-1 | A generic and open source machine emulator and virtualizer (headless) | https://www.qemu.org |
| **qemu-system-riscv64-headless** | 1:8.2.5-1 | A generic and open source machine emulator and virtualizer (headless) | https://www.qemu.org |
| **qemu-system-x86-64-headless** | 1:8.2.5-1 | A generic and open source machine emulator and virtualizer (headless) | https://www.qemu.org |
| **qemu-system-x86-64-headless-static** | 1:8.2.5-1 | Static libraries for qemu-system-x86-64-headless | https://www.qemu.org |
| **qemu-user-aarch64** | 1:8.2.5-1 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-user-arm** | 1:8.2.5-1 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-user-i386** | 1:8.2.5-1 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-user-m68k** | 1:8.2.5-1 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-user-ppc** | 1:8.2.5-1 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-user-ppc64** | 1:8.2.5-1 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-user-riscv32** | 1:8.2.5-1 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-user-riscv64** | 1:8.2.5-1 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-user-x86-64** | 1:8.2.5-1 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-utils** | 1:8.2.5-1 | A set of utilities for working with the QEMU emulators | https://www.qemu.org |
...
| **texlab** | 5.16.1 | A cross-platform implementation of the Language Server Protocol providing rich cross-editing support for the LaTeX typesetting system | https://texlab.netlify.app/ |
