...
| **libunbound** | 1.21.1 | A validating, recursive, caching DNS resolver | https://unbound.net/ |
| **libunbound-static** | 1.21.1 | Static libraries for libunbound | https://unbound.net/ |
...
| **python-grpcio** | 1.66.2 | High performance, open source, general RPC framework that puts mobile and HTTP/2 first | https://grpc.io/ |
...
| **python-pyarrow** | 17.0.0-2 | Python bindings for Apache Arrow | https://github.com/apache/arrow |
...
| **pyunbound** | 1.21.1 | Python bindings for Unbound | https://unbound.net/ |
...
| **unbound** | 1.21.1 | Unbound command-line tools | https://unbound.net/ |
