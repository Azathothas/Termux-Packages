...
| **command-not-found** | 2.4.0-62 | Suggest installation of packages in interactive shell sessions | https://github.com/termux/command-not-found |
...
| **python-numpy** | 2.2.2 | The fundamental package for scientific computing with Python | https://numpy.org/ |
| **python-numpy-static** | 2.2.2 | Static libraries for python-numpy | https://numpy.org/ |
