...
| **sheldon** | 0.8.0-1 | Fast, configurable, shell plugin manager | https://github.com/rossmacarthur/sheldon |
...
| **toml11** | 4.3.0 | toml11 is a C++11 (or later) header-only toml parser/encoder depending only on C++ standard library | https://github.com/ToruNiina/toml11 |
...
| **yazi** | 25.2.7 | Blazing fast terminal file manager written in Rust, based on async I/O | https://yazi-rs.github.io/ |
