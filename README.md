...
| **algernon** | 1.17.0 | Small self-contained web server with Lua, Markdown, QUIC, Redis and PostgreSQL support | https://algernon.roboticoverlords.org/ |
...
| **broot** | 1.39.1 | A better way to navigate directories | https://github.com/Canop/broot |
...
| **command-not-found** | 2.4.0-31 | Suggest installation of packages in interactive shell sessions | https://github.com/termux/command-not-found |
...
| **emscripten** | 3.1.62 | Emscripten: An LLVM-to-WebAssembly Compiler | https://emscripten.org |
| **emscripten-binaryen** | 3.1.62 | Emscripten-compatible Binaryen | https://emscripten.org |
| **emscripten-llvm** | 3.1.62 | Emscripten-compatible LLVM | https://emscripten.org |
| **emscripten-tests-third-party** | 3.1.62 | Emscripten third party test suite files | https://emscripten.org |
...
| **fastfetch** | 2.17.2 | A neofetch-like tool for fetching system information and displaying them in a pretty way | https://github.com/fastfetch-cli/fastfetch |
...
| **geth** | 1.14.6 | Go implementation of the Ethereum protocol | https://geth.ethereum.org/ |
| **geth-utils** | 1.14.6 | Additional utilities for Geth (like abigen, bootnode, evm, puppeth) | https://geth.ethereum.org/ |
...
| **kcptun** | 20240706 | A Stable & Secure Tunnel based on KCP with N:M multiplexing and FEC | https://github.com/xtaci/kcptun |
...
| **libxml2** | 2.13.2 | Library for parsing XML documents | http://www.xmlsoft.org |
| **libxml2-python** | 2.13.2 | Python bindings for libxml2 | http://www.xmlsoft.org |
| **libxml2-python-static** | 2.13.2 | Static libraries for libxml2-python | http://www.xmlsoft.org |
| **libxml2-static** | 2.13.2 | Static libraries for libxml2 | http://www.xmlsoft.org |
| **libxml2-utils** | 2.13.2 | XML utilities | http://www.xmlsoft.org |
...
| **oh-my-posh** | 21.21.1 | A prompt theme engine for any shell. | https://ohmyposh.dev |
...
| **openssh** | 9.8p1-3 | Secure shell for logging into a remote machine | https://www.openssh.com/ |
| **openssh-sftp-server** | 9.8p1-3 | OpenSSH SFTP server subsystem | https://www.openssh.com/ |
...
| **pocketbase** | 0.22.16 | An open source Go backend | https://github.com/pocketbase/pocketbase |
...
| **proot-distro** | 4.15.0 | Termux official utility for managing proot'ed Linux distributions | https://github.com/termux/proot-distro |
...
| **texlab** | 5.18.0 | A cross-platform implementation of the Language Server Protocol providing rich cross-editing support for the LaTeX typesetting system | https://texlab.netlify.app/ |
...
| **vtm** | 0.9.85 | Terminal multiplexer with TUI window manager and multi-party session sharing | https://vtm.netxs.online/ |
