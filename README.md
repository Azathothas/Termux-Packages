...
| **gst-libav** | 1.24.4 | GStreamer Libav plug-in contains one plugin with a set of elements using the Libav library code | https://gstreamer.freedesktop.org/modules/gst-libav.html |
...
| **neocmakelsp** | 0.7.4 | a cmake lsp based on tower-lsp and treesitter | https://github.com/Decodetalkers/neocmakelsp |
...
| **oh-my-posh** | 21.14.0 | A prompt theme engine for any shell. | https://ohmyposh.dev |
...
| **rbw** | 1.10.2 | An unofficial command line client for Bitwarden | https://github.com/doy/rbw |
...
| **ruff** | 0.4.9 | An extremely fast Python linter, written in Rust | https://github.com/charliermarsh/ruff |
...
| **sensible-utils** | 0.0.22 | Small utilities used by programs to sensibly select and spawn an appropriate browser, editor, or pager | https://packages.debian.org/sid/sensible-utils |
...
| **tdl** | 0.17.1 | Telegram downloader/tools written in Golang | https://docs.iyear.me/tdl/ |
