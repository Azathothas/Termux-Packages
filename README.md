...
| **neocmakelsp** | 0.8.13 | a cmake lsp based on tower-lsp and treesitter | https://github.com/Decodetalkers/neocmakelsp |
...
| **teleport-tsh** | 17.1.0 | Secure Access for Developers that doesn't get in the way | https://github.com/gravitational/teleport |
...
| **uv** | 0.5.10 | An extremely fast Python package installer and resolver, written in Rust. | https://docs.astral.sh/uv/ |
