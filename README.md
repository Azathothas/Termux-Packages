...
| **buf** | 1.46.0 | A new way of working with Protocol Buffers | https://buf.build |
...
| **curl** | 8.11.0 | Command line tool for transferring data with URL syntax | https://curl.se/ |
...
| **eza** | 0.20.7 | A modern replacement for ls | https://github.com/eza-community/eza |
...
| **fetchmail** | 6.5.0 | A remote-mail retrieval utility | https://www.fetchmail.info/ |
| **fetchmailconf** | 6.5.0 | A GUI configurator for generating fetchmail configuration files | https://www.fetchmail.info/ |
...
| **fzf** | 0.56.1 | Command-line fuzzy finder | https://junegunn.github.io/fzf/ |
...
| **gh** | 2.61.0 | GitHub’s official command line tool | https://cli.github.com/ |
...
| **jfrog-cli** | 2.71.3 | A CLI for JFrog products | https://jfrog.com/getcli |
...
| **libcurl** | 8.11.0 | Easy-to-use client-side URL transfer library | https://curl.se/ |
| **libcurl-static** | 8.11.0 | Static libraries for libcurl | https://curl.se/ |
...
| **libgrpc** | 1.67.1 | High performance, open source, general RPC framework that puts mobile and HTTP/2 first | https://grpc.io/ |
...
| **libheif** | 1.19.2 | HEIF (HEIC/AVIF) image encoding and decoding library | https://github.com/strukturag/libheif |
| **libheif-progs** | 1.19.2 | Programs for manipulating HEIF (HEIC/AVIF) image files | https://github.com/strukturag/libheif |
...
| **libllvm** | 19.1.3 | Modular compiler and toolchain technologies library | https://clang.llvm.org/ |
| **libllvm-static** | 19.1.3 | Static libraries for libllvm | https://clang.llvm.org/ |
...
| **libnss** | 3.106 | Network Security Services (NSS) | https://firefox-source-docs.mozilla.org/security/nss/ |
...
| **libpolly** | 19.1.3 | High-level loop and data-locality optimizer for clang | https://clang.llvm.org/ |
...
| **libvpx** | 1:1.15.0 | VP8 & VP9 Codec SDK | https://www.webmproject.org |
| **libvpx-static** | 1:1.15.0 | Static libraries for libvpx | https://www.webmproject.org |
...
| **libwayland** | 1.23.1 | Wayland protocol library | https://wayland.freedesktop.org/ |
| **libwayland-cross-scanner** | 1.23.1 | wayland-scanner for host (NOT for Termux) | https://wayland.freedesktop.org/ |
...
| **llvm-tools** | 19.1.3 | LLVM Development Tools | https://clang.llvm.org/ |
| **llvmgold** | 19.1.3 | LLVM gold plugin | https://clang.llvm.org/ |
...
| **lua-language-server** | 3.12.0 | Sumneko Lua Language Server coded in Lua | https://github.com/sumneko/lua-language-server |
...
| **luvi** | 20241009 | A project in-between luv and luvit. | https://luvit.io |
...
| **mariadb** | 2:11.5.2-2 | A drop-in replacement for mysql server | https://mariadb.org |
| **mariadb-static** | 2:11.5.2-2 | Static libraries for mariadb | https://mariadb.org |
...
| **mdbook** | 0.4.42 | Creates book from markdown files | https://rust-lang.github.io/mdBook/ |
...
| **mesa** | 24.2.6 | An open-source implementation of the OpenGL specification | https://www.mesa3d.org |
| **mesa-dev** | 24.2.6 | Mesa's OpenGL headers | https://www.mesa3d.org |
| **mesa-vulkan-icd-swrast** | 24.2.6 | Mesa's Swrast Vulkan ICD | https://www.mesa3d.org |
...
| **mlir** | 19.1.3 | A Multi-Level Intermediate Representation for compilers from LLVM | https://clang.llvm.org/ |
...
| **music-file-organizer** | 1.0.4-4 | Organizer of audio files into directories based on metadata tags | https://git.zx2c4.com/music-file-organizer/about/ |
...
| **mympd** | 18.2.0 | A standalone and lightweight web-based MPD client | https://jcorporation.github.io/myMPD/ |
...
| **nlopt** | 2.9.0 | Library for nonlinear optimization | https://nlopt.readthedocs.io/ |
...
| **nss-utils** | 3.106 | Tools for NSS | https://firefox-source-docs.mozilla.org/security/nss/ |
...
| **oh-my-posh** | 24.2.2 | A prompt theme engine for any shell. | https://ohmyposh.dev |
...
| **osmesa** | 24.2.6 | Mesa Off-screen Rendering Library | https://www.mesa3d.org |
...
| **pocketbase** | 0.22.23 | An open source Go backend | https://github.com/pocketbase/pocketbase |
...
| **python-grpcio** | 1.67.1 | High performance, open source, general RPC framework that puts mobile and HTTP/2 first | https://grpc.io/ |
...
| **python-pyarrow** | 18.0.0 | Python bindings for Apache Arrow | https://github.com/apache/arrow |
...
| **ruff** | 0.7.3 | An extremely fast Python linter, written in Rust | https://github.com/charliermarsh/ruff |
...
| **rush** | 0.5.7 | A cross-platform command-line tool for executing jobs in parallel | https://github.com/shenwei356/rush |
| **rust** | 1.82.0 | Systems programming language focused on safety, speed and concurrency | https://www.rust-lang.org/ |
| **rust-analyzer** | 20241104 | A Rust compiler front-end for IDEs | https://github.com/rust-lang/rust-analyzer |
...
| **seafile-client** | 9.0.9 | Seafile is a file syncing and sharing software with file encryption and group sharing | https://seafile.com |
| **seafile-client-static** | 9.0.9 | Static libraries for seafile-client | https://seafile.com |
| **seanime** | 2.2.2 | Self-hosted anime and manga server for sea rovers. | https://github.com/5rahim/seanime |
...
| **step-cli** | 0.28.0 | An easy-to-use CLI tool for building, operating, and automating Public Key Infrastructure (PKI) systems and workflows | https://smallstep.com/cli |
...
| **termux-tools** | 1.44.3 | Basic system tools for Termux | https://termux.dev/ |
| **teseq** | 1.1.1-1 | Tool for analyzing control characters and terminal control sequences | https://www.gnu.org/software/teseq/ |
| **tesseract** | 5.5.0 | Tesseract is probably the most accurate open source OCR engine available | https://github.com/tesseract-ocr/tesseract |
...
| **ugrep** | 7.0.2 | A faster, user-friendly and compatible grep replacement | https://github.com/Genivia/ugrep |
...
| **uv** | 0.5.1 | An extremely fast Python package installer and resolver, written in Rust. | https://docs.astral.sh/uv/ |
...
| **vulkan-tools** | 1.3.301 | Vulkan Tools and Utilities | https://github.com/KhronosGroup/Vulkan-Tools |
| **vulkan-utility-libraries** | 1.3.301 | Utility Libraries for Vulkan | https://github.com/KhronosGroup/Vulkan-Utility-Libraries |
