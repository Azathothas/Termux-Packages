...
| **broot** | 1.41.0 | A better way to navigate directories | https://github.com/Canop/broot |
...
| **i2pd** | 2.53.0 | A full-featured C++ implementation of the I2P router | https://i2pd.website/ |
| **i2pd-static** | 2.53.0 | Static libraries for i2pd | https://i2pd.website/ |
...
| **libdeflate** | 1.20 | C library for fast compression and decompression | https://github.com/ebiggers/libdeflate |
| **libdeflate-static** | 1.20 | Static libraries for libdeflate | https://github.com/ebiggers/libdeflate |
...
| **libimagequant** | 4.3.1 | Small, portable C library for high-quality conversion of RGBA images to 8-bit indexed-color (palette) images | https://pngquant.org/lib/ |
| **libimagequant-static** | 4.3.1 | Static libraries for libimagequant | https://pngquant.org/lib/ |
...
| **oh-my-posh** | 23.4.0 | A prompt theme engine for any shell. | https://ohmyposh.dev |
