...
| **apt** | 2.7.14-1 | Front-end for the dpkg package manager | https://packages.debian.org/apt |
| **apt-file** | 3.3 | search for files within packages | https://wiki.debian.org/apt-file |
| **apt-ftparchive** | 2.7.14-1 | apt-ftparchive is the command line tool that generates the index files that APT uses to access a distribution source | https://packages.debian.org/apt |
| **apt-transport-tor** | 2.7.14-1 | APT transport for anonymous package downloads via Tor | https://packages.debian.org/apt |
...
| **await** | 1.0.3 | Runs list of commands in parallel and waits for their termination | https://await-cli.app/ |
...
| **command-not-found** | 2.4.0-35 | Suggest installation of packages in interactive shell sessions | https://github.com/termux/command-not-found |
...
| **neocmakelsp** | 0.7.9 | a cmake lsp based on tower-lsp and treesitter | https://github.com/Decodetalkers/neocmakelsp |
...
| **ttyplot** | 1.6.5 | A realtime plotting utility for terminal with data input from stdin | https://github.com/tenox7/ttyplot |
