...
| **ruff** | 0.9.0 | An extremely fast Python linter, written in Rust | https://github.com/charliermarsh/ruff |
...
| **simdjson** | 3.11.5 | A C++ library to see how fast we can parse JSON with complete validation | https://simdjson.org/ |
