...
| **agate** | 3.3.9 | Very simple server for the Gemini hypertext protocol | https://github.com/mbrubeck/agate |
...
| **aichat** | 0.22.0 | A powerful chatgpt cli | https://github.com/sigoden/aichat |
...
| **alsa-utils-static** | 1.2.12 | Static libraries for alsa-utils | https://www.alsa-project.org |
...
| **await** | 1.0.5 | Runs list of commands in parallel and waits for their termination | https://await-cli.app/ |
...
| **buf** | 1.45.0 | A new way of working with Protocol Buffers | https://buf.build |
...
| **c-ares** | 1.34.2 | Library for asynchronous DNS requests (including name resolves) | https://c-ares.haxx.se |
...
| **chafa** | 1.14.4-1 | Image-to-text converter supporting a wide range of symbols, etc. | https://hpjansson.org/chafa/ |
...
| **clang** | 19.1.2 | C language frontend for LLVM | https://clang.llvm.org/ |
...
| **clvk** | 0.0.20241021.225108 | Experimental implementation of OpenCL on Vulkan | https://github.com/kpet/clvk |
| **cmake** | 3.30.5 | Family of tools designed to build, test and package software | https://cmake.org/ |
| **cmake-curses-gui** | 3.30.5 | Curses based user interface for CMake (ccmake) | https://cmake.org/ |
...
| **cmus** | 2.11.0-1 | Small, fast and powerful console music player | https://cmus.github.io/ |
...
| **command-not-found** | 2.4.0-47 | Suggest installation of packages in interactive shell sessions | https://github.com/termux/command-not-found |
| **composer** | 2.8.1 | Dependency Manager for PHP | https://getcomposer.org/ |
...
| **cppcheck** | 2.15.0 | tool for static C/C++ code analysis | https://github.com/danmar/cppcheck |
...
| **curl** | 8.10.1-1 | Command line tool for transferring data with URL syntax | https://curl.se/ |
...
| **difftastic** | 0.60.0 | difft: A structural diff that understands syntax | https://github.com/Wilfred/difftastic |
...
| **dropbear** | 2024.85 | Small SSH server and client | https://matt.ucc.asn.au/dropbear/dropbear.html |
| **dtach** | 0.9 | Emulates the detach feature of screen | http://dtach.sourceforge.net/ |
| **dtc** | 1.7.1 | Device Tree Compiler | https://git.kernel.org/pub/scm/utils/dtc/dtc |
| **dtc-static** | 1.7.1 | Static libraries for dtc | https://git.kernel.org/pub/scm/utils/dtc/dtc |
| **dte** | 1.11.1-1 | A small, configurable console text editor | https://craigbarnes.gitlab.io/dte/ |
| **dua** | 2.29.2 | View disk space usage and delete unwanted data, fast | https://github.com/Byron/dua-cli |
| **duc** | 1.4.5 | High-performance disk usage analyzer | http://duc.zevv.nl/ |
| **duckdb** | 1.1.2 | DuckDB Command Line Interface (CLI) shell | https://duckdb.org/ |
| **duf** | 0.8.1-3 | Disk usage/free utility | https://github.com/muesli/duf |
| **dufs** | 0.42.0 | A file server that supports static serving, uploading, searching, accessing control, webdav... | https://github.com/sigoden/dufs |
...
| **electrum** | 4.5.7 | Electrum is a lightweight Bitcoin wallet | https://electrum.org |
...
| **emscripten** | 3.1.69 | Emscripten: An LLVM-to-WebAssembly Compiler | https://emscripten.org |
| **emscripten-binaryen** | 3.1.69 | Emscripten-compatible Binaryen | https://emscripten.org |
| **emscripten-llvm** | 3.1.69 | Emscripten-compatible LLVM | https://emscripten.org |
| **emscripten-tests-third-party** | 3.1.69 | Emscripten third party test suite files | https://emscripten.org |
...
| **exiftool** | 12.99 | Utility for reading, writing and editing meta information in a wide variety of files. | https://exiftool.org/ |
...
| **eza** | 0.20.4 | A modern replacement for ls | https://github.com/eza-community/eza |
...
| **fastfetch** | 2.28.0 | A neofetch-like tool for fetching system information and displaying them in a pretty way | https://github.com/fastfetch-cli/fastfetch |
...
| **fdisk** | 2.40.2-1 | Utilities to manipulate disk partition tables | https://en.wikipedia.org/wiki/Util-linux |
...
| **fluidsynth** | 2.3.7 | Software synthesizer based on the SoundFont 2 specifications | https://github.com/FluidSynth/fluidsynth |
...
| **forgejo** | 9.0.0 | Forgejo is a self-hosted lightweight software forge. | https://forgejo.org/ |
...
| **fzf** | 0.55.0 | Command-line fuzzy finder | https://junegunn.github.io/fzf/ |
| **fzy** | 1.0 | A simple, fast fuzzy finder for the terminal | https://github.com/jhawthorn/fzy |
| **g-ir-scanner** | 1.80.1-1 | A tool which generates GIR XML files | https://gi.readthedocs.io/ |
...
| **go-musicfox** | 4.5.5 | A netease music player in terminal. | https://github.com/go-musicfox/go-musicfox |
...
| **gobject-introspection** | 1.80.1-1 | Uniform machine readable API | https://gi.readthedocs.io/ |
...
| **gpgme** | 1.23.2-3 | Library designed to make access to GnuPG easier | https://www.gnupg.org/related_software/gpgme/ |
| **gpgme-static** | 1.23.2-3 | Static libraries for gpgme | https://www.gnupg.org/related_software/gpgme/ |
| **gpgmepp** | 1.23.2-3 | Programmatic C++ library interface to GnuPG | https://www.gnupg.org/related_software/gpgme/ |
| **gpgmepp-static** | 1.23.2-3 | Static libraries for gpgmepp | https://www.gnupg.org/related_software/gpgme/ |
...
| **grafana** | 1:11.2.2 | The open-source platform for monitoring and observability | https://grafana.com/ |
...
| **graphviz** | 12.1.2 | Rich set of graph drawing tools | https://www.graphviz.org/ |
| **graphviz-static** | 12.1.2 | Static libraries for graphviz | https://www.graphviz.org/ |
...
| **gst-plugins-bad** | 1.24.8 | GStreamer Bad Plug-ins | https://gstreamer.freedesktop.org/ |
| **gst-plugins-base** | 1.24.8 | GStreamer base plug-ins | https://gstreamer.freedesktop.org/ |
| **gst-plugins-gl-headers** | 1.24.8 | OpenGL headers for GStreamer plugins | https://gstreamer.freedesktop.org/ |
| **gst-plugins-good** | 1.24.8 | GStreamer Good Plug-ins | https://gstreamer.freedesktop.org/ |
| **gst-plugins-ugly** | 1.24.8 | GStreamer Ugly Plug-ins | https://gstreamer.freedesktop.org/ |
| **gst-python** | 1.24.8-1 | Python bindings for GStreamer | https://gstreamer.freedesktop.org/ |
| **gstreamer** | 1.24.8 | Open source multimedia framework | https://gstreamer.freedesktop.org/ |
...
| **haproxy** | 3.0.5 | The Reliable, High Performance TCP/HTTP Load Balancer | https://www.haproxy.org/ |
| **harfbuzz** | 10.0.1 | OpenType text shaping engine | https://www.freedesktop.org/wiki/Software/HarfBuzz/ |
| **harfbuzz-icu** | 10.0.1 | OpenType text shaping engine ICU backend | https://www.freedesktop.org/wiki/Software/HarfBuzz/ |
| **harfbuzz-utils** | 10.0.1 | Tools using the harfbuzz library | https://www.freedesktop.org/wiki/Software/HarfBuzz/ |
...
| **hcloud** | 1.47.0 | Hetzner Cloud command line client | https://github.com/hetznercloud/cli |
...
| **helm** | 3.16.2 | Helm helps you manage Kubernetes applications | https://helm.sh |
...
| **hugo** | 0.136.4 | A fast and flexible static site generator | https://gohugo.io/ |
...
| **imagemagick** | 7.1.1.39 | Suite to create, edit, compose, or convert images in a variety of formats | https://www.imagemagick.org/ |
| **imagemagick-static** | 7.1.1.39 | Static libraries for imagemagick | https://www.imagemagick.org/ |
...
| **inetutils** | 2.4-2 | Collection of common network programs | https://www.gnu.org/software/inetutils/ |
...
| **ipfs** | 0.31.0 | A peer-to-peer hypermedia distribution protocol | https://ipfs.io/ |
...
| **jp2a** | 1.3.1 | A simple JPEG to ASCII converter | https://github.com/Talinx/jp2a/ |
...
| **jq-lsp** | 0.1.4 | jq language server | https://github.com/wader/jq-lsp |
| **jq-static** | 1.7.1 | Static libraries for jq | https://stedolan.github.io/jq/ |
| **jql** | 7.2.0 | A JSON Query Language CLI tool | https://github.com/yamafaktory/jql |
...
| **kakoune-lsp** | 18.0.2 | Language Server Protocol Client for the Kakoune editor | https://github.com/kakoune-lsp/kakoune-lsp |
| **kbd** | 2.6.4 | KBD's showkey utility for examining keycodes | https://kbd-project.org/ |
| **kcptun** | 20240919 | A Stable & Secure Tunnel based on KCP with N:M multiplexing and FEC | https://github.com/xtaci/kcptun |
...
| **kubelogin** | 1.30.1 | A kubectl plugin for Kubernetes OpenID Connect (OIDC) authentication | https://github.com/int128/kubelogin |
...
| **libblkid** | 2.40.2-1 | Block device identification library | https://en.wikipedia.org/wiki/Util-linux |
...
| **libcompiler-rt** | 19.1.2 | Compiler runtime libraries for clang | https://clang.llvm.org/ |
...
| **libcurl** | 8.10.1-1 | Easy-to-use client-side URL transfer library | https://curl.se/ |
| **libcurl-static** | 8.10.1-1 | Static libraries for libcurl | https://curl.se/ |
...
| **libduckdb** | 1.1.2 | An in-process SQL OLAP database management system | https://duckdb.org/ |
| **libduckdb-static** | 1.1.2 | Static libraries for libduckdb | https://duckdb.org/ |
...
| **libexpat** | 2.6.3 | XML parsing C library | https://libexpat.github.io/ |
| **libexpat-static** | 2.6.3 | Static libraries for libexpat | https://libexpat.github.io/ |
...
| **libfdisk** | 2.40.2-1 | Library for manipulating disk partition tables | https://en.wikipedia.org/wiki/Util-linux |
...
| **libgit2** | 1.8.2 | C library implementing Git core methods | https://libgit2.github.com/ |
| **libglibmm-2.4** | 2.66.7 | A C++ API for parts of glib that are useful for C++ | https://www.gtkmm.org/ |
| **libglibmm-2.68** | 2.80.0 | A C++ API for parts of glib that are useful for C++ | https://www.gtkmm.org/ |
...
| **libgnustep-base** | 1.30.0 | A library of general-purpose, non-graphical Objective C objects | http://www.gnustep.org |
...
| **libgrpc** | 1.67.0 | High performance, open source, general RPC framework that puts mobile and HTTP/2 first | https://grpc.io/ |
...
| **libheif** | 1.18.2 | HEIF (HEIC/AVIF) image encoding and decoding library | https://github.com/strukturag/libheif |
| **libheif-progs** | 1.18.2 | Programs for manipulating HEIF (HEIC/AVIF) image files | https://github.com/strukturag/libheif |
...
| **libicu** | 75.1 | International Components for Unicode library | http://site.icu-project.org/home |
| **libicu-static** | 75.1 | Static libraries for libicu | http://site.icu-project.org/home |
...
| **libllvm** | 19.1.2 | Modular compiler and toolchain technologies library | https://clang.llvm.org/ |
| **libllvm-static** | 19.1.2 | Static libraries for libllvm | https://clang.llvm.org/ |
...
| **libltdl** | 2.5.3 | Library for dlopening libraries | https://www.gnu.org/software/libtool/ |
...
| **libluajit** | 1:2.1.1727870382 | Just-In-Time Compiler for Lua | https://luajit.org/ |
| **libluajit-static** | 1:2.1.1727870382 | Static libraries for libluajit | https://luajit.org/ |
...
| **libmatio** | 1.5.27 | A C library for reading and writing Matlab MAT files | https://github.com/tbeu/matio |
...
| **libmount** | 2.40.2-1 | Library for (un)mounting filesystems | https://en.wikipedia.org/wiki/Util-linux |
...
| **libmsgpack-cxx** | 6.1.1 | msgpack for C++ | https://msgpack.org/ |
| **libmsgpack-static** | 6.1.0 | Static libraries for libmsgpack | https://github.com/msgpack/msgpack-c/ |
| **libmuparser** | 2.3.4-1 | An extensible high performance math expression parser library written in C++ | https://beltoforion.de/en/muparser |
...
| **libnats-c** | 3.9.1 | A C client for the NATS messaging system | https://nats-io.github.io/nats.c/ |
| **libnats-c-static** | 3.9.1 | Static libraries for libnats-c | https://nats-io.github.io/nats.c/ |
...
| **libnfs** | 5.0.3 | NFS client library | https://github.com/sahlberg/libnfs |
...
| **libnl-static** | 3.10.0 | Static libraries for libnl | https://github.com/thom311/libnl |
...
| **libnss** | 3.105 | Network Security Services (NSS) | https://firefox-source-docs.mozilla.org/security/nss/ |
...
| **libopenmpt** | 0.7.10 | OpenMPT based module player library and libopenmpt based command-line player | https://lib.openmpt.org/libopenmpt/ |
| **libopenmpt-static** | 0.7.10 | Static libraries for libopenmpt | https://lib.openmpt.org/libopenmpt/ |
...
| **libpixman** | 0.43.4 | Low-level library for pixel manipulation | http://www.pixman.org/ |
...
| **libpluto** | 0.9.5 | Shared library for the Pluto interpreter | https://plutolang.github.io/ |
| **libpluto-static** | 0.9.5 | Static libraries for libpluto | https://plutolang.github.io/ |
...
| **libpolly** | 19.1.2 | High-level loop and data-locality optimizer for clang | https://clang.llvm.org/ |
...
| **libraptor2** | 2.0.16-5 | RDF Syntax Library | https://librdf.org/raptor/ |
| **libraptor2-static** | 2.0.16-5 | Static libraries for libraptor2 | https://librdf.org/raptor/ |
...
| **librsvg** | 2.58.3 | Library to render SVG files using cairo | https://wiki.gnome.org/action/show/Projects/LibRsvg |
...
| **libseat** | 0.9.0 | Reference implementation of a wayland compositor | https://sr.ht/~kennylevinsen/seatd/ |
...
| **libsecp256k1** | 1:0.5.1 | Optimized c library for ECDSA signatures and seret/public key operations on curve secp256k1 | https://github.com/bitcoin-core/secp256k1 |
| **libsecp256k1-static** | 1:0.5.1 | Static libraries for libsecp256k1 | https://github.com/bitcoin-core/secp256k1 |
...
| **libsmartcols** | 2.40.2-1 | Library for smart adaptive formatting of tabular data | https://en.wikipedia.org/wiki/Util-linux |
...
| **libspdlog** | 1.14.1-1 | Very fast, header-only/compiled, C++ logging library | https://github.com/gabime/spdlog |
...
| **libtbb** | 2021.13.0 | oneAPI Threading Building Blocks | https://oneapi-src.github.io/oneTBB/ |
...
| **libtool** | 2.5.3 | Generic library support script hiding the complexity of using shared libraries behind a consistent, portable interface | https://www.gnu.org/software/libtool/ |
...
| **libusb** | 1.0.27 | A C library that provides generic access to USB devices | https://libusb.info/ |
| **libusb-static** | 1.0.27 | Static libraries for libusb | https://libusb.info/ |
| **libusbmuxd** | 2.0.2-p20230430-1 | A client library for applications to handle usbmux protocol connections with iOS devices | https://libimobiledevice.org |
| **libusbmuxd-static** | 2.0.2-p20230430-1 | Static libraries for libusbmuxd | https://libimobiledevice.org |
...
| **libvips** | 8.15.5 | A fast image processing library with low memory needs | https://libvips.github.io/libvips/ |
...
| **libvpx** | 1:1.14.1 | VP8 & VP9 Codec SDK | https://www.webmproject.org |
| **libvpx-static** | 1:1.14.1 | Static libraries for libvpx | https://www.webmproject.org |
...
| **libxapian** | 1.4.26 | Xapian search engine library | https://xapian.org |
| **libxapian-static** | 1.4.26 | Static libraries for libxapian | https://xapian.org |
...
| **libxml2** | 2.13.4-1 | Library for parsing XML documents | http://www.xmlsoft.org |
| **libxml2-python** | 2.13.4-1 | Python bindings for libxml2 | http://www.xmlsoft.org |
| **libxml2-python-static** | 2.13.4-1 | Static libraries for libxml2-python | http://www.xmlsoft.org |
| **libxml2-static** | 2.13.4-1 | Static libraries for libxml2 | http://www.xmlsoft.org |
| **libxml2-utils** | 2.13.4-1 | XML utilities | http://www.xmlsoft.org |
...
| **libzip** | 1.11.1 | Library for reading, creating, and modifying zip archives | https://libzip.org/ |
...
| **lld** | 19.1.2 | LLVM-based linker | https://clang.llvm.org/ |
| **llvm** | 19.1.2 | LLVM modular compiler and toolchain executables | https://clang.llvm.org/ |
...
| **llvm-tools** | 19.1.2 | LLVM Development Tools | https://clang.llvm.org/ |
| **llvmgold** | 19.1.2 | LLVM gold plugin | https://clang.llvm.org/ |
...
| **lowdown** | 1.1.2 | Markdown utilities and library (fork of hoedown -> sundown -> libsoldout) | https://kristaps.bsd.lv/lowdown |
| **lowdown-static** | 1.1.2 | Static libraries for lowdown | https://kristaps.bsd.lv/lowdown |
...
| **lua-language-server** | 3.11.1 | Sumneko Lua Language Server coded in Lua | https://github.com/sumneko/lua-language-server |
...
| **luajit** | 1:2.1.1727870382 | Just-In-Time compiler for Lua - command line tool | https://luajit.org/ |
...
| **luvi** | 20240723 | A project in-between luv and luvit. | https://luvit.io |
...
| **lychee** | 0.16.1 | A fast, async, resource-friendly link checker written in Rust | https://github.com/lycheeverse/lychee |
...
| **mautrix-whatsapp** | 0.11.0 | A Matrix-WhatsApp puppeting bridge | https://maunium.net/go/mautrix-whatsapp/ |
...
| **mdbook-katex** | 0.9.0-1 | A preprocessor for mdBook, pre-rendering LaTex equations to HTML at build time | https://github.com/lzanini/mdbook-katex |
...
| **mdbook-pikchr** | 0.1.8 | A mdbook preprocessor to render pikchr code blocks as images in your book | https://github.com/podsvirov/mdbook-pikchr |
...
| **memcached** | 1.6.32 | Free & open source, high-performance, distributed memory object caching system | https://memcached.org/ |
...
| **mesa** | 24.0.8-1 | An open-source implementation of the OpenGL specification | https://www.mesa3d.org |
| **mesa-dev** | 24.0.8-1 | Mesa's OpenGL headers | https://www.mesa3d.org |
| **mesa-vulkan-icd-swrast** | 24.0.8-1 | Mesa's Swrast Vulkan ICD | https://www.mesa3d.org |
...
| **miniflux** | 2.2.1 | A minimalist and opinionated feed reader | https://miniflux.app/ |
| **minimodem** | 0.24-1-0 | General-purpose software audio FSK modem | http://www.whence.com/minimodem/ |
| **minio** | 2024.10.13.13.34.11 | Multi-Cloud Object Storage | https://min.io/ |
...
| **mlir** | 19.1.2 | A Multi-Level Intermediate Representation for compilers from LLVM | https://clang.llvm.org/ |
| **mlocate** | 0.26-5 | Tool to find files anywhere in the filesystem based on their name | https://pagure.io/mlocate |
| **mold** | 2.34.1 | mold: A Modern Linker | https://github.com/rui314/mold |
...
| **monolith** | 2.8.3 | CLI tool for saving complete web pages as a single HTML file | https://github.com/Y2Z/monolith |
...
| **mount-utils** | 2.40.2-1 | Utilities for (un)mounting filesystems | https://en.wikipedia.org/wiki/Util-linux |
...
| **mpd** | 0.23.15-3 | Music player daemon | https://www.musicpd.org |
...
| **mpg123** | 1.32.7 | Fast console MPEG Audio Player and decoder library | https://mpg123.org/ |
| **mpg123-static** | 1.32.7 | Static libraries for mpg123 | https://mpg123.org/ |
...
| **mympd** | 18.1.2 | A standalone and lightweight web-based MPD client | https://jcorporation.github.io/myMPD/ |
...
| **ncmpcpp** | 0.9.2-13 | NCurses Music Player Client (Plus Plus) | https://rybczak.net/ncmpcpp/ |
...
| **ncspot** | 1.1.2 | An ncurses Spotify client written in Rust | https://github.com/hrkfdn/ncspot |
| **ncurses** | 6.5.20240831-1 | Library for text-based user interfaces in a terminal-independent manner | https://invisible-island.net/ncurses/ |
| **ncurses-static** | 6.5.20240831-1 | Static libraries for ncurses | https://invisible-island.net/ncurses/ |
| **ncurses-ui-libs** | 6.5.20240831-1 | Libraries for terminal user interfaces based on ncurses | https://invisible-island.net/ncurses/ |
| **ncurses-ui-libs-static** | 6.5.20240831-1 | Static libraries for terminal user interfaces based on ncurses | https://invisible-island.net/ncurses/ |
| **ncurses-utils** | 6.5.20240831-1 | Tools for working with terminals | https://invisible-island.net/ncurses/ |
...
| **neocmakelsp** | 0.8.12 | a cmake lsp based on tower-lsp and treesitter | https://github.com/Decodetalkers/neocmakelsp |
...
| **nlopt** | 2.8.0 | Library for nonlinear optimization | https://nlopt.readthedocs.io/ |
...
| **nodejs** | 22.8.0 | Open Source, cross-platform JavaScript runtime environment | https://nodejs.org/ |
| **nodejs-lts** | 20.17.0 | Open Source, cross-platform JavaScript runtime environment | https://nodejs.org/ |
| **notcurses** | 3.0.11 | blingful TUIs and character graphics | https://notcurses.com/ |
| **notcurses-data** | 3.0.11 | Platform-independent data for notcurses | https://notcurses.com/ |
| **notcurses-tools** | 3.0.11 | Tools and demos for notcurses | https://notcurses.com/ |
...
| **oh-my-posh** | 23.20.3 | A prompt theme engine for any shell. | https://ohmyposh.dev |
...
| **opencl-clhpp** | 2024.05.08 | Khronos OpenCL C++ Headers | https://github.com/KhronosGroup/OpenCL-CLHPP |
| **opencl-headers** | 2024.05.08 | Khronos OpenCL-Headers | https://github.com/KhronosGroup/OpenCL-Headers |
| **opencl-vendor-driver** | 0.3 | OpenCL driver from system vendor | https://termux.dev |
| **opencolorio** | 2.4.0 | A color management framework for visual effects and animation | https://opencolorio.org |
...
| **openjdk-21** | 21.0.5 | Java development kit and runtime | https://openjdk.java.net |
| **openjdk-21-source** | 21.0.5 | Source files for openjdk-21 | https://openjdk.java.net |
| **openjdk-21-x** | 21.0.5 | Portion of openjdk-21 requiring X11 functionality | https://openjdk.java.net |
...
| **openldap-static** | 2.6.8 | Static libraries for openldap | https://openldap.org |
...
| **osmesa** | 24.0.8-1 | Mesa Off-screen Rendering Library | https://www.mesa3d.org |
...
| **panda3d** | 1.10.14-1 | A framework for 3D rendering and game development for Python and C++ programs | https://www.panda3d.org/ |
| **panda3d-samples** | 1.10.14-1 | Python sample programs that use Panda3D | https://www.panda3d.org/ |
| **panda3d-static** | 1.10.14-1 | Static libraries for panda3d | https://www.panda3d.org/ |
...
| **parallel** | 20241022 | GNU Parallel is a shell tool for executing jobs in parallel using one or more machines | https://www.gnu.org/software/parallel/ |
...
| **pass** | 1.7.4-3 | Lightweight directory-based password manager | https://www.passwordstore.org |
...
| **pdfcpu** | 0.9.0 | A PDF processor written in Go | https://pdfcpu.io |
...
| **pet** | 0.9.0 | Simple command-line snippet manager | https://github.com/knqyf263/pet |
| **pforth** | 1:2.0.1 | Portable Forth in C | http://www.softsynth.com/pforth/ |
| **pgroonga** | 3.2.4 | A PostgreSQL extension to use Groonga as index | https://github.com/pgroonga/pgroonga |
...
| **php** | 8.3.10-1 | Server-side, HTML-embedded scripting language | https://php.net |
| **php-apache** | 8.3.10-1 | Apache 2.0 Handler module for PHP | https://php.net |
| **php-apache-ldap** | 8.3.10-1 | LDAP module for PHP/Apache | https://php.net |
| **php-apache-opcache** | 8.3.10-1 | OPcache module for PHP/Apache | https://php.net |
| **php-apache-pgsql** | 8.3.10-1 | PostgreSQL modules for PHP/Apache | https://php.net |
| **php-apache-sodium** | 8.3.10-1 | Sodium module for PHP/Apache | https://php.net |
| **php-apcu** | 5.1.24 | APCu - APC User Cache | http://php.net/apcu |
| **php-fpm** | 8.3.10-1 | FastCGI Process Manager for PHP | https://php.net |
| **php-gd** | 8.3.10-1 | gd module for PHP | https://php.net |
| **php-imagick** | 3.7.0-5 | The Imagick PHP extension | https://github.com/Imagick/imagick |
| **php-ldap** | 8.3.10-1 | LDAP module for PHP | https://php.net |
| **php-pgsql** | 8.3.10-1 | PostgreSQL modules for PHP | https://php.net |
...
| **php-sodium** | 8.3.10-1 | Sodium module for PHP | https://php.net |
| **php-zephir-parser** | 1.6.1 | The Zephir Parser delivered as a C extension for the PHP language | https://github.com/phalcon/php-zephir-parser |
...
| **plutolang** | 0.9.5 | A superset of Lua 5.4 with a focus on general-purpose programming. | https://plutolang.github.io/ |
...
| **pocketbase** | 0.22.22 | An open source Go backend | https://github.com/pocketbase/pocketbase |
...
| **predict** | 2.3.1 | A Satellite Tracking/Orbital Prediction Program | https://www.qsl.net/kd2bd/predict.html |
...
| **proj** | 9.5.0 | Generic coordinate transformation software | https://proj.org |
| **proot** | 5.1.107-65 | Emulate chroot, bind mount and binfmt_misc for non-root users | https://proot-me.github.io/ |
| **proot-distro** | 4.17.2 | Termux official utility for managing proot'ed Linux distributions | https://github.com/termux/proot-distro |
...
| **pv** | 1.9.0 | Terminal-based tool for monitoring the progress of data through a pipeline | http://www.ivarch.com/programs/pv.shtml |
...
| **python-ensurepip-wheels** | 3.12.7-1 | Wheels for Python ensurepip | https://python.org/ |
...
| **python-static** | 3.12.7-1 | Static libraries for python | https://python.org/ |
| **python-tkinter** | 3.12.7-1 | Tkinter support for Python 3 | https://python.org/ |
...
| **python-torchaudio** | 2.5.0 | Data manipulation and transformation for audio signal processing, powered by PyTorch | https://github.com/pytorch/audio |
| **python-torchvision** | 0.20.0 | Datasets, Transforms and Models specific to Computer Vision | https://github.com/pytorch/vision |
...
| **qemu-system-i386-headless** | 1:8.2.6 | A generic and open source machine emulator and virtualizer (headless) | https://www.qemu.org |
| **qemu-system-m68k-headless** | 1:8.2.6 | A generic and open source machine emulator and virtualizer (headless) | https://www.qemu.org |
| **qemu-system-ppc-headless** | 1:8.2.6 | A generic and open source machine emulator and virtualizer (headless) | https://www.qemu.org |
| **qemu-system-ppc64-headless** | 1:8.2.6 | A generic and open source machine emulator and virtualizer (headless) | https://www.qemu.org |
| **qemu-system-riscv32-headless** | 1:8.2.6 | A generic and open source machine emulator and virtualizer (headless) | https://www.qemu.org |
| **qemu-system-riscv64-headless** | 1:8.2.6 | A generic and open source machine emulator and virtualizer (headless) | https://www.qemu.org |
| **qemu-system-x86-64-headless** | 1:8.2.6 | A generic and open source machine emulator and virtualizer (headless) | https://www.qemu.org |
| **qemu-system-x86-64-headless-static** | 1:8.2.5-1 | Static libraries for qemu-system-x86-64-headless | https://www.qemu.org |
| **qemu-user-aarch64** | 1:8.2.6 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-user-arm** | 1:8.2.6 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-user-i386** | 1:8.2.6 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-user-m68k** | 1:8.2.6 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-user-ppc** | 1:8.2.6 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-user-ppc64** | 1:8.2.6 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-user-riscv32** | 1:8.2.6 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-user-riscv64** | 1:8.2.6 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-user-x86-64** | 1:8.2.6 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-utils** | 1:8.2.6 | A set of utilities for working with the QEMU emulators | https://www.qemu.org |
...
| **railway-cli** | 3.17.10 | This is the command line interface for Railway | https://railway.app |
...
| **rclone** | 1.68.1 | rsync for cloud storage | https://rclone.org/ |
...
| **remind** | 1:05.00.07 | Sophisticated calendar and alarm program | https://dianne.skoll.ca/projects/remind/ |
...
| **restic** | 0.17.1 | Fast, secure, efficient backup program | https://restic.net/ |
...
| **rsgain** | 3.5.2-1 | A simple audio normalizazion utility | https://github.com/complexlogic/rsgain |
...
| **rust-analyzer** | 20241021 | A Rust compiler front-end for IDEs | https://github.com/rust-lang/rust-analyzer |
...
| **rust-std-aarch64-linux-android** | 1.82.0 | Rust std for target aarch64-linux-android | https://www.rust-lang.org/ |
| **rust-std-armv7-linux-androideabi** | 1.82.0 | Rust std for target armv7-linux-androideabi | https://www.rust-lang.org/ |
| **rust-std-i686-linux-android** | 1.82.0 | Rust std for target i686-linux-android | https://www.rust-lang.org/ |
| **rust-std-wasm32-unknown-unknown** | 1.82.0 | Rust std for target wasm32-unknown-unknown | https://www.rust-lang.org/ |
| **rust-std-wasm32-wasi** | 1.82.0 | Rust std for target wasm32-wasi | https://www.rust-lang.org/ |
| **rust-std-wasm32-wasip1** | 1.82.0 | Rust std for target wasm32-wasip1 | https://www.rust-lang.org/ |
| **rust-std-wasm32-wasip2** | 1.82.0 | Rust std for target wasm32-wasip2 | https://www.rust-lang.org/ |
| **rust-std-x86-64-linux-android** | 1.82.0 | Rust std for target x86_64-linux-android | https://www.rust-lang.org/ |
| **rustc-dev** | 1.82.0 | Rust compiler development libs | https://www.rust-lang.org/ |
| **rustc-src** | 1.82.0 | Rust compiler source code files | https://www.rust-lang.org/ |
...
| **scala** | 3.5.2 | Scala 3 compiler and standard library. | https://www.scala-lang.org |
...
| **sccache** | 0.8.2 | sccache is ccache with cloud storage | https://github.com/mozilla/sccache |
...
| **seafile-client** | 9.0.8-1 | Seafile is a file syncing and sharing software with file encryption and group sharing | https://seafile.com |
| **seafile-client-static** | 9.0.8-1 | Static libraries for seafile-client | https://seafile.com |
| **seanime** | 2.1.1-2 | Self-hosted anime and manga server for sea rovers. | https://github.com/5rahim/seanime |
...
| **sftpgo** | 2.6.2-1 | Full-featured and highly configurable SFTP, HTTP/S, FTP/S and WebDAV server | https://sftpgo.com/ |
| **shaderc** | 2024.3 | Collection of tools, libraries, and tests for Vulkan shader compilation | https://github.com/google/shaderc |
...
| **simdjson** | 3.10.1 | A C++ library to see how fast we can parse JSON with complete validation | https://simdjson.org/ |
...
| **sing-box** | 1.10.1 | The universal proxy platform | https://sing-box.sagernet.org |
...
| **starship** | 1.21.1 | A minimal, blazing fast, and extremely customizable prompt for any shell | https://starship.rs |
...
| **step-cli** | 0.27.5-1 | An easy-to-use CLI tool for building, operating, and automating Public Key Infrastructure (PKI) systems and workflows | https://smallstep.com/cli |
...
| **storj-uplink** | 1.114.6 | Storj DCS Uplink CLI | https://www.storj.io/integrations/uplink-cli |
...
| **subversion** | 1.14.3-1 | Centralized version control system characterized by its simplicity | https://subversion.apache.org |
| **subversion-perl** | 1.14.3-1 | Perl interface to Subversion | https://subversion.apache.org |
| **subversion-perl-static** | 1.14.3-1 | Static libraries for subversion-perl | https://subversion.apache.org |
| **subversion-static** | 1.14.3-1 | Static libraries for subversion | https://subversion.apache.org |
...
| **svt-av1** | 2.2.1 | Scalable Video Technology for AV1 (SVT-AV1 Encoder and Decoder) | https://gitlab.com/AOMediaCodec/SVT-AV1 |
| **swaks** | 20240103.0 | Swiss Army Knife for SMTP | http://jetmore.org/john/code/swaks/ |
| **swi-prolog** | 9.3.13 | Most popular and complete prolog implementation | https://swi-prolog.org/ |
...
| **tdl** | 0.17.5 | Telegram downloader/tools written in Golang | https://docs.iyear.me/tdl/ |
| **tea** | 0.9.2 | The official CLI for Gitea | https://gitea.com/gitea/tea |
| **tealdeer** | 1.7.0 | A very fast implementation of tldr in Rust | https://dbrgn.github.io/tealdeer/ |
...
| **teleport-tsh** | 16.4.6 | Secure Access for Developers that doesn't get in the way | https://github.com/gravitational/teleport |
...
| **termux-gui-c** | 0.1.3 | A C library for the Termux:GUI plugin | https://github.com/tareksander/termux-gui-c-bindings |
...
| **texlab** | 5.20.0 | A cross-platform implementation of the Language Server Protocol providing rich cross-editing support for the LaTeX typesetting system | https://texlab.netlify.app/ |
...
| **timg** | 1.6.0-2 | A terminal image and video viewer | https://timg.sh/ |
...
| **tintin++** | 2.02.41 | Classic text-based MUD client | https://tintin.mudhalla.net |
...
| **tokei** | 13.0.0-alpha.6-0 | A blazingly fast CLOC (Count Lines Of Code) program | https://github.com/XAMPPRocky/tokei |
...
| **topgrade** | 16.0.1 | Upgrade all the things | https://github.com/topgrade-rs/topgrade/ |
| **tor** | 0.4.8.12 | The Onion Router anonymizing overlay network | https://www.torproject.org |
...
| **toxic** | 0.15.1 | A command line client for Tox | https://github.com/JFreegman/toxic |
...
| **tree-sitter** | 0.24.3 | An incremental parsing system for programming tools | https://github.com/tree-sitter/tree-sitter |
...
| **tree-sitter-static** | 0.24.3 | Static libraries for tree-sitter | https://github.com/tree-sitter/tree-sitter |
...
| **usql** | 0.19.3 | A universal command-line interface for SQL databases | https://github.com/xo/usql |
...
| **util-linux** | 2.40.2-1 | Miscellaneous system utilities | https://en.wikipedia.org/wiki/Util-linux |
...
| **uv** | 0.4.26 | An extremely fast Python package installer and resolver, written in Rust. | https://docs.astral.sh/uv/ |
| **uwsgi** | 2.0.27-1 | uWSGI application server container | https://projects.unbit.it/uwsgi |
| **v2ray** | 5.21.0 | A platform for building proxies to bypass network restrictions | https://www.v2fly.org/ |
...
| **vale** | 3.8.0 | A syntax-aware linter for prose built with speed and extensibility in mind | https://vale.sh |
...
| **viddy** | 1.2.0 | A modern watch command | https://github.com/sachaos/viddy |
...
| **vim** | 9.1.0800 | Vi IMproved - enhanced vi editor | https://www.vim.org |
| **vim-python** | 9.1.0800 | Vi IMproved - enhanced vi editor - with python support | https://www.vim.org |
| **vim-runtime** | 9.1.0800 | Vi IMproved - Runtime files | https://www.vim.org |
| **virglrenderer** | 1.1.0-1 | A virtual 3D GPU for use inside qemu virtual machines | https://virgil3d.github.io/ |
| **virglrenderer-android** | 1.0.1-2 | A virtual 3D GPU for use inside qemu virtual machines over OpenGLES libraries on Android | https://virgil3d.github.io/ |
...
| **vtm** | 0.9.99.29 | Terminal multiplexer with TUI window manager and multi-party session sharing | https://vtm.netxs.online/ |
...
| **vulkan-headers** | 1.3.299 | Vulkan Header files and API registry | https://github.com/KhronosGroup/Vulkan-Headers |
...
| **vulkan-loader-generic** | 1.3.299 | Vulkan Loader | https://github.com/KhronosGroup/Vulkan-Loader |
| **vulkan-tools** | 1.3.299 | Vulkan Tools and Utilities | https://github.com/KhronosGroup/Vulkan-Tools |
| **vulkan-utility-libraries** | 1.3.299 | Utility Libraries for Vulkan | https://github.com/KhronosGroup/Vulkan-Utility-Libraries |
...
| **wakatime-cli** | 1.102.1 | Command line interface used by all WakaTime text editor plugins | https://wakatime.com/plugins/ |
...
| **waypipe** | 0.9.1 | A proxy for Wayland clients | https://gitlab.freedesktop.org/mstoeckl/waypipe |
...
| **weechat** | 4.4.2-1 | Fast, light and extensible IRC chat client | https://weechat.org/ |
| **weechat-lua-plugin** | 4.4.2-1 | WeeChat Lua Plugin | https://weechat.org/ |
| **weechat-perl-plugin** | 4.4.2-1 | WeeChat Perl Plugin | https://weechat.org/ |
| **weechat-python-plugin** | 4.4.2-1 | WeeChat Python3 Plugin | https://weechat.org/ |
| **weechat-ruby-plugin** | 4.4.2-1 | WeeChat Ruby Plugin | https://weechat.org/ |
...
| **xh** | 0.23.0 | A friendly and fast tool for sending HTTP requests | https://github.com/ducaale/xh |
...
| **xmlto** | 0.0.29 | Convert xml to many other formats | https://pagure.io/xmlto/ |
| **xmppc** | 0.1.2-2 | Command Line Interface Tool for XMPP | https://codeberg.org/Anoxinon_e.V./xmppc |
| **xorg-util-macros** | 1.20.1 | X.Org Autotools macros | https://xorg.freedesktop.org/ |
...
| **xtrans** | 1.5.1 | X transport library | https://xorg.freedesktop.org/ |
...
| **yazi** | 0.3.3-1 | Blazing fast terminal file manager written in Rust, based on async I/O | https://yazi-rs.github.io/ |
| **yosys** | 0.45 | A framework for RTL synthesis tools | https://yosyshq.net/yosys/ |
...
| **ytui-music** | 2.0.0-beta-1 | Youtube client in terminal for music | https://github.com/sudipghimire533/ytui-music |
...
| **z-push** | 2.7.4 | An open-source application to synchronize ActiveSync compatible devices and Outlook | https://z-push.org/ |
| **z3** | 4.13.3 | Z3 is a theorem prover from Microsoft Research | https://github.com/Z3Prover/z3 |
...
| **znc** | 1.9.1 | An advanced IRC bouncer | https://znc.in/ |
| **zola** | 0.19.2 | A fast static site generator in a single binary with everything built-in. | https://github.com/getzola/zola |
...
| **zrok** | 0.4.42-1 | An open source sharing solution built on OpenZiti. | https://zrok.io/ |
