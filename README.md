...
| **apt** | 2.8.1 | Front-end for the dpkg package manager | https://packages.debian.org/apt |
| **apt-file** | 3.3 | search for files within packages | https://wiki.debian.org/apt-file |
| **apt-ftparchive** | 2.8.1 | apt-ftparchive is the command line tool that generates the index files that APT uses to access a distribution source | https://packages.debian.org/apt |
| **apt-transport-tor** | 2.8.1 | APT transport for anonymous package downloads via Tor | https://packages.debian.org/apt |
...
| **atomvm** | 1:0.6.3 | The minimal Erlang VM implementation | https://github.com/bettio/AtomVM |
...
| **bc-gh** | 6.7.6 | Unix dc and POSIX bc with GNU and BSD extensions | https://git.gavinhoward.com/gavin/bc |
...
| **broot** | 1.41.1 | A better way to navigate directories | https://github.com/Canop/broot |
...
| **buf** | 1.36.0 | A new way of working with Protocol Buffers | https://buf.build |
...
| **cloudflared** | 2024.8.2 | A tunneling daemon that proxies traffic from the Cloudflare network to your origins | https://github.com/cloudflare/cloudflared |
...
| **command-not-found** | 2.4.0-37 | Suggest installation of packages in interactive shell sessions | https://github.com/termux/command-not-found |
| **composer** | 2.7.7 | Dependency Manager for PHP | https://getcomposer.org/ |
...
| **cowsay** | 3.8.1 | Program which generates ASCII pictures of a cow with a message | https://cowsay.diamonds/ |
...
| **exercism** | 3.4.1 | A Go based command line tool for exercism.io | https://github.com/exercism/cli/ |
...
| **ffmpeg** | 6.1.1-5 | Tools and libraries to manipulate a wide range of multimedia formats and protocols | https://ffmpeg.org |
...
| **frp** | 0.59.0 | A fast reverse proxy to expose a local server behind a NAT or firewall to the internet | https://github.com/fatedier/frp |
...
| **gexiv2** | 0.14.3 | A GObject-based Exiv2 wrapper | https://wiki.gnome.org/Projects/gexiv2 |
...
| **graphicsmagick** | 1.3.43-2 | Collection of image processing tools | http://www.graphicsmagick.org/ |
| **graphicsmagick-static** | 1.3.43-2 | Static libraries for graphicsmagick | http://www.graphicsmagick.org/ |
...
| **gst-libav** | 1.24.6 | GStreamer Libav plug-in contains one plugin with a set of elements using the Libav library code | https://gstreamer.freedesktop.org/modules/gst-libav.html |
| **gst-plugins-bad** | 1.24.6 | GStreamer Bad Plug-ins | https://gstreamer.freedesktop.org/ |
| **gst-plugins-base** | 1.24.6 | GStreamer base plug-ins | https://gstreamer.freedesktop.org/ |
| **gst-plugins-gl-headers** | 1.24.6 | OpenGL headers for GStreamer plugins | https://gstreamer.freedesktop.org/ |
| **gst-plugins-good** | 1.24.6 | GStreamer Good Plug-ins | https://gstreamer.freedesktop.org/ |
| **gst-plugins-ugly** | 1.24.6 | GStreamer Ugly Plug-ins | https://gstreamer.freedesktop.org/ |
| **gst-python** | 1.24.6 | Python bindings for GStreamer | https://gstreamer.freedesktop.org/ |
| **gstreamer** | 1.24.6 | Open source multimedia framework | https://gstreamer.freedesktop.org/ |
...
| **gum** | 0.14.3 | A tool for creating minimal interactive TUIs for shell scripts | https://github.com/charmbracelet/gum |
...
| **hugo** | 0.132.2 | A fast and flexible static site generator | https://gohugo.io/ |
...
| **imagemagick** | 7.1.1.36 | Suite to create, edit, compose, or convert images in a variety of formats | https://www.imagemagick.org/ |
| **imagemagick-static** | 7.1.1.36 | Static libraries for imagemagick | https://www.imagemagick.org/ |
...
| **kak-lsp** | 17.1.1-1 | Language Server Protocol Client for the Kakoune editor | https://github.com/kak-lsp/kak-lsp |
...
| **kcptun** | 20240807 | A Stable & Secure Tunnel based on KCP with N:M multiplexing and FEC | https://github.com/xtaci/kcptun |
...
| **kubelogin** | 1.28.2 | A kubectl plugin for Kubernetes OpenID Connect (OIDC) authentication | https://github.com/int128/kubelogin |
...
| **libc++utilities** | 5.25.0 | Useful C++ classes and routines such as argument parser, IO and conversion utilities | https://github.com/Martchus/cpp-utilities |
...
| **libcommons-lang3-java** | 3.15.0 | A host of helper utilities for the java.lang API | https://commons.apache.org/proper/commons-lang/ |
...
| **libgeos** | 3.12.2 | Geometry Engine, C++ port of the Java Topology Suite | https://geos.osgeo.org/ |
...
| **libmaxminddb** | 1.10.0 | MaxMind GeoIP2 database - library and utilities | https://dev.maxmind.com/geoip/geoip2/ |
| **libmaxminddb-static** | 1.10.0 | Static libraries for libmaxminddb | https://dev.maxmind.com/geoip/geoip2/ |
| **libmaxminddb-tools** | 1.10.0 | A geoip lookup utility for MaxMind DB | https://dev.maxmind.com/geoip/geoip2/ |
...
| **libmsgpack** | 6.0.2 | MessagePack implementation for C | https://github.com/msgpack/msgpack-c/ |
| **libmsgpack-cxx** | 6.1.1 | msgpack for C++ | https://msgpack.org/ |
| **libmsgpack-static** | 6.0.2 | Static libraries for libmsgpack | https://github.com/msgpack/msgpack-c/ |
...
| **libmusicbrainz** | 5.1.0-3 | The MusicBrainz Client Library | https://musicbrainz.org/doc/libmusicbrainz |
...
| **libneon** | 0.33.0 | An HTTP/1.1 and WebDAV client library, with a C interface | https://notroj.github.io/neon/ |
| **libneon-static** | 0.33.0 | Static libraries for libneon | https://notroj.github.io/neon/ |
...
| **librsvg** | 2.58.2 | Library to render SVG files using cairo | https://wiki.gnome.org/action/show/Projects/LibRsvg |
...
| **lua-language-server** | 3.10.3 | Sumneko Lua Language Server coded in Lua | https://github.com/sumneko/lua-language-server |
...
| **mold** | 2.32.1 | mold: A Modern Linker | https://github.com/rui314/mold |
...
| **mympd** | 17.0.1 | A standalone and lightweight web-based MPD client | https://jcorporation.github.io/myMPD/ |
...
| **o-editor** | 2.65.12 | Small, fast and limited text editor | https://github.com/xyproto/o |
...
| **oh-my-posh** | 23.6.3 | A prompt theme engine for any shell. | https://ohmyposh.dev |
...
| **parallel** | 20240722 | GNU Parallel is a shell tool for executing jobs in parallel using one or more machines | https://www.gnu.org/software/parallel/ |
...
| **pet** | 0.8.4 | Simple command-line snippet manager | https://github.com/knqyf263/pet |
...
| **postgresql** | 16.3 | Object-relational SQL database | https://www.postgresql.org |
| **postgresql-static** | 16.3 | Static libraries for postgresql | https://www.postgresql.org |
...
| **pv** | 1.8.12 | Terminal-based tool for monitoring the progress of data through a pipeline | http://www.ivarch.com/programs/pv.shtml |
...
| **pypy** | 7.3.15-2 | A fast, compliant alternative implementation of Python | https://pypy.org |
| **pypy-tests** | 7.3.15-2 | Test files for PyPy | https://pypy.org |
| **pypy-tkinter** | 7.3.15-2 | Tkinter support for PyPy | https://pypy.org |
...
| **recoll** | 1.39.4 | Full-text search for your desktop | https://www.recoll.org/ |
| **recoll-python** | 1.39.4 | Python interface for Recoll | https://www.recoll.org/ |
...
| **ruff** | 0.6.0 | An extremely fast Python linter, written in Rust | https://github.com/charliermarsh/ruff |
...
| **rust-analyzer** | 20240812 | A Rust compiler front-end for IDEs | https://github.com/rust-lang/rust-analyzer |
...
| **sabnzbd** | 4.3.2 | Fully automated Usenet Binary Downloader | https://sabnzbd.org/ |
...
| **sc-im** | 0.8.3-3 | An improved version of sc, a spreadsheet calculator | https://github.com/andmarti1424/sc-im |
| **scala** | 3.4.2 | Scala 3 compiler and standard library. | https://www.scala-lang.org |
...
| **sing-box** | 1.9.3 | The universal proxy platform | https://sing-box.sagernet.org |
...
| **storj-uplink** | 1.109.2 | Storj DCS Uplink CLI | https://www.storj.io/integrations/uplink-cli |
...
| **svt-av1** | 2.1.2 | Scalable Video Technology for AV1 (SVT-AV1 Encoder and Decoder) | https://gitlab.com/AOMediaCodec/SVT-AV1 |
| **swaks** | 20240103.0 | Swiss Army Knife for SMTP | http://jetmore.org/john/code/swaks/ |
| **swi-prolog** | 9.3.9 | Most popular and complete prolog implementation | https://swi-prolog.org/ |
...
| **trzsz-go** | 1.1.7-1 | A simple file transfer tools, similar to lrzsz ( rz / sz ) | https://trzsz.github.io/ |
| **trzsz-ssh** | 0.1.21 | An openssh client alternative | https://trzsz.github.io/ssh |
...
| **ugrep** | 6.4.1 | A faster, user-friendly and compatible grep replacement | https://github.com/Genivia/ugrep |
...
| **vale** | 3.7.0 | A syntax-aware linter for prose built with speed and extensibility in mind | https://vale.sh |
...
| **vgmstream** | 1917 | A library for playback of various streamed audio formats used in video games | https://github.com/vgmstream/vgmstream |
...
| **vtm** | 0.9.99.05 | Terminal multiplexer with TUI window manager and multi-party session sharing | https://vtm.netxs.online/ |
...
| **vulkan-extension-layer** | 1.3.292 | Vulkan Extension Layer | https://github.com/KhronosGroup/Vulkan-ExtensionLayer |
| **vulkan-headers** | 1.3.292 | Vulkan Header files and API registry | https://github.com/KhronosGroup/Vulkan-Headers |
...
| **vulkan-loader-generic** | 1.3.292 | Vulkan Loader | https://github.com/KhronosGroup/Vulkan-Loader |
| **vulkan-tools** | 1.3.292 | Vulkan Tools and Utilities | https://github.com/KhronosGroup/Vulkan-Tools |
...
| **weechat** | 4.3.6 | Fast, light and extensible IRC chat client | https://weechat.org/ |
| **weechat-lua-plugin** | 4.3.6 | WeeChat Lua Plugin | https://weechat.org/ |
| **weechat-perl-plugin** | 4.3.6 | WeeChat Perl Plugin | https://weechat.org/ |
| **weechat-python-plugin** | 4.3.6 | WeeChat Python3 Plugin | https://weechat.org/ |
| **weechat-ruby-plugin** | 4.3.6 | WeeChat Ruby Plugin | https://weechat.org/ |
...
| **zrok** | 0.4.38 | An open source sharing solution built on OpenZiti. | https://zrok.io/ |
