...
| **agate** | 3.3.6 | Very simple server for the Gemini hypertext protocol | https://github.com/mbrubeck/agate |
...
| **aichat** | 0.14.0 | A powerful chatgpt cli | https://github.com/sigoden/aichat |
...
| **alist** | 3.33.0 | A file list program that supports multiple storage | https://alist.nn.ci |
...
| **ani-cli** | 4.8 | A cli to browse and watch anime | https://github.com/pystardust/ani-cli |
...
| **atomvm** | 1:0.6.0 | The minimal Erlang VM implementation | https://github.com/bettio/AtomVM |
...
| **bash** | 5.2.26 | A sh-compatible shell that incorporates useful features from the Korn shell (ksh) and C shell (csh) | https://www.gnu.org/software/bash/ |
| **bash-completion** | 2.12.0 | Programmable completion for the bash shell | https://github.com/scop/bash-completion |
...
| **broot** | 1.36.1-1 | A better way to navigate directories | https://github.com/Canop/broot |
...
| **buf** | 1.30.0 | A new way of working with Protocol Buffers | https://buf.build |
...
| **cargo-c** | 0.9.31-1 | Cargo C-ABI helpers | https://github.com/lu-zero/cargo-c |
...
| **cava** | 0.10.1 | Console-based Audio Visualizer. Works with MPD and Pulseaudio | https://github.com/karlstav/cava |
...
| **chezmoi** | 2.47.2 | Manage your dotfiles across multiple machines | https://chezmoi.io |
...
| **clamav** | 1.3.0 | Anti-virus toolkit for Unix | https://www.clamav.net/ |
| **clamav-static** | 1.3.0 | Static libraries for clamav | https://www.clamav.net/ |
| **clang** | 18.1.2 | C language frontend for LLVM | https://clang.llvm.org/ |
...
| **cloudflared** | 2024.3.0 | A tunneling daemon that proxies traffic from the Cloudflare network to your origins | https://github.com/cloudflare/cloudflared |
| **clpeak** | 1.1.2-3 | A tool which profiles OpenCL devices to find their peak capacities | https://github.com/krrishnarraj/clpeak |
| **clvk** | 0.0.20240319.131235 | Experimental implementation of OpenCL on Vulkan | https://github.com/kpet/clvk |
| **cmake** | 3.29.0 | Family of tools designed to build, test and package software | https://cmake.org/ |
| **cmake-curses-gui** | 3.29.0 | Curses based user interface for CMake (ccmake) | https://cmake.org/ |
...
| **command-not-found** | 2.4.0-17 | Suggest installation of packages in interactive shell sessions | https://github.com/termux/command-not-found |
| **composer** | 2.7.2 | Dependency Manager for PHP | https://getcomposer.org/ |
...
| **cppcheck** | 2.13.4 | tool for static C/C++ code analysis | https://github.com/danmar/cppcheck |
...
| **croc** | 9.6.14 | Easily and securely send things from one computer to another | https://github.com/schollz/croc |
...
| **curl** | 8.7.1 | Command line tool for transferring data with URL syntax | https://curl.se/ |
...
| **difftastic** | 0.56.1 | difft: A structural diff that understands syntax | https://github.com/Wilfred/difftastic |
...
| **duckdb** | 0.10.1 | DuckDB Command Line Interface (CLI) shell | https://duckdb.org/ |
...
| **electrum** | 4.5.4 | Electrum is a lightweight Bitcoin wallet | https://electrum.org |
...
| **emscripten-llvm** | 3.1.56 | Emscripten-compatible LLVM | https://emscripten.org |
| **emscripten-tests-third-party** | 3.1.56 | Emscripten third party test suite files | https://emscripten.org |
...
| **enchant** | 2.6.8 | Wraps a number of different spelling libraries and programs with a consistent interface | https://abiword.github.io/enchant/ |
| **enchant-static** | 2.6.8 | Static libraries for enchant | https://abiword.github.io/enchant/ |
...
| **esbuild** | 0.20.2 | An extremely fast JavaScript bundler | https://esbuild.github.io/ |
...
| **exiftool** | 12.81 | Utility for reading, writing and editing meta information in a wide variety of files. | https://exiftool.org/ |
...
| **eza** | 0.18.9 | A modern replacement for ls | https://github.com/eza-community/eza |
...
| **forgejo** | 1.21.5-0-0 | Forgejo is a self-hosted lightweight software forge. | https://forgejo.org/ |
...
| **frp** | 0.56.0 | A fast reverse proxy to expose a local server behind a NAT or firewall to the internet | https://gofrp.org/doc |
...
| **geth** | 1.13.14 | Go implementation of the Ethereum protocol | https://geth.ethereum.org/ |
| **geth-utils** | 1.13.14 | Additional utilities for Geth (like abigen, bootnode, evm, puppeth) | https://geth.ethereum.org/ |
...
| **gh** | 2.46.0 | GitHub’s official command line tool | https://cli.github.com/ |
...
| **ghostscript** | 10.02.1 | Interpreter for the PostScript language and for PDF | https://www.ghostscript.com/ |
...
| **git-gitk** | 2.44.0 | Git repository browser | https://git-scm.com/ |
| **git-gui** | 2.44.0 | A graphical interface to Git | https://git-scm.com/ |
...
| **git-svn** | 2.44.0 | Convert between Git and Subversion repositories | https://git-scm.com/ |
...
| **gitui** | 0.25.2-1 | Blazing fast terminal-ui for git written in rust | https://github.com/extrawurst/gitui |
...
| **glib** | 2.80.0 | Library providing core building blocks for libraries and applications written in C | https://developer.gnome.org/glib/ |
| **glib-bin** | 2.80.0 | Programs for the GLib library | https://developer.gnome.org/glib/ |
| **glib-cross** | 2.80.0 | glib for host (NOT for Termux) | https://developer.gnome.org/glib/ |
...
| **glslang** | 14.1.0-1 | OpenGL and OpenGL ES shader front end and validator | https://github.com/KhronosGroup/glslang |
...
| **gmic** | 3.3.5 | Full-featured framework for image processing | https://gmic.eu |
| **gmic-gm** | 3.3.5 | Full-featured framework for image processing (GraphicsMagick variant) | https://gmic.eu |
...
| **gnupg** | 2.4.4 | Implementation of the OpenPGP standard for encrypting and signing data and communication | https://www.gnupg.org/ |
...
| **gnutls** | 3.8.3 | Commandline utilities for interfacing with the gnutls library | https://www.gnutls.org/ |
...
| **gpgv** | 2.4.4 | GNU privacy guard - signature verification tool | https://www.gnupg.org/ |
...
| **graphviz** | 10.0.1-1 | Rich set of graph drawing tools | https://www.graphviz.org/ |
| **graphviz-static** | 10.0.1-1 | Static libraries for graphviz | https://www.graphviz.org/ |
...
| **gst-libav** | 1.24.1 | GStreamer Libav plug-in contains one plugin with a set of elements using the Libav library code | https://gstreamer.freedesktop.org/modules/gst-libav.html |
| **gst-plugins-bad** | 1.24.1 | GStreamer Bad Plug-ins | https://gstreamer.freedesktop.org/ |
| **gst-plugins-base** | 1.24.1 | GStreamer base plug-ins | https://gstreamer.freedesktop.org/ |
| **gst-plugins-gl-headers** | 1.24.1 | OpenGL headers for GStreamer plugins | https://gstreamer.freedesktop.org/ |
| **gst-plugins-good** | 1.24.1 | GStreamer Good Plug-ins | https://gstreamer.freedesktop.org/ |
| **gst-plugins-ugly** | 1.24.1 | GStreamer Ugly Plug-ins | https://gstreamer.freedesktop.org/ |
| **gst-python** | 1.24.1 | Python bindings for GStreamer | https://gstreamer.freedesktop.org/ |
| **gstreamer** | 1.24.1 | Open source multimedia framework | https://gstreamer.freedesktop.org/ |
...
| **imagemagick** | 7.1.1.29 | Suite to create, edit, compose, or convert images in a variety of formats | https://www.imagemagick.org/ |
| **imagemagick-static** | 7.1.1.29 | Static libraries for imagemagick | https://www.imagemagick.org/ |
...
| **jfrog-cli** | 2.54.0 | A CLI for JFrog products | https://jfrog.com/getcli |
...
| **jql** | 7.1.6 | A JSON Query Language CLI tool | https://github.com/yamafaktory/jql |
...
| **kubecolor** | 0.2.2 | Colorize your kubectl output | https://github.com/kubecolor/kubecolor |
...
| **lazygit** | 0.41.0-1 | Simple terminal UI for git commands | https://github.com/jesseduffield/lazygit |
...
| **libandroid-utimes** | 0.2 | futimes, futimesat and lutimes from bionic | https://github.com/termux/libandroid-utimes |
| **libandroid-utimes-static** | 0.2 | Static libraries for libandroid-utimes | https://github.com/termux/libandroid-utimes |
...
| **libarrow-cpp** | 15.0.1 | C++ libraries for Apache Arrow | https://github.com/apache/arrow |
...
| **libc++utilities** | 5.24.7 | Useful C++ classes and routines such as argument parser, IO and conversion utilities | https://github.com/Martchus/cpp-utilities |
...
| **libcompiler-rt** | 18.1.2 | Compiler runtime libraries for clang | https://clang.llvm.org/ |
...
| **libcurl** | 8.7.1 | Easy-to-use client-side URL transfer library | https://curl.se/ |
| **libcurl-static** | 8.7.1 | Static libraries for libcurl | https://curl.se/ |
...
| **libdav1d** | 1.4.1 | AV1 cross-platform decoder focused on speed and correctness | https://code.videolan.org/videolan/dav1d/ |
...
| **libduckdb** | 0.10.1 | An in-process SQL OLAP database management system | https://duckdb.org/ |
| **libduckdb-static** | 0.10.1 | Static libraries for libduckdb | https://duckdb.org/ |
...
| **libgit2** | 1.8.0 | C library implementing Git core methods | https://libgit2.github.com/ |
...
| **libgts** | 0.7.6 | Provides useful functions to deal with 3D surfaces meshed with interconnected triangles | https://gts.sourceforge.net/ |
| **libgts-static** | 0.7.6 | Static libraries for libgts | https://gts.sourceforge.net/ |
...
| **libicu** | 74.2-1 | International Components for Unicode library | http://site.icu-project.org/home |
| **libicu-static** | 74.2-1 | Static libraries for libicu | http://site.icu-project.org/home |
...
| **libimagequant** | 4.3.0 | Small, portable C library for high-quality conversion of RGBA images to 8-bit indexed-color (palette) images | https://pngquant.org/lib/ |
| **libimagequant-static** | 4.3.0 | Static libraries for libimagequant | https://pngquant.org/lib/ |
...
| **libjasper** | 4.2.2 | Library for manipulating JPEG-2000 files | http://www.ece.uvic.ca/~frodo/jasper/ |
| **libjasper-utils** | 4.2.2 | JPEG-2000 utilities | http://www.ece.uvic.ca/~frodo/jasper/ |
...
| **libllvm** | 18.1.2 | Modular compiler and toolchain technologies library | https://clang.llvm.org/ |
| **libllvm-static** | 18.1.2 | Static libraries for libllvm | https://clang.llvm.org/ |
...
| **libluajit** | 1:2.1.1710088188 | Just-In-Time Compiler for Lua | https://luajit.org/ |
| **libluajit-static** | 1:2.1.1710088188 | Static libraries for libluajit | https://luajit.org/ |
...
| **libmaxminddb** | 1.9.1 | MaxMind GeoIP2 database - library and utilities | https://dev.maxmind.com/geoip/geoip2/ |
| **libmaxminddb-static** | 1.9.1 | Static libraries for libmaxminddb | https://dev.maxmind.com/geoip/geoip2/ |
| **libmaxminddb-tools** | 1.9.1 | A geoip lookup utility for MaxMind DB | https://dev.maxmind.com/geoip/geoip2/ |
...
| **libmediainfo** | 24.01 | Library for reading information from media files | https://mediaarea.net/en/MediaInfo |
| **libmediainfo-static** | 24.01 | Static libraries for libmediainfo | https://mediaarea.net/en/MediaInfo |
...
| **libnats-c** | 3.8.0 | A C client for the NATS messaging system | https://nats-io.github.io/nats.c/ |
| **libnats-c-static** | 3.8.0 | Static libraries for libnats-c | https://nats-io.github.io/nats.c/ |
| **libncnn** | 20230627-2 | A high-performance neural network inference framework optimized for the mobile platform | https://github.com/Tencent/ncnn |
| **libncnn-static** | 20230627-2 | Static libraries for libncnn | https://github.com/Tencent/ncnn |
...
| **libnghttp3** | 1.2.0 | HTTP/3 library written in C | https://nghttp2.org/nghttp3/ |
| **libnghttp3-static** | 1.2.0 | Static libraries for libnghttp3 | https://nghttp2.org/nghttp3/ |
...
| **libnss** | 3.98 | Network Security Services (NSS) | https://firefox-source-docs.mozilla.org/security/nss/ |
...
| **libopenblas** | 0.3.26 | An optimized BLAS library based on GotoBLAS2 1.13 BSD | https://www.openblas.net |
| **libopenblas-static** | 0.3.26 | Static libraries for libopenblas | https://www.openblas.net |
...
| **libopenmpt** | 0.7.6 | OpenMPT based module player library and libopenmpt based command-line player | https://lib.openmpt.org/libopenmpt/ |
| **libopenmpt-static** | 0.7.6 | Static libraries for libopenmpt | https://lib.openmpt.org/libopenmpt/ |
...
| **libosmpbf** | 1.5.0-7 | osmpbf is a Java/C library to read and write OpenStreetMap PBF files | https://github.com/openstreetmap/OSM-binary/ |
| **libosmpbf-static** | 1.5.0-7 | Static libraries for libosmpbf | https://github.com/openstreetmap/OSM-binary/ |
...
| **libpolly** | 18.1.2 | High-level loop and data-locality optimizer for clang | https://clang.llvm.org/ |
...
| **libre2** | 2024.03.01 | A regular expression library | https://github.com/google/re2 |
...
| **libunbound** | 1.19.3 | A validating, recursive, caching DNS resolver | https://unbound.net/ |
| **libunbound-static** | 1.19.3 | Static libraries for libunbound | https://unbound.net/ |
...
| **libutf8-range** | 2:25.1 | Fast UTF-8 validation with Range algorithm | https://github.com/protocolbuffers/protobuf |
...
| **libvips** | 8.15.2a | A fast image processing library with low memory needs | https://libvips.github.io/libvips/ |
...
| **lld** | 18.1.2 | LLVM-based linker | https://clang.llvm.org/ |
| **llvm** | 18.1.2 | LLVM modular compiler and toolchain executables | https://clang.llvm.org/ |
...
| **llvm-tools** | 18.1.2 | LLVM Development Tools | https://clang.llvm.org/ |
| **llvmgold** | 18.1.2 | LLVM gold plugin | https://clang.llvm.org/ |
...
| **memcached** | 1.6.26 | Free & open source, high-performance, distributed memory object caching system | https://memcached.org/ |
...
| **mlir** | 18.1.2 | A Multi-Level Intermediate Representation for compilers from LLVM | https://clang.llvm.org/ |
...
| **mosh** | 1.4.0-8 | Mobile shell that supports roaming and intelligent local echo | https://mosh.org |
| **mosh-perl** | 1.4.0-8 | The mosh Perl script | https://mosh.org |
...
| **mupdf** | 1.24.0 | Lightweight PDF and XPS viewer (library) | https://mupdf.com/ |
| **mupdf-static** | 1.24.0 | Static libraries for mupdf | https://mupdf.com/ |
| **mupdf-tools** | 1.24.0 | Lightweight PDF and XPS viewer (utilities) | https://mupdf.com/ |
...
| **mympd** | 14.1.0 | A standalone and lightweight web-based MPD client | https://jcorporation.github.io/myMPD/ |
...
| **nala** | 0.15.1 | Commandline frontend for the apt package manager | https://gitlab.com/volian/nala |
...
| **navidrome** | 0.51.1 | 🎧☁️ Modern Music Server and Streamer compatible with Subsonic/Airsonic | https://www.navidrome.org/ |
...
| **ncspot** | 1.0.0 | An ncurses Spotify client written in Rust | https://github.com/hrkfdn/ncspot |
...
| **ndk-sysroot** | 26b-2 | System header and library files from the Android NDK needed for compiling C programs | https://developer.android.com/tools/sdk/ndk/index.html |
...
| **neomutt** | 20240323 | A version of mutt with added features | https://neomutt.org/ |
...
| **nginx** | 1.25.4 | Lightweight HTTP server | https://www.nginx.org |
...
| **nss-utils** | 3.98 | Tools for NSS | https://firefox-source-docs.mozilla.org/security/nss/ |
| **nudoku** | 2.1.0 | ncurses based sudoku game | http://jubalh.github.io/nudoku/ |
| **nushell** | 0.91.0 | A new type of shell operating on structured data | https://www.nushell.sh |
...
| **openfoam** | 2312 | OpenFOAM is a CFD software written in C++ | https://www.openfoam.com |
...
| **parallel** | 20240222 | GNU Parallel is a shell tool for executing jobs in parallel using one or more machines | https://www.gnu.org/software/parallel/ |
...
| **perl** | 5.38.2-2 | Capable, feature-rich programming language | https://www.perl.org/ |
...
| **pipewire** | 1.0.4 | A server and user space API to deal with multimedia pipelines | https://pipewire.org/ |
...
| **postgresql** | 16.2 | Object-relational SQL database | https://www.postgresql.org |
| **postgresql-static** | 16.2 | Static libraries for postgresql | https://www.postgresql.org |
...
| **procs** | 0.14.5 | A modern replacement for ps | https://github.com/dalance/procs |
...
| **proj** | 9.4.0 | Generic coordinate transformation software | https://proj.org |
| **proot** | 5.1.107-62 | Emulate chroot, bind mount and binfmt_misc for non-root users | https://proot-me.github.io/ |
| **proot-distro** | 4.11.0 | Termux official utility for managing proot'ed Linux distributions | https://github.com/termux/proot-distro |
| **protobuf** | 2:25.1 | Compiler for protocol buffer definition files | https://github.com/protocolbuffers/protobuf |
| **protobuf-dev** | 2:25.1 | CMake files for protobuf shared libraries | https://github.com/protocolbuffers/protobuf |
| **protobuf-static** | 25.1 | Protocol buffers C++ library (static) | https://github.com/protocolbuffers/protobuf |
...
| **python-apsw** | 3.45.2.0 | Another Python SQLite Wrapper | https://github.com/rogerbinns/apsw/ |
...
| **python-grpcio** | 1.62.1 | High performance, open source, general RPC framework that puts mobile and HTTP/2 first | https://grpc.io/ |
...
| **python-pillow** | 10.2.0-1 | Python Imaging Library | https://python-pillow.org/ |
| **python-pip** | 24.0-1 | The PyPA recommended tool for installing Python packages | https://pip.pypa.io/ |
| **python-pyarrow** | 15.0.1 | Python bindings for Apache Arrow | https://github.com/apache/arrow |
...
| **qpdf** | 11.9.0 | Content-Preserving PDF Transformation System | http://qpdf.sourceforge.net |
...
| **rav1e** | 0.7.1 | An AV1 encoder program focused on speed and safety | https://github.com/xiph/rav1e/ |
...
| **rclone** | 1.66.0 | rsync for cloud storage | https://rclone.org/ |
...
| **recoll** | 1.37.4 | Full-text search for your desktop | https://www.lesbonscomptes.com/recoll/index.html |
| **recoll-python** | 1.37.4 | Python interface for Recoll | https://www.lesbonscomptes.com/recoll/index.html |
| **recoll-static** | 1.37.4 | Static libraries for recoll | https://www.lesbonscomptes.com/recoll/index.html |
...
| **robin-map** | 1.2.2 | C++ implementation of a fast hash map and hash set using robin hood hashing | https://github.com/Tessil/robin-map/ |
...
| **ruff** | 0.3.0 | An extremely fast Python linter, written in Rust | https://github.com/charliermarsh/ruff |
...
| **rust** | 1.77.0 | Systems programming language focused on safety, speed and concurrency | https://www.rust-lang.org/ |
...
| **rust-docs** | 1.77.0 | Rust documentation | https://www.rust-lang.org/ |
| **rust-src** | 1.77.0 | Rust source code files | https://www.rust-lang.org/ |
| **rust-std-aarch64-linux-android** | 1.77.0 | Rust std for target aarch64-linux-android | https://www.rust-lang.org/ |
| **rust-std-armv7-linux-androideabi** | 1.77.0 | Rust std for target armv7-linux-androideabi | https://www.rust-lang.org/ |
| **rust-std-i686-linux-android** | 1.77.0 | Rust std for target i686-linux-android | https://www.rust-lang.org/ |
| **rust-std-wasm32-unknown-unknown** | 1.77.0 | Rust std for target wasm32-unknown-unknown | https://www.rust-lang.org/ |
| **rust-std-wasm32-wasi** | 1.77.0 | Rust std for target wasm32-wasi | https://www.rust-lang.org/ |
| **rust-std-x86-64-linux-android** | 1.77.0 | Rust std for target x86_64-linux-android | https://www.rust-lang.org/ |
| **rustc-dev** | 1.77.0 | Rust compiler development libs | https://www.rust-lang.org/ |
| **rustc-src** | 1.77.0 | Rust compiler source code files | https://www.rust-lang.org/ |
...
| **sabnzbd** | 4.2.3 | Fully automated Usenet Binary Downloader | https://sabnzbd.org/ |
...
| **scala** | 3.4.0 | Scala 3 compiler and standard library. | https://www.scala-lang.org |
...
| **sccache** | 0.7.7 | sccache is ccache with cloud storage | https://github.com/mozilla/sccache |
| **scdaemon** | 2.4.4 | Daemon invoked by gpg to manage smartcards | https://www.gnupg.org/ |
...
| **seafile-client** | 9.0.5 | Seafile is a file syncing and sharing software with file encryption and group sharing | https://seafile.com |
| **seafile-client-static** | 9.0.5 | Static libraries for seafile-client | https://seafile.com |
...
| **shaderc** | 2024.0 | Collection of tools, libraries, and tests for Vulkan shader compilation | https://github.com/google/shaderc |
...
| **sing-box** | 1.8.10 | The universal proxy platform | https://sing-box.sagernet.org |
...
| **speedtest-go** | 1.6.10 | Command line interface to test internet speed using speedtest.net | https://github.com/showwin/speedtest-go/ |
...
| **spglib** | 2.3.1 | C library for finding and handling crystal symmetries | https://spglib.github.io/spglib/index.html |
...
| **squid** | 6.8 | Full-featured Web proxy cache server | http://www.squid-cache.org |
...
| **sslscan** | 2.1.3 | Utility to discover supported cipher suites on SSL/TLS enabled servers | https://github.com/rbsec/sslscan |
...
| **teleport-tsh** | 15.1.10 | Secure Access for Developers that doesn't get in the way | https://github.com/gravitational/teleport |
...
| **texlab** | 5.14.1 | A cross-platform implementation of the Language Server Protocol providing rich cross-editing support for the LaTeX typesetting system | https://texlab.netlify.app/ |
...
| **timg** | 1.6.0 | A terminal image and video viewer | https://timg.sh/ |
...
| **trurl** | 0.10 | trurl is a command line tool that parses and manipulates URLs | https://curl.se/trurl/ |
...
| **ttyd** | 1.7.5 | Command-line tool for sharing terminal over the web | https://tsl0922.github.io/ttyd/ |
| **ttyper** | 1.4.1 | Terminal-based typing test | https://github.com/max-niederman/ttyper |
| **ttyplot** | 1.6.2 | A realtime plotting utility for terminal with data input from stdin | https://github.com/tenox7/ttyplot |
...
| **ugrep** | 5.1.1 | A faster, user-friendly and compatible grep replacement | https://github.com/Genivia/ugrep |
| **unar** | 1.10.7-7 | Command line tools for archive and file unarchiving and extraction | https://theunarchiver.com/command-line |
| **unbound** | 1.19.3 | Unbound command-line tools | https://unbound.net/ |
...
| **upx** | 4.2.3 | the Ultimate Packer for eXecutables | https://upx.github.io/ |
...
| **uwsgi** | 2.0.24-1 | uWSGI application server container | https://projects.unbit.it/uwsgi |
| **v2ray** | 5.15.1 | A platform for building proxies to bypass network restrictions | https://www.v2fly.org/ |
...
| **valadoc-static** | 0.56.16 | Static libraries for valadoc | https://wiki.gnome.org/Projects/Vala |
| **vale** | 3.3.1 | A syntax-aware linter for prose built with speed and extensibility in mind | https://vale.sh |
...
| **vcsh** | 2.0.8 | Config manager based on Git | https://github.com/RichiH/vcsh |
...
| **vtm** | 0.9.75a | Terminal multiplexer with TUI window manager and multi-party session sharing | https://vtm.netxs.online/ |
...
| **vulkan-loader-generic** | 1.3.281 | Vulkan Loader | https://github.com/KhronosGroup/Vulkan-Loader |
| **vulkan-tools** | 1.3.280 | Vulkan Tools and Utilities | https://github.com/KhronosGroup/Vulkan-Tools |
| **vulkan-utility-libraries** | 1.3.281 | Utility Libraries for Vulkan | https://github.com/KhronosGroup/Vulkan-Utility-Libraries |
...
| **whois** | 5.5.21 | An intelligent Whois client | https://github.com/rfc1036/whois |
...
| **xmake** | 2.8.9 | A cross-platform build utility based on Lua | https://xmake.io/ |
| **xmlsec** | 1.3.3 | XML Security Library | https://www.aleksey.com/xmlsec/ |
| **xmlsec-static** | 1.3.3 | Static libraries for xmlsec | https://www.aleksey.com/xmlsec/ |
...
| **yara** | 4.5.0 | Tool aimed at helping malware researchers to identify and classify malware samples | https://github.com/VirusTotal/yara |
| **yara-static** | 4.5.0 | Static libraries for yara | https://github.com/VirusTotal/yara |
...
| **yazi** | 0.2.4 | Blazing fast terminal file manager written in Rust, based on async I/O | https://yazi-rs.github.io/ |
| **yosys** | 0.38 | A framework for RTL synthesis tools | https://yosyshq.net/yosys/ |
| **youtubedr** | 2.10.1 | Download youtube video in Golang | https://github.com/kkdai/youtube |
| **yq** | 4.43.1 | A lightweight and portable command-line YAML, JSON and XML processor | https://mikefarah.gitbook.io/yq/ |
...
| **znc** | 1.9.0 | An advanced IRC bouncer | https://znc.in/ |
| **zopfli** | 1.0.3-3 | New zlib compatible compressor tools | https://github.com/google/zopfli |
| **zoxide** | 0.9.4 | A faster way to navigate your filesystem | https://github.com/ajeetdsouza/zoxide |
