...
| **agate** | 3.3.8 | Very simple server for the Gemini hypertext protocol | https://github.com/mbrubeck/agate |
...
| **broot** | 1.44.0 | A better way to navigate directories | https://github.com/Canop/broot |
...
| **buf** | 1.40.1 | A new way of working with Protocol Buffers | https://buf.build |
...
| **chafa** | 1.14.2 | Image-to-text converter supporting a wide range of symbols, etc. | https://hpjansson.org/chafa/ |
| **chafa-static** | 1.14.2 | Static libraries for chafa | https://hpjansson.org/chafa/ |
...
| **cloudflared** | 2024.8.3 | A tunneling daemon that proxies traffic from the Cloudflare network to your origins | https://github.com/cloudflare/cloudflared |
...
| **cmake** | 3.30.3 | Family of tools designed to build, test and package software | https://cmake.org/ |
| **cmake-curses-gui** | 3.30.3 | Curses based user interface for CMake (ccmake) | https://cmake.org/ |
...
| **croc** | 1:10.0.11 | Easily and securely send things from one computer to another | https://github.com/schollz/croc |
...
| **curl** | 8.9.1 | Command line tool for transferring data with URL syntax | https://curl.se/ |
...
| **emscripten** | 3.1.65 | Emscripten: An LLVM-to-WebAssembly Compiler | https://emscripten.org |
| **emscripten-binaryen** | 3.1.65 | Emscripten-compatible Binaryen | https://emscripten.org |
| **emscripten-llvm** | 3.1.65 | Emscripten-compatible LLVM | https://emscripten.org |
| **emscripten-tests-third-party** | 3.1.65 | Emscripten third party test suite files | https://emscripten.org |
...
| **eza** | 0.19.2 | A modern replacement for ls | https://github.com/eza-community/eza |
...
| **fastfetch** | 2.23.0 | A neofetch-like tool for fetching system information and displaying them in a pretty way | https://github.com/fastfetch-cli/fastfetch |
...
| **git-svn** | 2.46.0 | Convert between Git and Subversion repositories | https://git-scm.com/ |
...
| **glab-cli** | 1.46.0 | A GitLab CLI tool bringing GitLab to your command line | https://gitlab.com/gitlab-org/cli |
...
| **hugo** | 0.134.1 | A fast and flexible static site generator | https://gohugo.io/ |
...
| **imagemagick** | 7.1.1.38 | Suite to create, edit, compose, or convert images in a variety of formats | https://www.imagemagick.org/ |
| **imagemagick-static** | 7.1.1.38 | Static libraries for imagemagick | https://www.imagemagick.org/ |
...
| **imlib2** | 1.12.3 | Library that does image file loading and saving as well as rendering, manipulation, arbitrary polygon support | https://sourceforge.net/projects/enlightenment/ |
| **imlib2-static** | 1.12.3 | Static libraries for imlib2 | https://sourceforge.net/projects/enlightenment/ |
...
| **ipfs** | 0.29.0 | A peer-to-peer hypermedia distribution protocol | https://ipfs.io/ |
| **ipmitool** | 1.8.19 | Command-line interface to IPMI-enabled devices | https://github.com/ipmitool/ipmitool |
| **iproute2** | 6.10.0 | Utilities for controlling networking | https://wiki.linuxfoundation.org/networking/iproute2 |
...
| **lgogdownloader** | 3.15 | Open source downloader to GOG.com for Linux users using the same API as the official GOGDownloader | https://sites.google.com/site/gogdownloader/ |
...
| **libc++utilities** | 5.26.0 | Useful C++ classes and routines such as argument parser, IO and conversion utilities | https://github.com/Martchus/cpp-utilities |
...
| **libcurl** | 8.9.1 | Easy-to-use client-side URL transfer library | https://curl.se/ |
| **libcurl-static** | 8.9.1 | Static libraries for libcurl | https://curl.se/ |
...
| **libgc** | 8.2.6 | Library providing the Boehm-Demers-Weiser conservative garbage collector | https://www.hboehm.info/gc/ |
...
| **libjpeg-turbo** | 3.0.3 | Library for reading and writing JPEG image files | https://libjpeg-turbo.virtualgl.org |
| **libjpeg-turbo-progs** | 3.0.3 | Programs for manipulating JPEG files | https://libjpeg-turbo.virtualgl.org |
| **libjpeg-turbo-static** | 3.0.3 | Static libraries for libjpeg-turbo | https://libjpeg-turbo.virtualgl.org |
| **libjxl** | 0.10.3 | JPEG XL image format reference implementation | https://jpegxl.info/ |
| **libjxl-progs** | 0.10.3 | Programs for manipulating JPEG XL files | https://jpegxl.info/ |
...
| **libmount** | 2.39.3-4 | Library for (un)mounting filesystems | https://en.wikipedia.org/wiki/Util-linux |
...
| **libsmartcols** | 2.39.3-4 | Library for smart adaptive formatting of tabular data | https://en.wikipedia.org/wiki/Util-linux |
...
| **lua-language-server** | 3.10.5 | Sumneko Lua Language Server coded in Lua | https://github.com/sumneko/lua-language-server |
...
| **minio** | 2024.08.29.01.40.52 | Multi-Cloud Object Storage | https://min.io/ |
| **miniserve** | 0.27.1-1 | Tool to serve files and dirs over HTTP | https://github.com/svenstaro/miniserve |
...
| **mympd** | 17.0.3 | A standalone and lightweight web-based MPD client | https://jcorporation.github.io/myMPD/ |
...
| **ncurses** | 6.4.20231001-5 | Library for text-based user interfaces in a terminal-independent manner | https://invisible-island.net/ncurses/ |
| **ncurses-static** | 6.4.20231001-5 | Static libraries for ncurses | https://invisible-island.net/ncurses/ |
| **ncurses-ui-libs** | 6.4.20231001-5 | Libraries for terminal user interfaces based on ncurses | https://invisible-island.net/ncurses/ |
| **ncurses-ui-libs-static** | 6.4.20231001-5 | Static libraries for terminal user interfaces based on ncurses | https://invisible-island.net/ncurses/ |
| **ncurses-utils** | 6.4.20231001-5 | Tools for working with terminals | https://invisible-island.net/ncurses/ |
...
| **nodejs** | 22.5.1 | Open Source, cross-platform JavaScript runtime environment | https://nodejs.org/ |
...
| **oh-my-posh** | 23.11.1 | A prompt theme engine for any shell. | https://ohmyposh.dev |
...
| **pacman** | 6.1.0-1 | A library-based package manager with dependency support | https://archlinux.org/pacman/ |
...
| **plantuml** | 1.2024.6 | Draws UML diagrams, using a simple and human readable text description | https://plantuml.com/ |
...
| **python-onnxruntime** | 1.19.0 | Cross-platform, high performance ML inferencing and training accelerator | https://onnxruntime.ai/ |
...
| **recoll** | 1.40.0 | Full-text search for your desktop | https://www.recoll.org/ |
| **recoll-python** | 1.40.0 | Python interface for Recoll | https://www.recoll.org/ |
...
| **remind** | 1:05.00.05 | Sophisticated calendar and alarm program | https://dianne.skoll.ca/projects/remind/ |
...
| **rust-analyzer** | 20240902 | A Rust compiler front-end for IDEs | https://github.com/rust-lang/rust-analyzer |
...
| **shaderc** | 2024.1 | Collection of tools, libraries, and tests for Vulkan shader compilation | https://github.com/google/shaderc |
...
| **squid** | 6.10 | Full-featured Web proxy cache server | http://www.squid-cache.org |
...
| **storj-uplink** | 1.110.3 | Storj DCS Uplink CLI | https://www.storj.io/integrations/uplink-cli |
...
| **tdl** | 0.17.3 | Telegram downloader/tools written in Golang | https://docs.iyear.me/tdl/ |
...
| **teleport-tsh** | 16.2.1 | Secure Access for Developers that doesn't get in the way | https://github.com/gravitational/teleport |
...
| **termux-tools** | 1.43.4-1 | Basic system tools for Termux | https://termux.dev/ |
...
| **tinygo** | 0.32.0 | Go compiler for microcontrollers, WASM, CLI tools | https://tinygo.org |
| **tinygo-common** | 0.32.0 | TinyGo common files | https://tinygo.org |
...
| **tree-sitter-lua** | 0.1.0-2 | Lua grammar for tree-sitter | https://github.com/tree-sitter-grammars |
| **tree-sitter-lua-static** | 0.1.0-2 | Static libraries for tree-sitter-lua | https://github.com/tree-sitter-grammars |
| **tree-sitter-markdown** | 0.2.3-3 | Tree-sitter parser for Markdown | https://github.com/tree-sitter-grammars |
| **tree-sitter-markdown-static** | 0.2.3-3 | Static libraries for tree-sitter-markdown | https://github.com/tree-sitter-grammars |
...
| **util-linux** | 2.39.3-4 | Miscellaneous system utilities | https://en.wikipedia.org/wiki/Util-linux |
...
| **wasm-component-ld** | 0.5.7 | Command line linker for creating WebAssembly components | https://github.com/bytecodealliance/wasm-component-ld |
...
| **weechat** | 4.4.1 | Fast, light and extensible IRC chat client | https://weechat.org/ |
| **weechat-lua-plugin** | 4.4.1 | WeeChat Lua Plugin | https://weechat.org/ |
| **weechat-perl-plugin** | 4.4.1 | WeeChat Perl Plugin | https://weechat.org/ |
| **weechat-python-plugin** | 4.4.1 | WeeChat Python3 Plugin | https://weechat.org/ |
| **weechat-ruby-plugin** | 4.4.1 | WeeChat Ruby Plugin | https://weechat.org/ |
...
| **wireguard-tools** | 1.0.20210914-1 | Tools for the WireGuard secure network tunnel | https://www.wireguard.com |
...
| **yara** | 4.5.1 | Tool aimed at helping malware researchers to identify and classify malware samples | https://github.com/VirusTotal/yara |
| **yara-static** | 4.5.1 | Static libraries for yara | https://github.com/VirusTotal/yara |
...
| **zrok** | 0.4.39 | An open source sharing solution built on OpenZiti. | https://zrok.io/ |
