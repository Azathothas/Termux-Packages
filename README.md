...
| **pocketbase** | 0.23.6 | An open source Go backend | https://github.com/pocketbase/pocketbase |
...
| **uv** | 0.5.8 | An extremely fast Python package installer and resolver, written in Rust. | https://docs.astral.sh/uv/ |
