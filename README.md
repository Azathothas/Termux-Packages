...
| **cargo-c** | 0.10.0 | Cargo C-ABI helpers | https://github.com/lu-zero/cargo-c |
...
| **ccache** | 4.10 | Compiler cache for fast recompilation of C/C++ code | https://ccache.samba.org |
...
| **clang** | 18.1.7-1 | C language frontend for LLVM | https://clang.llvm.org/ |
...
| **clvk** | 0.0.20240617.092132 | Experimental implementation of OpenCL on Vulkan | https://github.com/kpet/clvk |
...
| **command-not-found** | 2.4.0-30 | Suggest installation of packages in interactive shell sessions | https://github.com/termux/command-not-found |
...
| **croc** | 1:10.0.9 | Easily and securely send things from one computer to another | https://github.com/schollz/croc |
...
| **elixir** | 1.17.1 | Elixir is a dynamic, functional language designed for building scalable and maintainable applications | https://elixir-lang.org/ |
...
| **esbuild** | 0.21.5 | An extremely fast JavaScript bundler | https://esbuild.github.io/ |
...
| **exiftool** | 12.87 | Utility for reading, writing and editing meta information in a wide variety of files. | https://exiftool.org/ |
...
| **fastfetch** | 2.16.0 | A neofetch-like tool for fetching system information and displaying them in a pretty way | https://github.com/fastfetch-cli/fastfetch |
...
| **forgejo** | 7.0.4 | Forgejo is a self-hosted lightweight software forge. | https://forgejo.org/ |
...
| **gleam** | 1.2.1 | A friendly language for building type-safe, scalable systems! | https://gleam.run |
| **glib** | 2.80.3 | Library providing core building blocks for libraries and applications written in C | https://developer.gnome.org/glib/ |
| **glib-bin** | 2.80.3 | Programs for the GLib library | https://developer.gnome.org/glib/ |
| **glib-cross** | 2.80.3 | glib for host (NOT for Termux) | https://developer.gnome.org/glib/ |
...
| **gopls** | 0.16.0 | The official Go language server | https://github.com/golang/tools |
...
| **haproxy** | 3.0.2 | The Reliable, High Performance TCP/HTTP Load Balancer | https://www.haproxy.org/ |
...
| **hcloud** | 1.44.1 | Hetzner Cloud command line client | https://github.com/hetznercloud/cli |
...
| **hugo** | 0.128.0 | A fast and flexible static site generator | https://gohugo.io/ |
...
| **jfrog-cli** | 2.59.0 | A CLI for JFrog products | https://jfrog.com/getcli |
...
| **just** | 1.29.1 | A handy way to save and run project-specific commands | https://just.systems |
...
| **libcompiler-rt** | 18.1.7-1 | Compiler runtime libraries for clang | https://clang.llvm.org/ |
...
| **libgrpc** | 1.64.2 | High performance, open source, general RPC framework that puts mobile and HTTP/2 first | https://grpc.io/ |
...
| **libheif** | 1.17.6 | HEIF (HEIC/AVIF) image encoding and decoding library | https://github.com/strukturag/libheif |
| **libheif-progs** | 1.17.6 | Programs for manipulating HEIF (HEIC/AVIF) image files | https://github.com/strukturag/libheif |
...
| **libjxl** | 0.10.2 | JPEG XL image format reference implementation | https://jpegxl.info/ |
| **libjxl-progs** | 0.10.2 | Programs for manipulating JPEG XL files | https://jpegxl.info/ |
...
| **libllvm** | 18.1.7-1 | Modular compiler and toolchain technologies library | https://clang.llvm.org/ |
| **libllvm-static** | 18.1.7-1 | Static libraries for libllvm | https://clang.llvm.org/ |
...
| **libpolly** | 18.1.7-1 | High-level loop and data-locality optimizer for clang | https://clang.llvm.org/ |
...
| **libre2** | 2024.03.01-1 | A regular expression library | https://github.com/google/re2 |
...
| **librsvg** | 2.58.1 | Library to render SVG files using cairo | https://wiki.gnome.org/action/show/Projects/LibRsvg |
...
| **libunbound** | 1.20.0 | A validating, recursive, caching DNS resolver | https://unbound.net/ |
| **libunbound-static** | 1.20.0 | Static libraries for libunbound | https://unbound.net/ |
...
| **libwolfssl** | 5.7.0 | A small, fast, portable implementation of TLS/SSL for embedded devices to the cloud | https://www.wolfssl.com/ |
...
| **libxml2** | 2.13.1-1 | Library for parsing XML documents | http://www.xmlsoft.org |
| **libxml2-python** | 2.13.1-1 | Python bindings for libxml2 | http://www.xmlsoft.org |
| **libxml2-python-static** | 2.13.1-1 | Static libraries for libxml2-python | http://www.xmlsoft.org |
| **libxml2-static** | 2.13.1-1 | Static libraries for libxml2 | http://www.xmlsoft.org |
| **libxml2-utils** | 2.13.1-1 | XML utilities | http://www.xmlsoft.org |
...
| **lld** | 18.1.7-1 | LLVM-based linker | https://clang.llvm.org/ |
| **llvm** | 18.1.7-1 | LLVM modular compiler and toolchain executables | https://clang.llvm.org/ |
...
| **llvm-tools** | 18.1.7-1 | LLVM Development Tools | https://clang.llvm.org/ |
| **llvmgold** | 18.1.7-1 | LLVM gold plugin | https://clang.llvm.org/ |
...
| **matplotlib** | 3.9.0 | A comprehensive library for creating static, animated, and interactive visualizations in Python | https://matplotlib.org/ |
...
| **mlir** | 18.1.7-1 | A Multi-Level Intermediate Representation for compilers from LLVM | https://clang.llvm.org/ |
| **mlocate** | 0.26-5 | Tool to find files anywhere in the filesystem based on their name | https://pagure.io/mlocate |
| **mold** | 2.32.0 | mold: A Modern Linker | https://github.com/rui314/mold |
...
| **mupdf** | 1.24.4 | Lightweight PDF and XPS viewer (library) | https://mupdf.com/ |
| **mupdf-static** | 1.24.4 | Static libraries for mupdf | https://mupdf.com/ |
| **mupdf-tools** | 1.24.4 | Lightweight PDF and XPS viewer (utilities) | https://mupdf.com/ |
...
| **mympd** | 15.0.2 | A standalone and lightweight web-based MPD client | https://jcorporation.github.io/myMPD/ |
...
| **neocmakelsp** | 0.7.6 | a cmake lsp based on tower-lsp and treesitter | https://github.com/Decodetalkers/neocmakelsp |
...
| **ngspice** | 42 | A mixed-level/mixed-signal circuit simulator | https://ngspice.sourceforge.net/ |
...
| **oh-my-posh** | 21.16.2 | A prompt theme engine for any shell. | https://ohmyposh.dev |
...
| **open-adventure** | 1.18-1 | Forward-port of the original Colossal Cave Adventure from 1976-77 | http://www.catb.org/~esr/open-adventure/ |
...
| **openjdk-17** | 17.0-33 | Java development kit and runtime | https://github.com/openjdk/mobile |
| **openjdk-17-source** | 17.0-33 | Source files for openjdk-17 | https://github.com/openjdk/mobile |
| **openjdk-17-x** | 17.0-33 | Portion of openjdk-17 requiring X11 functionality | https://github.com/openjdk/mobile |
...
| **pipewire** | 1.1.82-1 | A server and user space API to deal with multimedia pipelines | https://pipewire.org/ |
...
| **proot-distro** | 4.14.0 | Termux official utility for managing proot'ed Linux distributions | https://github.com/termux/proot-distro |
...
| **python** | 3.11.9-2 | Python 3 programming language intended to enable clear programs | https://python.org/ |
...
| **python-ensurepip-wheels** | 3.11.9-2 | Wheels for Python ensurepip | https://python.org/ |
...
| **python-grpcio** | 1.64.2 | High performance, open source, general RPC framework that puts mobile and HTTP/2 first | https://grpc.io/ |
...
| **python-static** | 3.11.9-2 | Static libraries for python | https://python.org/ |
| **python-tkinter** | 3.11.9-2 | Tkinter support for Python 3 | https://python.org/ |
...
| **recoll** | 1.37.5 | Full-text search for your desktop | https://www.recoll.org/ |
| **recoll-python** | 1.37.5 | Python interface for Recoll | https://www.recoll.org/ |
...
| **restic** | 0.16.4 | Fast, secure, efficient backup program | https://restic.net/ |
...
| **rgbds** | 0.7.0 | Rednex Game Boy Development System - An assembly toolchain for the Nintendo Game Boy & Game Boy Color | https://rgbds.gbdev.io |
...
| **ruff** | 0.4.10 | An extremely fast Python linter, written in Rust | https://github.com/charliermarsh/ruff |
...
| **rustscan** | 2.2.3 | The modern,fast,smart and effective port scanner | https://rustscan.github.io/RustScan |
...
| **scc** | 3.3.4 | Counts physical the lines of code, blank lines, comment lines, and physical lines of source code | https://github.com/boyter/scc |
...
| **speedtest-go** | 1.7.7 | Command line interface to test internet speed using speedtest.net | https://github.com/showwin/speedtest-go/ |
...
| **spglib** | 2.4.0 | C library for finding and handling crystal symmetries | https://spglib.github.io/spglib/index.html |
...
| **step-cli** | 0.26.2 | An easy-to-use CLI tool for building, operating, and automating Public Key Infrastructure (PKI) systems and workflows | https://smallstep.com/cli |
...
| **storj-uplink** | 1.104.5 | Storj DCS Uplink CLI | https://www.storj.io/integrations/uplink-cli |
...
| **svt-av1** | 2.1.0 | Scalable Video Technology for AV1 (SVT-AV1 Encoder and Decoder) | https://gitlab.com/AOMediaCodec/SVT-AV1 |
| **swaks** | 20240103.0 | Swiss Army Knife for SMTP | http://jetmore.org/john/code/swaks/ |
| **swi-prolog** | 9.3.7 | Most popular and complete prolog implementation | https://swi-prolog.org/ |
...
| **taplo** | 0.9.1 | A TOML LSP and toolkit | https://taplo.tamasfe.dev/ |
...
| **tdl** | 0.17.2 | Telegram downloader/tools written in Golang | https://docs.iyear.me/tdl/ |
...
| **termux-keyring** | 3.12 | GPG public keys for the official Termux repositories | https://github.com/termux |
...
| **texlab** | 5.17.0 | A cross-platform implementation of the Language Server Protocol providing rich cross-editing support for the LaTeX typesetting system | https://texlab.netlify.app/ |
...
| **toml11** | 4.0.1 | toml11 is a C++11 (or later) header-only toml parser/encoder depending only on C++ standard library | https://github.com/ToruNiina/toml11 |
...
| **transmission** | 4.0.6 | Easy, lean and powerful BitTorrent client | https://transmissionbt.com/ |
...
| **unbound** | 1.20.0 | Unbound command-line tools | https://unbound.net/ |
...
| **vtm** | 0.9.83 | Terminal multiplexer with TUI window manager and multi-party session sharing | https://vtm.netxs.online/ |
...
| **vulkan-extension-layer** | 1.3.287 | Vulkan Extension Layer | https://github.com/KhronosGroup/Vulkan-ExtensionLayer |
...
| **weechat** | 4.3.3 | Fast, light and extensible IRC chat client | https://weechat.org/ |
| **weechat-lua-plugin** | 4.3.3 | WeeChat Lua Plugin | https://weechat.org/ |
| **weechat-perl-plugin** | 4.3.3 | WeeChat Perl Plugin | https://weechat.org/ |
| **weechat-python-plugin** | 4.3.3 | WeeChat Python3 Plugin | https://weechat.org/ |
| **weechat-ruby-plugin** | 4.3.3 | WeeChat Ruby Plugin | https://weechat.org/ |
...
| **xh** | 0.22.0 | A friendly and fast tool for sending HTTP requests | https://github.com/ducaale/xh |
...
| **znc** | 1.9.0-1 | An advanced IRC bouncer | https://znc.in/ |
...
| **zrok** | 0.4.33 | An open source sharing solution built on OpenZiti. | https://zrok.io/ |
