...
| **atuin** | 18.3.0-1 | Magical shell history | https://atuin.sh/ |
...
| **uv** | 0.5.12 | An extremely fast Python package installer and resolver, written in Rust. | https://docs.astral.sh/uv/ |
