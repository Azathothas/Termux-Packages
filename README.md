...
| **b3sum** | 1.6.0 | A command line utility for calculating BLAKE3 hashes, similar to Coreutils tools like b2sum or md5sum | https://github.com/BLAKE3-team/BLAKE3/tree/master/b3sum |
...
| **bash** | 5.2.37-1 | A sh-compatible shell that incorporates useful features from the Korn shell (ksh) and C shell (csh) | https://www.gnu.org/software/bash/ |
...
| **harfbuzz** | 10.3.0 | OpenType text shaping engine | https://www.freedesktop.org/wiki/Software/HarfBuzz/ |
| **harfbuzz-icu** | 10.3.0 | OpenType text shaping engine ICU backend | https://www.freedesktop.org/wiki/Software/HarfBuzz/ |
| **harfbuzz-utils** | 10.3.0 | Tools using the harfbuzz library | https://www.freedesktop.org/wiki/Software/HarfBuzz/ |
...
| **libgnustep-base** | 1.31.0 | A library of general-purpose, non-graphical Objective C objects | https://www.gnustep.org |
...
| **libnats-c** | 3.9.2 | A C client for the NATS messaging system | https://nats-io.github.io/nats.c/ |
| **libnats-c-static** | 3.9.2 | Static libraries for libnats-c | https://nats-io.github.io/nats.c/ |
...
| **libwebsockets** | 4.3.4 | Lightweight C websockets library | https://libwebsockets.org |
...
| **matplotlib** | 3.10.0 | A comprehensive library for creating static, animated, and interactive visualizations in Python | https://matplotlib.org/ |
...
| **mdbtools** | 1.0.0-3 | A set of programs to help you extract data from Microsoft Access files in various settings | https://github.com/mdbtools/mdbtools |
| **mdbtools-static** | 1.0.0-3 | Static libraries for mdbtools | https://github.com/mdbtools/mdbtools |
...
| **minio** | 2025.02.18.16.25.55 | Multi-Cloud Object Storage | https://min.io/ |
...
| **ruff** | 0.9.7 | An extremely fast Python linter, written in Rust | https://github.com/charliermarsh/ruff |
...
| **seanime** | 2.7.4 | Self-hosted anime and manga server for sea rovers. | https://github.com/5rahim/seanime |
...
| **shaderc** | 2024.4 | Collection of tools, libraries, and tests for Vulkan shader compilation | https://github.com/google/shaderc |
...
| **teleport-tsh** | 17.2.9 | Secure Access for Developers that doesn't get in the way | https://github.com/gravitational/teleport |
...
| **vale** | 3.9.5 | A syntax-aware linter for prose built with speed and extensibility in mind | https://vale.sh |
