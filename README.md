...
| **boinc** | 8.0.3 | Open-source software for volunteer computing | https://boinc.berkeley.edu/ |
...
| **c-ares** | 1.32.2 | Library for asynchronous DNS requests (including name resolves) | https://c-ares.haxx.se |
...
| **cargo-c** | 0.10.2 | Cargo C-ABI helpers | https://github.com/lu-zero/cargo-c |
...
| **ccache** | 4.10.1 | Compiler cache for fast recompilation of C/C++ code | https://ccache.samba.org |
...
| **command-not-found** | 2.4.0-34 | Suggest installation of packages in interactive shell sessions | https://github.com/termux/command-not-found |
...
| **croc** | 1:10.0.10 | Easily and securely send things from one computer to another | https://github.com/schollz/croc |
...
| **emscripten** | 3.1.63 | Emscripten: An LLVM-to-WebAssembly Compiler | https://emscripten.org |
| **emscripten-binaryen** | 3.1.63 | Emscripten-compatible Binaryen | https://emscripten.org |
| **emscripten-llvm** | 3.1.63 | Emscripten-compatible LLVM | https://emscripten.org |
| **emscripten-tests-third-party** | 3.1.63 | Emscripten third party test suite files | https://emscripten.org |
...
| **exiftool** | 12.89 | Utility for reading, writing and editing meta information in a wide variety of files. | https://exiftool.org/ |
...
| **fastfetch** | 2.18.1 | A neofetch-like tool for fetching system information and displaying them in a pretty way | https://github.com/fastfetch-cli/fastfetch |
...
| **git-gui** | 2.45.2 | A graphical interface to Git | https://git-scm.com/ |
...
| **glab-cli** | 1.43.0 | A GitLab CLI tool bringing GitLab to your command line | https://gitlab.com/gitlab-org/cli |
...
| **gmic-gm** | 3.4.0 | Full-featured framework for image processing (GraphicsMagick variant) | https://gmic.eu |
...
| **gst-libav** | 1.24.5 | GStreamer Libav plug-in contains one plugin with a set of elements using the Libav library code | https://gstreamer.freedesktop.org/modules/gst-libav.html |
| **gst-plugins-bad** | 1.24.5 | GStreamer Bad Plug-ins | https://gstreamer.freedesktop.org/ |
| **gst-plugins-base** | 1.24.5 | GStreamer base plug-ins | https://gstreamer.freedesktop.org/ |
...
| **hugo** | 0.129.0 | A fast and flexible static site generator | https://gohugo.io/ |
...
| **imagemagick** | 7.1.1.35 | Suite to create, edit, compose, or convert images in a variety of formats | https://www.imagemagick.org/ |
| **imagemagick-static** | 7.1.1.35 | Static libraries for imagemagick | https://www.imagemagick.org/ |
...
| **jfrog-cli** | 2.59.1 | A CLI for JFrog products | https://jfrog.com/getcli |
...
| **libhangul** | 0.1.0-p20230415-0 | A library to support hangul input method logic | https://github.com/libhangul/libhangul |
| **libhangul-static** | 0.1.0-p20230415-0 | Static libraries for libhangul | https://github.com/libhangul/libhangul |
...
| **libheif** | 1.18.0 | HEIF (HEIC/AVIF) image encoding and decoding library | https://github.com/strukturag/libheif |
| **libheif-progs** | 1.18.0 | Programs for manipulating HEIF (HEIC/AVIF) image files | https://github.com/strukturag/libheif |
...
| **liblz4** | 1.9.4-1 | Fast LZ compression algorithm library | https://lz4.github.io/lz4/ |
...
| **libopenmpt** | 0.7.8 | OpenMPT based module player library and libopenmpt based command-line player | https://lib.openmpt.org/libopenmpt/ |
| **libopenmpt-static** | 0.7.8 | Static libraries for libopenmpt | https://lib.openmpt.org/libopenmpt/ |
...
| **libtreesitter** | 0.22.6 | An incremental parsing system for programming tools | https://github.com/tree-sitter/tree-sitter |
| **libtreesitter-static** | 0.22.6 | Static libraries for libtreesitter | https://github.com/tree-sitter/tree-sitter |
...
| **libx11** | 1.8.9 | X11 client-side library | https://xorg.freedesktop.org/ |
| **libx11-static** | 1.8.9 | Static libraries for libx11 | https://xorg.freedesktop.org/ |
...
| **libxml2** | 2.13.2-1 | Library for parsing XML documents | http://www.xmlsoft.org |
| **libxml2-python** | 2.13.2-1 | Python bindings for libxml2 | http://www.xmlsoft.org |
| **libxml2-python-static** | 2.13.2-1 | Static libraries for libxml2-python | http://www.xmlsoft.org |
| **libxml2-static** | 2.13.2-1 | Static libraries for libxml2 | http://www.xmlsoft.org |
| **libxml2-utils** | 2.13.2-1 | XML utilities | http://www.xmlsoft.org |
...
| **logo-ls** | 2024.06.04 | Modern ls command with vscode like File Icon and Git Integrations | https://github.com/Yash-Handa/logo-ls |
...
| **lua-language-server** | 3.9.3 | Sumneko Lua Language Server coded in Lua | https://github.com/sumneko/lua-language-server |
...
| **lz4** | 1.9.4-1 | Fast LZ compression algorithm tool | https://lz4.github.io/lz4/ |
...
| **nodejs** | 22.4.1 | Open Source, cross-platform JavaScript runtime environment | https://nodejs.org/ |
...
| **nushell** | 0.95.0 | A new type of shell operating on structured data | https://www.nushell.sh |
...
| **oh-my-posh** | 21.28.0 | A prompt theme engine for any shell. | https://ohmyposh.dev |
...
| **pocketbase** | 0.22.17 | An open source Go backend | https://github.com/pocketbase/pocketbase |
...
| **procs** | 0.14.5-1 | A modern replacement for ps | https://github.com/dalance/procs |
...
| **python-bcrypt** | 4.1.3 | Acceptable password hashing for your software and your servers | https://github.com/pyca/bcrypt |
...
| **rbw** | 1.11.1 | An unofficial command line client for Bitwarden | https://github.com/doy/rbw |
...
| **rust-std-aarch64-linux-android** | 1.79.0-1 | Rust std for target aarch64-linux-android | https://www.rust-lang.org/ |
| **rust-std-armv7-linux-androideabi** | 1.79.0-1 | Rust std for target armv7-linux-androideabi | https://www.rust-lang.org/ |
| **rust-std-i686-linux-android** | 1.79.0-1 | Rust std for target i686-linux-android | https://www.rust-lang.org/ |
| **rust-std-wasm32-unknown-unknown** | 1.79.0-1 | Rust std for target wasm32-unknown-unknown | https://www.rust-lang.org/ |
| **rust-std-wasm32-wasi** | 1.79.0-1 | Rust std for target wasm32-wasi | https://www.rust-lang.org/ |
| **rust-std-wasm32-wasip1** | 1.79.0-1 | Rust std for target wasm32-wasip1 | https://www.rust-lang.org/ |
| **rust-std-wasm32-wasip2** | 1.79.0-1 | Rust std for target wasm32-wasip2 | https://www.rust-lang.org/ |
| **rust-std-x86-64-linux-android** | 1.79.0-1 | Rust std for target x86_64-linux-android | https://www.rust-lang.org/ |
| **rustc-dev** | 1.79.0-1 | Rust compiler development libs | https://www.rust-lang.org/ |
| **rustc-src** | 1.79.0-1 | Rust compiler source code files | https://www.rust-lang.org/ |
...
| **seafile-client** | 9.0.6 | Seafile is a file syncing and sharing software with file encryption and group sharing | https://seafile.com |
| **seafile-client-static** | 9.0.6 | Static libraries for seafile-client | https://seafile.com |
...
| **shellcheck** | 0.10.0 | Shell script analysis tool | https://www.shellcheck.net/ |
...
| **spirv-headers** | 1.3.283.0 | SPIR-V Headers | https://github.com/KhronosGroup/SPIRV-Headers |
| **spirv-tools** | 1.3.283.0 | SPIR-V Tools | https://github.com/KhronosGroup/SPIRV-Tools |
...
| **starship** | 1.19.0-1 | A minimal, blazing fast, and extremely customizable prompt for any shell | https://starship.rs |
...
| **step-cli** | 0.27.2 | An easy-to-use CLI tool for building, operating, and automating Public Key Infrastructure (PKI) systems and workflows | https://smallstep.com/cli |
...
| **tinygo** | 0.31.2-1 | Go compiler for microcontrollers, WASM, CLI tools | https://tinygo.org |
| **tinygo-common** | 0.31.2-1 | TinyGo common files | https://tinygo.org |
...
| **tree-sitter-markdown** | 0.2.3-1 | Tree-sitter parser for Markdown | https://github.com/tree-sitter-grammars/tree-sitter-markdown |
| **tree-sitter-markdown-static** | 0.2.3-1 | Static libraries for tree-sitter-markdown | https://github.com/tree-sitter-grammars/tree-sitter-markdown |
...
| **tree-sitter-vimdoc-static** | 3.0.0 | Static libraries for tree-sitter-vimdoc | https://github.com/neovim/tree-sitter-vimdoc |
...
| **trurl** | 0.13 | trurl is a command line tool that parses and manipulates URLs | https://curl.se/trurl/ |
...
| **vale** | 3.6.1 | A syntax-aware linter for prose built with speed and extensibility in mind | https://vale.sh |
...
| **vtm** | 0.9.95 | Terminal multiplexer with TUI window manager and multi-party session sharing | https://vtm.netxs.online/ |
...
| **vulkan-headers** | 1.3.291 | Vulkan Header files and API registry | https://github.com/KhronosGroup/Vulkan-Headers |
...
| **wakatime-cli** | 1.95.0 | Command line interface used by all WakaTime text editor plugins | https://wakatime.com/plugins/ |
...
| **xmake** | 2.9.3 | A cross-platform build utility based on Lua | https://xmake.io/ |
...
| **xorriso** | 1:1.5.7-1 | Tool for creating ISO files | https://www.gnu.org/software/xorriso |
...
| **zls** | 0.12.0 | Zig language server | https://github.com/zigtools/zls |
...
| **zrok** | 0.4.35 | An open source sharing solution built on OpenZiti. | https://zrok.io/ |
