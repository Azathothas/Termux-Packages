...
| **buf** | 1.40.0 | A new way of working with Protocol Buffers | https://buf.build |
...
| **uv** | 0.4.5 | An extremely fast Python package installer and resolver, written in Rust. | https://docs.astral.sh/uv/ |
