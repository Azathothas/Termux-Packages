...
| **bash-completion** | 2.15.0 | Programmable completion for the bash shell | https://github.com/scop/bash-completion |
...
| **fastfetch** | 2.32.1 | A neofetch-like tool for fetching system information and displaying them in a pretty way | https://github.com/fastfetch-cli/fastfetch |
...
| **groonga** | 14.1.1 | An embeddable fulltext search engine | https://github.com/groonga/groonga/ |
...
| **lesspipe** | 2.16-1 | An input filter for the pager less | http://www-zeuthen.desy.de/~friebel/unix/lesspipe.html |
...
| **libgrpc** | 1.68.2 | High performance, open source, general RPC framework that puts mobile and HTTP/2 first | https://grpc.io/ |
...
| **lowdown** | 1.3.2 | Markdown utilities and library (fork of hoedown -> sundown -> libsoldout) | https://kristaps.bsd.lv/lowdown |
| **lowdown-static** | 1.3.2 | Static libraries for lowdown | https://kristaps.bsd.lv/lowdown |
...
| **memcached** | 1.6.33 | Free & open source, high-performance, distributed memory object caching system | https://memcached.org/ |
...
| **mympd** | 19.0.1 | A standalone and lightweight web-based MPD client | https://jcorporation.github.io/myMPD/ |
...
| **pocketbase** | 0.23.11 | An open source Go backend | https://github.com/pocketbase/pocketbase |
...
| **python-grpcio** | 1.68.2 | High performance, open source, general RPC framework that puts mobile and HTTP/2 first | https://grpc.io/ |
...
| **qemu-common** | 1:8.2.6-1 | A set common files used by the QEMU emulators | https://www.qemu.org |
| **qemu-system-aarch64-headless** | 1:8.2.6-1 | A generic and open source machine emulator and virtualizer (headless) | https://www.qemu.org |
| **qemu-system-arm-headless** | 1:8.2.6-1 | A generic and open source machine emulator and virtualizer (headless) | https://www.qemu.org |
| **qemu-system-i386-headless** | 1:8.2.6-1 | A generic and open source machine emulator and virtualizer (headless) | https://www.qemu.org |
| **qemu-system-m68k-headless** | 1:8.2.6-1 | A generic and open source machine emulator and virtualizer (headless) | https://www.qemu.org |
| **qemu-system-ppc-headless** | 1:8.2.6-1 | A generic and open source machine emulator and virtualizer (headless) | https://www.qemu.org |
| **qemu-system-ppc64-headless** | 1:8.2.6-1 | A generic and open source machine emulator and virtualizer (headless) | https://www.qemu.org |
| **qemu-system-riscv32-headless** | 1:8.2.6-1 | A generic and open source machine emulator and virtualizer (headless) | https://www.qemu.org |
| **qemu-system-riscv64-headless** | 1:8.2.6-1 | A generic and open source machine emulator and virtualizer (headless) | https://www.qemu.org |
| **qemu-system-x86-64-headless** | 1:8.2.6-1 | A generic and open source machine emulator and virtualizer (headless) | https://www.qemu.org |
| **qemu-system-x86-64-headless-static** | 1:8.2.5-1 | Static libraries for qemu-system-x86-64-headless | https://www.qemu.org |
| **qemu-user-aarch64** | 1:8.2.6-1 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-user-arm** | 1:8.2.6-1 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-user-i386** | 1:8.2.6-1 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-user-m68k** | 1:8.2.6-1 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-user-ppc** | 1:8.2.6-1 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-user-ppc64** | 1:8.2.6-1 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-user-riscv32** | 1:8.2.6-1 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-user-riscv64** | 1:8.2.6-1 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-user-x86-64** | 1:8.2.6-1 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-utils** | 1:8.2.6-1 | A set of utilities for working with the QEMU emulators | https://www.qemu.org |
...
| **rust-analyzer** | 20241216 | A Rust compiler front-end for IDEs | https://rust-analyzer.github.io/ |
...
| **uv** | 0.5.11 | An extremely fast Python package installer and resolver, written in Rust. | https://docs.astral.sh/uv/ |
