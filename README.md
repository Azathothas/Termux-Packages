...
| **chezmoi** | 2.52.0 | Manage your dotfiles across multiple machines | https://chezmoi.io |
...
| **clvk** | 0.0.20240709.130041 | Experimental implementation of OpenCL on Vulkan | https://github.com/kpet/clvk |
...
| **dar** | 2.7.15 | A full featured command-line backup tool, short for Disk ARchive | http://dar.linux.free.fr/ |
| **dar-static** | 2.7.15 | Static libraries for dar | http://dar.linux.free.fr/ |
...
| **enchant** | 2.8.1 | Wraps a number of different spelling libraries and programs with a consistent interface | https://abiword.github.io/enchant/ |
...
| **fastfetch** | 2.21.1 | A neofetch-like tool for fetching system information and displaying them in a pretty way | https://github.com/fastfetch-cli/fastfetch |
...
| **forgejo** | 8.0.0 | Forgejo is a self-hosted lightweight software forge. | https://forgejo.org/ |
...
| **gauche** | 0.9.12-4 | An R7RS Scheme implementation developed to be a handy script interpreter | https://practical-scheme.net/gauche/ |
...
| **geth** | 1.14.7 | Go implementation of the Ethereum protocol | https://geth.ethereum.org/ |
| **geth-utils** | 1.14.7 | Additional utilities for Geth (like abigen, bootnode, evm, puppeth) | https://geth.ethereum.org/ |
...
| **gpgme** | 1.23.2-1 | Library designed to make access to GnuPG easier | https://www.gnupg.org/related_software/gpgme/ |
| **gpgme-static** | 1.23.2-1 | Static libraries for gpgme | https://www.gnupg.org/related_software/gpgme/ |
| **gpgmepp** | 1.23.2-1 | Programmatic C++ library interface to GnuPG | https://www.gnupg.org/related_software/gpgme/ |
| **gpgmepp-static** | 1.23.2-1 | Static libraries for gpgmepp | https://www.gnupg.org/related_software/gpgme/ |
...
| **graphviz** | 12.0.0 | Rich set of graph drawing tools | https://www.graphviz.org/ |
| **graphviz-static** | 12.0.0 | Static libraries for graphviz | https://www.graphviz.org/ |
...
| **jfrog-cli** | 2.63.0 | A CLI for JFrog products | https://jfrog.com/getcli |
...
| **libgcrypt** | 1.10.3-1 | General purpose cryptographic library based on the code from GnuPG | https://www.gnu.org/software/libgcrypt/ |
| **libgcrypt-static** | 1.10.3-1 | Static libraries for libgcrypt | https://www.gnu.org/software/libgcrypt/ |
...
| **libsqlite** | 3.46.0 | Library implementing a self-contained and transactional SQL database engine | https://www.sqlite.org |
| **libsqlite-static** | 3.46.0 | Static libraries for libsqlite | https://www.sqlite.org |
| **libsqlite-tcl** | 3.46.0 | tcl bindings for SQLite | https://www.sqlite.org |
...
| **libunbound** | 1.20.0-1 | A validating, recursive, caching DNS resolver | https://unbound.net/ |
| **libunbound-static** | 1.20.0-1 | Static libraries for libunbound | https://unbound.net/ |
...
| **mcfly** | 0.9.1 | Replaces your default ctrl-r shell history search with an intelligent search engine | https://github.com/cantino/mcfly |
...
| **monero** | 0.18.3.3-1 | A private, secure, untraceable, decentralised digital currency | https://getmonero.org/ |
...
| **multitail** | 7.1.4 | Tool to monitor logfiles and command output in multiple windows in a terminal, colorize, filter and merge | http://www.vanheusden.com/multitail/ |
...
| **mympd** | 17.0.0 | A standalone and lightweight web-based MPD client | https://jcorporation.github.io/myMPD/ |
...
| **nginx** | 1.27.0 | Lightweight HTTP server | https://www.nginx.org |
...
| **oh-my-posh** | 23.6.2 | A prompt theme engine for any shell. | https://ohmyposh.dev |
...
| **pinentry** | 1.3.0 | Dialog allowing secure password entry | https://www.gnupg.org/related_software/pinentry/index.html |
...
| **pocketbase** | 0.22.18 | An open source Go backend | https://github.com/pocketbase/pocketbase |
...
| **pueue** | 3.4.1 | A command-line task management tool for sequential and parallel execution of long-running tasks | https://github.com/Nukesor/pueue |
...
| **pypy** | 7.3.15-1 | A fast, compliant alternative implementation of Python | https://pypy.org |
| **pypy-tests** | 7.3.15-1 | Test files for PyPy | https://pypy.org |
| **pypy-tkinter** | 7.3.15-1 | Tkinter support for PyPy | https://pypy.org |
| **pypy3** | 7.3.15 | A fast, compliant alternative implementation of Python 3 | https://pypy.org |
| **pypy3-tests** | 7.3.15 | Test files for PyPy 3 | https://pypy.org |
| **pypy3-tkinter** | 7.3.15 | Tkinter support for PyPy 3 | https://pypy.org |
...
| **python** | 3.11.9-4 | Python 3 programming language intended to enable clear programs | https://python.org/ |
| **python-apsw** | 3.46.0.1 | Another Python SQLite Wrapper | https://github.com/rogerbinns/apsw/ |
...
| **python-ensurepip-wheels** | 3.11.9-4 | Wheels for Python ensurepip | https://python.org/ |
...
| **python-static** | 3.11.9-4 | Static libraries for python | https://python.org/ |
| **python-tkinter** | 3.11.9-4 | Tkinter support for Python 3 | https://python.org/ |
...
| **pyunbound** | 1.20.0-1 | Python bindings for Unbound | https://unbound.net/ |
...
| **qemu-system-i386-headless** | 1:8.2.5-2 | A generic and open source machine emulator and virtualizer (headless) | https://www.qemu.org |
| **qemu-system-m68k-headless** | 1:8.2.5-2 | A generic and open source machine emulator and virtualizer (headless) | https://www.qemu.org |
| **qemu-system-ppc-headless** | 1:8.2.5-2 | A generic and open source machine emulator and virtualizer (headless) | https://www.qemu.org |
| **qemu-system-ppc64-headless** | 1:8.2.5-2 | A generic and open source machine emulator and virtualizer (headless) | https://www.qemu.org |
| **qemu-system-riscv32-headless** | 1:8.2.5-2 | A generic and open source machine emulator and virtualizer (headless) | https://www.qemu.org |
| **qemu-system-riscv64-headless** | 1:8.2.5-2 | A generic and open source machine emulator and virtualizer (headless) | https://www.qemu.org |
| **qemu-system-x86-64-headless** | 1:8.2.5-2 | A generic and open source machine emulator and virtualizer (headless) | https://www.qemu.org |
| **qemu-system-x86-64-headless-static** | 1:8.2.5-1 | Static libraries for qemu-system-x86-64-headless | https://www.qemu.org |
| **qemu-user-aarch64** | 1:8.2.5-2 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-user-arm** | 1:8.2.5-2 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-user-i386** | 1:8.2.5-2 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-user-m68k** | 1:8.2.5-2 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-user-ppc** | 1:8.2.5-2 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-user-ppc64** | 1:8.2.5-2 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-user-riscv32** | 1:8.2.5-2 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-user-riscv64** | 1:8.2.5-2 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-user-x86-64** | 1:8.2.5-2 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-utils** | 1:8.2.5-2 | A set of utilities for working with the QEMU emulators | https://www.qemu.org |
...
| **railway-cli** | 3.11.4 | This is the command line interface for Railway | https://railway.app |
...
| **ruff** | 0.5.7 | An extremely fast Python linter, written in Rust | https://github.com/charliermarsh/ruff |
...
| **rust-analyzer** | 20240805 | A Rust compiler front-end for IDEs | https://github.com/rust-lang/rust-analyzer |
...
| **scdaemon** | 2.4.5-1 | Daemon invoked by gpg to manage smartcards | https://www.gnupg.org/ |
...
| **sqlite** | 3.46.0 | Command line shell for SQLite | https://www.sqlite.org |
...
| **starship** | 1.20.1 | A minimal, blazing fast, and extremely customizable prompt for any shell | https://starship.rs |
...
| **swi-prolog** | 9.3.8 | Most popular and complete prolog implementation | https://swi-prolog.org/ |
...
| **toml11** | 4.1.0 | toml11 is a C++11 (or later) header-only toml parser/encoder depending only on C++ standard library | https://github.com/ToruNiina/toml11 |
...
| **ttyper** | 1.5.0 | Terminal-based typing test | https://github.com/max-niederman/ttyper |
