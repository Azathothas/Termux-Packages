...
> The [Markdown README](https://github.com/pkgforge-dev/Termux-Packages/blob/main/README.md) **may not render because of huge file size.** Please Visit: https://termux-packages.ajam.dev
> - View [RAW](https://pub.ajam.dev/repos/pkgforge-dev/Termux-Packages/pkgs.txt): https://pub.ajam.dev/repos/pkgforge-dev/Termux-Packages/pkgs.txt
> - View [JSON](https://github.com/pkgforge-dev/Termux-Packages/blob/main/pkgs.json): https://github.com/pkgforge-dev/Termux-Packages/blob/main/pkgs.json
> - View [YAML](https://github.com/pkgforge-dev/Termux-Packages/blob/main/pkgs.yaml): https://github.com/pkgforge-dev/Termux-Packages/blob/main/pkgs.yaml
...
| **aichat** | 0.28.0 | A powerful chatgpt cli | https://github.com/sigoden/aichat |
| **aidl** | 13.0.0.6-17 | Android Interface Definition Language (AIDL) | https://elinux.org/Android_aapt |
...
| **android-tools** | 35.0.2-1 | Android platform tools | https://developer.android.com/ |
...
| **aom-tools** | 3.12.0 | Command-line tools using AOMedia library | https://aomedia.org/ |
...
| **aspnetcore-runtime-8.0** | 8.0.13 | ASP.NET Core 8.0 Runtime | https://dotnet.microsoft.com/en-us/ |
| **aspnetcore-runtime-9.0** | 9.0.2 | ASP.NET Core 9.0 Runtime | https://dotnet.microsoft.com/en-us/ |
| **aspnetcore-runtime-dbg-8.0** | 8.0.13 | ASP.NET Core 8.0 Runtime Managed Debug Symbols | https://dotnet.microsoft.com/en-us/ |
| **aspnetcore-runtime-dbg-9.0** | 9.0.2 | ASP.NET Core 9.0 Runtime Managed Debug Symbols | https://dotnet.microsoft.com/en-us/ |
| **aspnetcore-targeting-pack-8.0** | 8.0.13 | ASP.NET Core 8.0 Targeting Pack | https://dotnet.microsoft.com/en-us/ |
| **aspnetcore-targeting-pack-9.0** | 9.0.2 | ASP.NET Core 9.0 Targeting Pack | https://dotnet.microsoft.com/en-us/ |
...
| **botan3** | 3.7.1 | Crypto and TLS for Modern C++ | https://botan.randombit.net/ |
| **botan3-static** | 3.7.1 | Static libraries for botan3 | https://botan.randombit.net/ |
...
| **broot** | 1.44.7 | A better way to navigate directories | https://github.com/Canop/broot |
...
| **cargo-c** | 0.10.11 | Cargo C-ABI helpers | https://github.com/lu-zero/cargo-c |
...
| **cloudflared** | 2025.2.1 | A tunneling daemon that proxies traffic from the Cloudflare network to your origins | https://github.com/cloudflare/cloudflared |
| **clpeak** | 1.1.4 | A tool which profiles OpenCL devices to find their peak capacities | https://github.com/krrishnarraj/clpeak |
| **clvk** | 0.0.20250224.115625 | Experimental implementation of OpenCL on Vulkan | https://github.com/kpet/clvk |
...
| **command-not-found** | 2.4.0-65 | Suggest installation of packages in interactive shell sessions | https://github.com/termux/command-not-found |
...
| **curl** | 8.12.1 | Command line tool for transferring data with URL syntax | https://curl.se/ |
| **curlie** | 1.8.1 | The power of curl, the ease of use of httpie | https://curlie.io/ |
...
| **dart** | 3.7.1 | Dart is a general-purpose programming language | https://dart.dev/ |
...
| **dotnet-apphost-pack-8.0** | 8.0.13 | .NET 8.0 Targeting Pack | https://dotnet.microsoft.com/en-us/ |
| **dotnet-apphost-pack-9.0** | 9.0.2 | .NET 9.0 Targeting Pack | https://dotnet.microsoft.com/en-us/ |
| **dotnet-host** | 9.0 | A metapackage for .NET Host | https://dotnet.microsoft.com/en-us/ |
| **dotnet-host-8.0** | 8.0.13 | .NET 8.0 Host | https://dotnet.microsoft.com/en-us/ |
| **dotnet-host-9.0** | 9.0.2 | .NET 9.0 Host | https://dotnet.microsoft.com/en-us/ |
| **dotnet-hostfxr-8.0** | 8.0.13 | .NET 8.0 Host Resolver | https://dotnet.microsoft.com/en-us/ |
| **dotnet-hostfxr-9.0** | 9.0.2 | .NET 9.0 Host Resolver | https://dotnet.microsoft.com/en-us/ |
| **dotnet-runtime-8.0** | 8.0.13 | .NET 8.0 Runtime | https://dotnet.microsoft.com/en-us/ |
| **dotnet-runtime-9.0** | 9.0.2 | .NET 9.0 Runtime | https://dotnet.microsoft.com/en-us/ |
| **dotnet-runtime-dbg-8.0** | 8.0.13 | .NET 8.0 Runtime Managed Debug Symbols | https://dotnet.microsoft.com/en-us/ |
| **dotnet-runtime-dbg-9.0** | 9.0.2 | .NET 9.0 Runtime Managed Debug Symbols | https://dotnet.microsoft.com/en-us/ |
| **dotnet-sdk-8.0** | 8.0.13 | .NET 8.0 SDK | https://dotnet.microsoft.com/en-us/ |
| **dotnet-sdk-9.0** | 9.0.2 | .NET 9.0 SDK | https://dotnet.microsoft.com/en-us/ |
| **dotnet-sdk-dbg-8.0** | 8.0.13 | .NET 8.0 SDK Managed Debug Symbols | https://dotnet.microsoft.com/en-us/ |
| **dotnet-sdk-dbg-9.0** | 9.0.2 | .NET 9.0 SDK Managed Debug Symbols | https://dotnet.microsoft.com/en-us/ |
| **dotnet-targeting-pack-8.0** | 8.0.13 | .NET 8.0 Targeting Pack | https://dotnet.microsoft.com/en-us/ |
| **dotnet-targeting-pack-9.0** | 9.0.2 | .NET 9.0 Targeting Pack | https://dotnet.microsoft.com/en-us/ |
| **dotnet-templates-8.0** | 8.0.13 | .NET 8.0 Templates | https://dotnet.microsoft.com/en-us/ |
...
| **edbrowse** | 3.8.10-1 | Line based editor, browser, and mail client | https://edbrowse.org/ |
...
| **eja** | 15.4.5 | eja micro web server | https://github.com/eja/eja |
...
| **emacs** | 30.1 | Extensible, customizable text editor-and more | https://www.gnu.org/software/emacs/ |
...
| **exiftool** | 13.22 | Utility for reading, writing and editing meta information in a wide variety of files. | https://exiftool.org/ |
...
| **fastfetch** | 2.38.0 | A maintained, feature-rich and performance oriented, neofetch like system information tool | https://github.com/fastfetch-cli/fastfetch |
...
| **ffmpeg** | 7.1-5 | Tools and libraries to manipulate a wide range of multimedia formats and protocols | https://ffmpeg.org |
...
| **fselect** | 0.8.9 | Find files with SQL-like queries | https://fselect.rocks/ |
...
| **gegl** | 0.4.54 | Data flow based image processing framework | https://gegl.org/ |
...
| **geth** | 1.15.5 | Go implementation of the Ethereum protocol | https://geth.ethereum.org/ |
| **geth-utils** | 1.15.5 | Additional utilities for Geth (like abigen, bootnode, evm, puppeth) | https://geth.ethereum.org/ |
...
| **gh** | 2.67.0 | GitHub’s official command line tool | https://cli.github.com/ |
...
| **ghostscript** | 10.03.1-2 | Interpreter for the PostScript language and for PDF | https://www.ghostscript.com/ |
...
| **glab-cli** | 1.53.0 | A GitLab CLI tool bringing GitLab to your command line | https://gitlab.com/gitlab-org/cli |
| **gleam** | 1.8.1 | A friendly language for building type-safe, scalable systems! | https://gleam.run |
| **glib** | 2.82.5 | Library providing core building blocks for libraries and applications written in C | https://developer.gnome.org/glib/ |
| **glib-bin** | 2.82.5 | Programs for the GLib library | https://developer.gnome.org/glib/ |
| **glib-cross** | 2.82.5 | glib for host (NOT for Termux) | https://developer.gnome.org/glib/ |
...
| **gnucobol** | 3.2 | A free/libre COBOL compiler | https://gnucobol.sourceforge.io/ |
| **gnucobol-static** | 3.2 | Static libraries for gnucobol | https://gnucobol.sourceforge.io/ |
...
| **gnunet** | 0.23.1 | A framework for secure peer-to-peer networking | https://gnunet.org |
...
| **gpac** | 2.4.0-2 | An open-source multimedia framework focused on modularity and standards compliance | https://gpac.wp.imt.fr/ |
| **gpac-static** | 2.4.0-2 | Static libraries for gpac | https://gpac.wp.imt.fr/ |
| **gperf** | 3.1-7 | A perfect hash function generator | https://www.gnu.org/software/gperf |
| **gpgme** | 1.24.2 | Library designed to make access to GnuPG easier | https://www.gnupg.org/related_software/gpgme/ |
| **gpgme-static** | 1.24.2 | Static libraries for gpgme | https://www.gnupg.org/related_software/gpgme/ |
| **gpgmepp** | 1.24.2 | Programmatic C++ library interface to GnuPG | https://www.gnupg.org/related_software/gpgme/ |
| **gpgmepp-static** | 1.24.2 | Static libraries for gpgmepp | https://www.gnupg.org/related_software/gpgme/ |
...
| **groonga** | 15.0.2 | An embeddable fulltext search engine | https://github.com/groonga/groonga/ |
...
| **gst-plugins-bad** | 1.24.12-1 | GStreamer Bad Plug-ins | https://gstreamer.freedesktop.org/ |
...
| **gst-python** | 1.24.12-1 | Python bindings for GStreamer | https://gstreamer.freedesktop.org/ |
...
| **gum** | 0.15.2 | A tool for creating minimal interactive TUIs for shell scripts | https://github.com/charmbracelet/gum |
...
| **haproxy** | 3.1.5 | The Reliable, High Performance TCP/HTTP Load Balancer | https://www.haproxy.org/ |
| **harfbuzz** | 10.4.0 | OpenType text shaping engine | https://www.freedesktop.org/wiki/Software/HarfBuzz/ |
| **harfbuzz-icu** | 10.4.0 | OpenType text shaping engine ICU backend | https://www.freedesktop.org/wiki/Software/HarfBuzz/ |
| **harfbuzz-utils** | 10.4.0 | Tools using the harfbuzz library | https://www.freedesktop.org/wiki/Software/HarfBuzz/ |
...
| **helm** | 3.17.1 | Helm helps you manage Kubernetes applications | https://helm.sh |
...
| **hugo** | 0.145.0 | A fast and flexible static site generator | https://gohugo.io/ |
...
| **hwdata** | 0.393 | Database of hardware identification and configuration data | https://github.com/vcrhonek/hwdata |
...
| **hz** | 0.9.6 | A high-performance and strong-extensibility Go HTTP framework that helps developers build microservices | https://www.cloudwego.io |
...
| **jfrog-cli** | 2.74.0 | A CLI for JFrog products | https://jfrog.com/getcli |
...
| **jq-lsp** | 0.1.11 | jq language server | https://github.com/wader/jq-lsp |
| **jq-static** | 1.7.1 | Static libraries for jq | https://stedolan.github.io/jq/ |
| **jql** | 8.0.4 | A JSON Query Language CLI tool | https://github.com/yamafaktory/jql |
...
| **lf** | 34 | Terminal file manager | https://github.com/gokcehan/lf |
...
| **lgogdownloader** | 3.16 | Open source downloader to GOG.com for Linux users using the same API as the official GOGDownloader | https://sites.google.com/site/gogdownloader/ |
...
| **libandroid-stub** | 27c-1 | Stub libandroid.so for non-Android certified environment | https://android.googlesource.com/platform/frameworks/base/+/main/native/android |
...
| **libaom** | 3.12.0 | AV1 Video Codec Library | https://aomedia.org/ |
| **libaom-static** | 3.12.0 | Static libraries for libaom | https://aomedia.org/ |
...
| **libbcprov-java** | 1.80 | A lightweight cryptography API for Java | https://www.bouncycastle.org/java.html |
| **libblkid** | 2.40.2-3 | Block device identification library | https://en.wikipedia.org/wiki/Util-linux |
...
| **libcompiler-rt** | 19.1.7 | Compiler runtime libraries for clang | https://clang.llvm.org/ |
...
| **libcurl** | 8.12.1 | Easy-to-use client-side URL transfer library | https://curl.se/ |
| **libcurl-static** | 8.12.1 | Static libraries for libcurl | https://curl.se/ |
...
| **libdisplay-info** | 0.2.0 | EDID and DisplayID library | https://emersion.pages.freedesktop.org/libdisplay-info/ |
...
| **libexif** | 0.6.25 | Library for reading and writing EXIF image metadata | https://libexif.github.io/ |
| **libexif-static** | 0.6.25 | Static libraries for libexif | https://libexif.github.io/ |
| **libexpat** | 2.6.4 | XML parsing C library | https://libexpat.github.io/ |
| **libexpat-static** | 2.6.4 | Static libraries for libexpat | https://libexpat.github.io/ |
| **libfann** | 2.2.0-1 | Fast artificial neural network library | http://leenissen.dk/fann/wp |
| **libfcl** | 0.7.0-2 | Flexible collision library | https://github.com/flexible-collision-library/fcl |
| **libfdisk** | 2.40.2-3 | Library for manipulating disk partition tables | https://en.wikipedia.org/wiki/Util-linux |
...
| **libffi** | 3.4.7 | Library providing a portable, high level programming interface to various calling conventions | https://sourceware.org/libffi/ |
| **libffi-static** | 3.4.7 | Static libraries for libffi | https://sourceware.org/libffi/ |
| **libfinalcut** | 0.9.1 | A C++ class library and widget toolkit for creating a text-based user interface | https://github.com/gansm/finalcut |
| **libfinalcut-static** | 0.9.1 | Static libraries for libfinalcut | https://github.com/gansm/finalcut |
...
| **libflac** | 1.5.0 | FLAC (Free Lossless Audio Codec) library | https://xiph.org/flac/ |
...
| **libgedit-gfls** | 0.2.1 | A module dedicated to file loading and saving | https://gitlab.gnome.org/World/gedit/libgedit-gfls |
...
| **libgit2** | 1.9.0 | C library implementing Git core methods | https://libgit2.github.com/ |
| **libglibmm-2.4** | 2.66.7 | A C++ API for parts of glib that are useful for C++ | https://www.gtkmm.org/ |
| **libglibmm-2.68** | 2.82.0 | A C++ API for parts of glib that are useful for C++ | https://www.gtkmm.org/ |
...
| **libgmime** | 3.2.15 | MIME message parser and creator | https://github.com/jstedfast/gmime |
| **libgmime-static** | 3.2.15 | Static libraries for libgmime | https://github.com/jstedfast/gmime |
| **libgmp** | 6.3.0-1 | Library for arbitrary precision arithmetic | https://gmplib.org/ |
| **libgmp-static** | 6.3.0-1 | Static libraries for libgmp | https://gmplib.org/ |
| **libgnt** | 2.14.4 | An ncurses toolkit for creating text-mode graphical user interfaces in a fast and easy way | https://keep.imfreedom.org/libgnt/libgnt |
| **libgnustep-base** | 1.31.1 | A library of general-purpose, non-graphical Objective C objects | https://www.gnustep.org |
| **libgnutls** | 3.8.9 | Secure communications library implementing the SSL, TLS and DTLS protocols and technologies around them | https://www.gnutls.org/ |
| **libgnutls-static** | 3.8.9 | Static libraries for libgnutls | https://www.gnutls.org/ |
...
| **libgrpc** | 1.70.1-1 | High performance, open source, general RPC framework that puts mobile and HTTP/2 first | https://grpc.io/ |
...
| **libgts-static** | 0.7.6-1 | Static libraries for libgts | https://gts.sourceforge.net/ |
| **libgxps** | 0.3.2-2 | handling and rendering XPS documents | https://wiki.gnome.org/libgxps |
| **libhangul** | 0.1.0-p20230415-2 | A library to support hangul input method logic | https://github.com/libhangul/libhangul |
...
| **libidn** | 1.42 | GNU Libidn library, implementation of IETF IDN specifications | https://www.gnu.org/software/libidn/ |
| **libidn-static** | 1.42 | Static libraries for libidn | https://www.gnu.org/software/libidn/ |
| **libidn2** | 2.3.7 | Free software implementation of IDNA2008, Punycode and TR46 | https://www.gnu.org/software/libidn/#libidn2 |
| **libidn2-static** | 2.3.7 | Static libraries for libidn2 | https://www.gnu.org/software/libidn/#libidn2 |
...
| **libimobiledevice** | 1.3.0-p20230430-2 | A library to communicate with services on iOS devices using native protocols | https://libimobiledevice.org/ |
...
| **libimobiledevice-static** | 1.3.0-p20230430-2 | Static libraries for libimobiledevice | https://libimobiledevice.org/ |
...
| **libjanet** | 1.37.1 | Development library for Janet | https://janet-lang.org |
| **libjanet-static** | 1.37.1 | Static libraries for libjanet | https://janet-lang.org |
...
| **libksba** | 1.6.7-1 | Library for using X.509 certificates and CMS (Cryptographic Message Syntax) easily accessible | https://gnupg.org/related_software/libksba/ |
...
| **liblo-static** | 0.32 | Static libraries for liblo | https://liblo.sourceforge.net/ |
...
| **liblog4cxx** | 1.0.0-1 | A logging framework for C++ patterned after Apache log4j | https://logging.apache.org/log4cxx/latest_stable/index.html |
| **liblqr** | 0.4.3 | Provides a C/C++ API for performing non-uniform resizing of images by the seam-carving technique | https://github.com/carlobaldassi/liblqr |
| **liblqr-static** | 0.4.3 | Static libraries for liblqr | https://github.com/carlobaldassi/liblqr |
...
| **libltdl** | 2.5.4 | Library for dlopening libraries | https://www.gnu.org/software/libtool/ |
...
| **libluajit** | 1:2.1.1731601260 | Just-In-Time Compiler for Lua | https://luajit.org/ |
| **libluajit-static** | 1:2.1.1731601260 | Static libraries for libluajit | https://luajit.org/ |
| **liblz4** | 1.10.0 | Fast LZ compression algorithm library | https://lz4.github.io/lz4/ |
| **liblzma** | 5.6.4 | XZ-format compression library | https://tukaani.org/xz/ |
| **liblzma-static** | 5.6.4 | Static libraries for liblzma | https://tukaani.org/xz/ |
...
| **libmatio** | 1.5.28 | A C library for reading and writing Matlab MAT files | https://github.com/tbeu/matio |
| **libmatroska** | 1.7.1 | Matroska library | https://dl.matroska.org/downloads/libmatroska/ |
| **libmaxminddb** | 1.12.2 | MaxMind GeoIP2 database - library and utilities | https://dev.maxmind.com/geoip/geoip2/ |
| **libmaxminddb-static** | 1.12.2 | Static libraries for libmaxminddb | https://dev.maxmind.com/geoip/geoip2/ |
| **libmaxminddb-tools** | 1.12.2 | A geoip lookup utility for MaxMind DB | https://dev.maxmind.com/geoip/geoip2/ |
| **libmcrypt** | 2.5.8-5 | A library which provides a uniform interface to several symmetric encryption algorithms | https://mcrypt.sourceforge.net/ |
| **libmcrypt-static** | 2.5.8-5 | Static libraries for libmcrypt | https://mcrypt.sourceforge.net/ |
...
| **libmdbx** | 0.12.10 | An extremely fast, compact, powerful, embedded, transactional key-value database | https://libmdbx.dqdkfa.ru/ |
| **libmediainfo** | 24.12 | Library for reading information from media files | https://mediaarea.net/en/MediaInfo |
| **libmediainfo-static** | 24.12 | Static libraries for libmediainfo | https://mediaarea.net/en/MediaInfo |
...
| **libminizip-ng** | 4.0.8 | A zip manipulation library written in C | https://github.com/zlib-ng/minizip-ng |
...
| **libmpdclient** | 2.22 | Asynchronous API library for interfacing MPD in the C, C++ & Objective C languages | https://www.musicpd.org/libs/libmpdclient/ |
| **libmpeg2** | 0.5.1 | MPEG-2 decoder libraries | https://libmpeg2.sourceforge.io/ |
| **libmpeg2-static** | 0.5.1 | Static libraries for libmpeg2 | https://libmpeg2.sourceforge.io/ |
...
| **libmsgpack** | 6.1.0 | MessagePack implementation for C | https://github.com/msgpack/msgpack-c/ |
| **libmsgpack-cxx** | 7.0.0 | msgpack for C++ | https://msgpack.org/ |
| **libmsgpack-static** | 6.1.0 | Static libraries for libmsgpack | https://github.com/msgpack/msgpack-c/ |
| **libmuparser** | 2.3.5 | An extensible high performance math expression parser library written in C++ | https://beltoforion.de/en/muparser |
...
| **libnats-c** | 3.10.0 | A C client for the NATS messaging system | https://nats-io.github.io/nats.c/ |
| **libnats-c-static** | 3.10.0 | Static libraries for libnats-c | https://nats-io.github.io/nats.c/ |
| **libncnn** | 20230627-7 | A high-performance neural network inference framework optimized for the mobile platform | https://github.com/Tencent/ncnn |
| **libncnn-static** | 20230627-7 | Static libraries for libncnn | https://github.com/Tencent/ncnn |
...
| **libnettle-static** | 3.10.1 | Static libraries for libnettle | https://www.lysator.liu.se/~nisse/nettle/ |
...
| **libnghttp3-static** | 1.8.0 | Static libraries for libnghttp3 | https://nghttp2.org/nghttp3/ |
...
| **libnl-static** | 3.11.0 | Static libraries for libnl | https://github.com/thom311/libnl |
...
| **libnpth** | 1.6-2 | New GNU Portable Threads Library | https://www.gnupg.org/related_software/npth/ |
...
| **libode** | 0.16.6 | An open source, high performance library for simulating rigid body dynamics | https://www.ode.org |
...
| **libosmpbf** | 1.5.1 | osmpbf is a Java/C library to read and write OpenStreetMap PBF files | https://github.com/openstreetmap/OSM-binary/ |
| **libosmpbf-static** | 1.5.1 | Static libraries for libosmpbf | https://github.com/openstreetmap/OSM-binary/ |
...
| **libpagmo** | 2.19.1 | Scientific library for massively parallel optimization | https://esa.github.io/pagmo2/index.html |
| **libpangomm-1.4** | 2.46.4 | A C++ API for Pango | https://www.gtkmm.org/ |
| **libpangomm-2.48** | 2.56.1 | A C++ API for Pango | https://www.gtkmm.org/ |
...
| **libpaper** | 2.2.6 | Library for handling paper characteristics (by @rrthomas) | https://github.com/rrthomas/psutils |
| **libpaper-static** | 2.2.6 | Static libraries for libpaper | https://github.com/rrthomas/psutils |
...
| **libpcsclite** | 2.0.0-1 | Middleware to access a smart card using SCard API (PC/SC). | https://pcsclite.apdu.fr/ |
| **libpcsclite-static** | 2.0.0-1 | Static libraries for libpcsclite | https://pcsclite.apdu.fr/ |
...
| **libpluto** | 0.10.4 | Shared library for the Pluto interpreter | https://plutolang.github.io/ |
| **libpluto-static** | 0.10.4 | Static libraries for libpluto | https://plutolang.github.io/ |
| **libpng** | 1.6.47 | Official PNG reference library | http://www.libpng.org/pub/png/libpng.html |
...
| **libprotobuf** | 2:25.1-4 | Protocol buffers C++ library | https://github.com/protocolbuffers/protobuf |
...
| **libraptor2** | 2.0.16-6 | RDF Syntax Library | https://librdf.org/raptor/ |
| **libraptor2-static** | 2.0.16-6 | Static libraries for libraptor2 | https://librdf.org/raptor/ |
...
| **librasqal** | 0.9.33-2 | RDF Query Library | https://librdf.org/rasqal/ |
| **librasqal-static** | 0.9.33-2 | Static libraries for librasqal | https://librdf.org/rasqal/ |
| **librav1e** | 0.7.1-2 | An AV1 encoder library focused on speed and safety | https://github.com/xiph/rav1e/ |
| **librav1e-static** | 0.7.1-2 | Static libraries for librav1e | https://github.com/xiph/rav1e/ |
| **libraw** | 0.21.3 | Library for reading RAW files from digital cameras | https://www.libraw.org/ |
| **libraw-static** | 0.21.3 | Static libraries for libraw | https://www.libraw.org/ |
| **libre2** | 2024.07.02-2 | A regular expression library | https://github.com/google/re2 |
...
| **librttopo-static** | 1.1.0-2 | Static libraries for librttopo | https://git.osgeo.org/gitea/rttopo/librttopo |
...
| **libsearpc** | 1:3.2.0-6 | A simple C language RPC framework (mainly for seafile) | https://github.com/haiwen/libsearpc |
| **libsearpc-static** | 1:3.2.0-6 | Static libraries for libsearpc | https://github.com/haiwen/libsearpc |
| **libseat** | 0.9.1 | Reference implementation of a wayland compositor | https://sr.ht/~kennylevinsen/seatd/ |
...
| **libsecp256k1** | 1:0.6.0 | Optimized c library for ECDSA signatures and seret/public key operations on curve secp256k1 | https://github.com/bitcoin-core/secp256k1 |
| **libsecp256k1-static** | 1:0.6.0 | Static libraries for libsecp256k1 | https://github.com/bitcoin-core/secp256k1 |
| **libsecret** | 0.21.6 | A GObject-based library for accessing the Secret Service API | https://gitlab.gnome.org/GNOME/libsecret |
| **libsfdo** | 0.1.3 | A collection of libraries which implement some of the freedesktop.org specifications. | https://gitlab.freedesktop.org/vyivel/libsfdo |
...
| **libsodium-static** | 1.0.20 | Static libraries for libsodium | https://libsodium.org/ |
| **libsoldout** | 1.4-1 | Flexible C library and tools for markdown | https://fossil.instinctive.eu/libsoldout/index |
| **libsoldout-static** | 1.4-1 | Static libraries for libsoldout | https://fossil.instinctive.eu/libsoldout/index |
...
| **libspdlog** | 1.15.1 | Very fast, header-only/compiled, C++ logging library | https://github.com/gabime/spdlog |
...
| **libsqlite** | 3.48.0 | Library implementing a self-contained and transactional SQL database engine | https://www.sqlite.org |
| **libsqlite-static** | 3.48.0 | Static libraries for libsqlite | https://www.sqlite.org |
| **libsqlite-tcl** | 3.48.0 | tcl bindings for SQLite | https://www.sqlite.org |
...
| **libt3key** | 0.2.11 | A library and database with escape sequence to key symbol mappings | https://os.ghalkes.nl/t3/libt3key.html |
...
| **libtalloc** | 2.4.2 | Hierarchical, reference counted memory pool system with destructors | https://talloc.samba.org/talloc/doc/html/index.html |
...
| **libtool** | 2.5.4 | Generic library support script hiding the complexity of using shared libraries behind a consistent, portable interface | https://www.gnu.org/software/libtool/ |
| **libtorrent** | 0.15.1 | Libtorrent BitTorrent library | https://github.com/rakshasa/rtorrent/wiki |
| **libtorrent-rasterbar** | 2.0.11 | A feature complete C++ bittorrent implementation focusing on efficiency and scalability | https://libtorrent.org/ |
| **libtorrent-static** | 0.15.1 | Static libraries for libtorrent | https://github.com/rakshasa/rtorrent/wiki |
...
| **libunbound** | 1.22.0 | A validating, recursive, caching DNS resolver | https://unbound.net/ |
| **libunbound-static** | 1.22.0 | Static libraries for libunbound | https://unbound.net/ |
| **libunibilium** | 2.1.2 | Terminfo parsing library | https://github.com/neovim/unibilium |
| **libunistring** | 1.3 | Library providing functions for manipulating Unicode strings | https://www.gnu.org/software/libunistring/ |
| **libunistring-static** | 1.3 | Static libraries for libunistring | https://www.gnu.org/software/libunistring/ |
...
| **libusbmuxd-static** | 2.0.2-p20230430-2 | Static libraries for libusbmuxd | https://libimobiledevice.org |
...
| **libutf8-range** | 2:25.1-4 | Fast UTF-8 validation with Range algorithm | https://github.com/protocolbuffers/protobuf |
| **libuuid** | 2.40.2-3 | Library for handling universally unique identifiers | https://en.wikipedia.org/wiki/Util-linux |
| **libuv** | 1.50.0 | Support library with a focus on asynchronous I/O | https://libuv.org |
| **libuv-static** | 1.50.0 | Static libraries for libuv | https://libuv.org |
...
| **libvigra** | 1.12.1 | Computer vision library | https://ukoethe.github.io/vigra/ |
| **libvips** | 8.16.0 | A fast image processing library with low memory needs | https://libvips.github.io/libvips/ |
...
| **libvoikko** | 4.3.2-1 | A spelling and grammar checker, hyphenator and collection of related linguistic data for Finnish language | http://voikko.sourceforge.net |
| **libvoikko-static** | 4.3.2-1 | Static libraries for libvoikko | http://voikko.sourceforge.net |
| **libvorbis** | 1.3.7-2 | Library for using the Ogg Vorbis compressed audio format | https://xiph.org/vorbis/ |
| **libvorbis-static** | 1.3.7-2 | Static libraries for libvorbis | https://xiph.org/vorbis/ |
| **libvpx** | 1:1.15.0-1 | VP8 & VP9 Codec SDK | https://www.webmproject.org |
...
| **libwebp** | 1.5.0 | Library to encode and decode images in WebP format | https://github.com/webmproject/libwebp |
...
| **libwebsockets** | 4.3.5 | Lightweight C websockets library | https://libwebsockets.org |
| **libwolfssl** | 5.7.6 | A small, fast, portable implementation of TLS/SSL for embedded devices to the cloud | https://www.wolfssl.com/ |
...
| **libx11** | 1.8.11 | X11 client-side library | https://xorg.freedesktop.org/ |
| **libx11-static** | 1.8.11 | Static libraries for libx11 | https://xorg.freedesktop.org/ |
...
| **libxi** | 1.8.2 | X11 Input extension library | https://xorg.freedesktop.org/ |
...
| **lld** | 19.1.7 | LLVM-based linker | https://clang.llvm.org/ |
| **llvm** | 19.1.7 | LLVM modular compiler and toolchain executables | https://clang.llvm.org/ |
| **llvm-mingw-w64** | 20241030 | MinGW-w64 toolchain based on LLVM | https://github.com/mstorsjo/llvm-mingw |
| **llvm-mingw-w64-libcompiler-rt** | 20241030 | Compiler runtime libraries for LLVM-MinGW | https://www.llvm.org/ |
...
| **loksh** | 7.6 | A Linux port of OpenBSD's ksh | https://github.com/dimkr/loksh |
| **lowdown** | 1.4.0 | Markdown utilities and library (fork of hoedown -> sundown -> libsoldout) | https://kristaps.bsd.lv/lowdown |
| **lowdown-static** | 1.4.0 | Static libraries for lowdown | https://kristaps.bsd.lv/lowdown |
...
| **lua51-lpeg** | 1.1.0-2 | Pattern-matching library for Lua 5.1 | https://www.inf.puc-rio.br/~roberto/lpeg |
...
| **lychee** | 0.18.1 | A fast, async, resource-friendly link checker written in Rust | https://github.com/lycheeverse/lychee |
...
| **magic-wormhole-rs** | 0.7.1 | Rust implementation of Magic Wormhole, with new features and enhancements | https://github.com/magic-wormhole/magic-wormhole.rs |
| **mailsync** | 5.2.7-1 | A way of synchronizing a collection of mailboxes | http://mailsync.sourceforge.net/ |
| **mailutils** | 3.18 | Mailutils is a swiss army knife of electronic mail handling.  | https://mailutils.org/ |
| **mailutils-static** | 3.18 | Static libraries for mailutils | https://mailutils.org/ |
...
| **matplotlib** | 3.10.1 | A comprehensive library for creating static, animated, and interactive visualizations in Python | https://matplotlib.org/ |
...
| **mautrix-whatsapp** | 0.11.3 | A Matrix-WhatsApp puppeting bridge | https://maunium.net/go/mautrix-whatsapp/ |
...
| **mdbook** | 0.4.45 | Creates book from markdown files | https://rust-lang.github.io/mdBook/ |
...
| **mdbook-graphviz** | 0.2.1-1 | mdbook preprocessor to add graphviz support | https://github.com/dylanowen/mdbook-graphviz |
| **mdbook-katex** | 0.9.3 | A preprocessor for mdBook, pre-rendering LaTex equations to HTML at build time | https://github.com/lzanini/mdbook-katex |
| **mdbook-linkcheck** | 0.7.7-1 | A backend for mdbook which will check your links for you | https://michael-f-bryan.github.io/mdbook-linkcheck/ |
| **mdbook-mermaid** | 0.14.1 | A preprocessor for mdbook to add mermaid support | https://github.com/badboy/mdbook-mermaid |
| **mdbook-open-on-gh** | 2.4.3 | A preprocessor for mdbook to add a open-on-github link on every page | https://github.com/badboy/mdbook-open-on-gh |
| **mdbook-pikchr** | 0.1.9 | A mdbook preprocessor to render pikchr code blocks as images in your book | https://github.com/podsvirov/mdbook-pikchr |
| **mdbook-plantuml** | 0.8.0-1 | mdBook preprocessor to render PlantUML code blocks as images in your book | https://github.com/sytsereitsma/mdbook-plantuml |
| **mdbook-presentation-preprocessor** | 0.3.1-1 | A preprocessor for utilizing an MDBook as slides for a presentation | https://github.com/FreeMasen/mdbook-presentation-preprocessor |
...
| **mediamtx** | 1.11.3 | Ready-to-use SRT / WebRTC / RTSP / RTMP / LL-HLS media server and media proxy | https://github.com/bluenviron/mediamtx |
...
| **microsocks** | 1:1.0.5 | tiny, portable SOCKS5 server with very moderate resource usage | https://github.com/rofl0r/microsocks |
| **miller** | 6.13.0 | Like awk, sed, cut, join, and sort for name-indexed data such as CSV, TSV, and tabular JSON | https://miller.readthedocs.io/ |
...
| **mono-libs** | 6.12.0.206-1 | Platform-independent libraries for mono | https://gitlab.winehq.org/mono/mono |
| **mono-static** | 6.12.0.206-1 | Static libraries for mono | https://gitlab.winehq.org/mono/mono |
| **monolith** | 2.8.3-1 | CLI tool for saving complete web pages as a single HTML file | https://github.com/Y2Z/monolith |
...
| **mpd** | 0.23.17 | Music player daemon | https://www.musicpd.org |
...
| **mpv** | 0.39.0-2 | Command-line media player | https://mpv.io/ |
...
| **mupdf** | 1.24.10 | Lightweight PDF and XPS viewer (library) | https://mupdf.com/ |
| **mupdf-static** | 1.24.10 | Static libraries for mupdf | https://mupdf.com/ |
| **mupdf-tools** | 1.24.10 | Lightweight PDF and XPS viewer (utilities) | https://mupdf.com/ |
...
| **nala** | 0.15.4-4 | Commandline frontend for the apt package manager | https://gitlab.com/volian/nala |
...
| **ndk-multilib** | 27c | Multilib binaries for cross-compilation | https://developer.android.com/tools/sdk/ndk/index.html |
| **ndk-multilib-native-static** | 27c | Install native static libs from NDK | https://developer.android.com/tools/sdk/ndk/index.html |
| **ndk-multilib-native-stubs** | 27c | Install native stubs for shared libs from NDK | https://developer.android.com/tools/sdk/ndk/index.html |
...
| **neovim** | 0.10.4-2 | Ambitious Vim-fork focused on extensibility and agility (nvim) | https://neovim.io/ |
...
| **netstandard-targeting-pack-2.1** | 9.0 | A metapackage for NETStandard.Library 2.1 Targeting Pack | https://dotnet.microsoft.com/en-us/ |
| **netstandard-targeting-pack-2.1-8.0** | 8.0.13 | NETStandard.Library 2.1 Targeting Pack (.NET 8.0) | https://dotnet.microsoft.com/en-us/ |
| **netstandard-targeting-pack-2.1-9.0** | 9.0.2 | NETStandard.Library 2.1 Targeting Pack (.NET 9.0) | https://dotnet.microsoft.com/en-us/ |
| **nettle** | 3.10.1 | Low level cryptographic tools | https://www.lysator.liu.se/~nisse/nettle/ |
| **newsboat** | 2.38-1 | RSS/Atom feed reader for the text console | https://newsboat.org/ |
| **nginx** | 1.27.4 | Lightweight HTTP server | https://www.nginx.org |
...
| **nmh** | 1.8-1 | Powerful electronic mail handling system | http://www.nongnu.org/nmh/ |
...
| **nodejs** | 23.8.0 | Open Source, cross-platform JavaScript runtime environment | https://nodejs.org/ |
| **nodejs-lts** | 22.14.0 | Open Source, cross-platform JavaScript runtime environment | https://nodejs.org/ |
...
| **notmuch** | 0.38.3 | Thread-based email index, search and tagging system | https://notmuchmail.org |
...
| **o-editor** | 2.68.8 | Small, fast and limited text editor | https://github.com/xyproto/o |
| **oathtool** | 2.6.12 | One-time password components | http://www.nongnu.org/oath-toolkit/ |
| **oathtool-static** | 2.6.12 | Static libraries for oathtool | http://www.nongnu.org/oath-toolkit/ |
...
| **ocrad** | 0.29 | Optical Character Recognition program based on a feature extraction method | https://www.gnu.org/software/ocrad/ocrad.html |
| **ocrad-static** | 0.29 | Static libraries for ocrad | https://www.gnu.org/software/ocrad/ocrad.html |
...
| **oh-my-posh** | 25.1.1 | A prompt theme engine for any shell. | https://ohmyposh.dev |
...
| **onefetch** | 2.23.1 | A command-line Git information tool written in Rust | https://onefetch.dev/ |
| **onigmo** | 6.2.0 | A regular expressions library forked from Oniguruma | https://github.com/k-takata/Onigmo |
| **onigmo-static** | 6.2.0 | Static libraries for onigmo | https://github.com/k-takata/Onigmo |
| **oniguruma** | 6.9.10 | Regular expressions library | https://github.com/kkos/oniguruma |
| **oniguruma-static** | 6.9.10 | Static libraries for oniguruma | https://github.com/kkos/oniguruma |
...
| **open-adventure** | 1.20 | Forward-port of the original Colossal Cave Adventure from 1976-77 | http://www.catb.org/~esr/open-adventure/ |
| **openal-soft** | 1.24.2 | Software implementation of the OpenAL API | https://openal-soft.org/ |
...
| **opencolorio** | 2.4.1 | A color management framework for visual effects and animation | https://opencolorio.org |
...
| **openjdk-17** | 17.0-38 | Java development kit and runtime | https://github.com/openjdk/mobile |
| **openjdk-17-source** | 17.0-38 | Source files for openjdk-17 | https://github.com/openjdk/mobile |
| **openjdk-17-x** | 17.0-38 | Portion of openjdk-17 requiring X11 functionality | https://github.com/openjdk/mobile |
| **openjdk-21** | 21.0.6 | Java development kit and runtime | https://openjdk.java.net |
| **openjdk-21-source** | 21.0.6 | Source files for openjdk-21 | https://openjdk.java.net |
| **openjdk-21-x** | 21.0.6 | Portion of openjdk-21 requiring X11 functionality | https://openjdk.java.net |
...
| **openldap** | 2.6.9 | OpenLDAP server | https://openldap.org |
| **openldap-static** | 2.6.9 | Static libraries for openldap | https://openldap.org |
...
| **openssh** | 9.9p2 | Secure shell for logging into a remote machine | https://www.openssh.com/ |
| **openssh-sftp-server** | 9.9p2 | OpenSSH SFTP server subsystem | https://www.openssh.com/ |
...
| **openssl-static** | 1:3.4.1 | Static libraries for openssl | https://www.openssl.org/ |
...
| **panda3d-static** | 1.10.15 | Static libraries for panda3d | https://www.panda3d.org/ |
| **pango** | 1.56.1 | Library for laying out and rendering text | https://www.gtk.org/docs/architecture/pango |
...
| **parallel** | 20250222 | GNU Parallel is a shell tool for executing jobs in parallel using one or more machines | https://www.gnu.org/software/parallel/ |
...
| **patch** | 2.7.6-4 | GNU patch which applies diff files to create patched files | https://savannah.gnu.org/projects/patch/ |
| **patchelf** | 0.18.0 | Utility to modify the dynamic linker and RPATH of ELF executables | https://nixos.org/patchelf.html |
| **pathpicker** | 0.9.5-2 | Facebook PathPicker - a terminal-based file picker | https://facebook.github.io/PathPicker/ |
...
| **pcaudiolib** | 1.3 | Portable C Audio Library | https://github.com/espeak-ng/pcaudiolib |
...
| **pcre2** | 10.45 | Perl 5 compatible regular expression library | https://www.pcre.org |
| **pcre2-static** | 10.45 | Static libraries for pcre2 | https://www.pcre.org |
| **pcre2grep** | 10.45 | A grep with Perl-compatible regular expressions | https://www.pcre.org |
| **pcregrep** | 8.45-1 | A grep with Perl-compatible regular expressions | https://www.pcre.org |
| **pcscd** | 2.0.0-1 | Middleware to access a smart card using SCard API (PC/SC). (daemon side) | https://pcsclite.apdu.fr/ |
...
| **pdfcpu** | 0.9.1 | A PDF processor written in Go | https://pdfcpu.io |
...
| **peaclock** | 0.4.3-6 | A responsive and customizable clock, timer, and stopwatch for the terminal. | https://github.com/octobanana/peaclock |
...
| **pet** | 1.0.1 | Simple command-line snippet manager | https://github.com/knqyf263/pet |
| **pforth** | 1:2.0.1 | Portable Forth in C | http://www.softsynth.com/pforth/ |
| **pgroonga** | 4.0.1 | A PostgreSQL extension to use Groonga as index | https://github.com/pgroonga/pgroonga |
...
| **php** | 8.4.2 | Server-side, HTML-embedded scripting language | https://php.net |
| **php-apache** | 8.4.2 | Apache 2.0 Handler module for PHP | https://php.net |
| **php-apache-ldap** | 8.4.2 | LDAP module for PHP/Apache | https://php.net |
| **php-apache-opcache** | 8.4.2 | OPcache module for PHP/Apache | https://php.net |
| **php-apache-pgsql** | 8.4.2 | PostgreSQL modules for PHP/Apache | https://php.net |
| **php-apache-sodium** | 8.4.2 | Sodium module for PHP/Apache | https://php.net |
| **php-apcu** | 5.1.24 | APCu - APC User Cache | http://php.net/apcu |
| **php-fpm** | 8.4.2 | FastCGI Process Manager for PHP | https://php.net |
| **php-gd** | 8.4.2 | gd module for PHP | https://php.net |
| **php-imagick** | 3.7.0-6 | The Imagick PHP extension | https://github.com/Imagick/imagick |
| **php-ldap** | 8.4.2 | LDAP module for PHP | https://php.net |
| **php-pgsql** | 8.4.2 | PostgreSQL modules for PHP | https://php.net |
...
| **php-sodium** | 8.4.2 | Sodium module for PHP | https://php.net |
...
| **pianobar** | 2024.12.21 | pianobar is a free/open-source, console-based client for the personalized online radio Pandora. | https://6xq.net/pianobar/ |
...
| **pinentry** | 1.3.1-1 | Dialog allowing secure password entry | https://www.gnupg.org/related_software/pinentry/index.html |
...
| **pocketbase** | 0.25.8 | An open source Go backend | https://github.com/pocketbase/pocketbase |
...
| **portaudio** | 19.07.00-2 | A portable audio I/O library | https://www.portaudio.com/ |
| **portaudio-static** | 19.07.00-2 | Static libraries for portaudio | https://www.portaudio.com/ |
...
| **postgis** | 3.5.2 | Spatial database extender for PostgreSQL object-relational database | https://postgis.net |
| **postgresql** | 17.0-1 | Object-relational SQL database | https://www.postgresql.org |
| **postgresql-static** | 17.0-1 | Static libraries for postgresql | https://www.postgresql.org |
...
| **povray** | 3.8.0-beta.2-11 | The Persistence of Vision Raytracer | https://www.povray.org/ |
| **povray-data** | 3.8.0-beta.2-11 | Platform-independent data for povray | https://www.povray.org/ |
| **predict** | 2.3.1-1 | A Satellite Tracking/Orbital Prediction Program | https://www.qsl.net/kd2bd/predict.html |
| **privoxy** | 3.0.34-1 | Non-caching web proxy with advanced filtering capabilities | https://www.privoxy.org |
...
| **protobuf** | 2:25.1-4 | Compiler for protocol buffer definition files | https://github.com/protocolbuffers/protobuf |
| **protobuf-dev** | 2:25.1-4 | CMake files for protobuf shared libraries | https://github.com/protocolbuffers/protobuf |
| **protobuf-static** | 25.1-4 | Protocol buffers C++ library (static) | https://github.com/protocolbuffers/protobuf |
...
| **pueue** | 4.0.0-rc.1-1 | A command-line task management tool for sequential and parallel execution of long-running tasks | https://github.com/Nukesor/pueue |
...
| **pypy** | 7.3.19-1 | A fast, compliant alternative implementation of Python | https://pypy.org |
| **pypy-tests** | 7.3.19-1 | Test files for PyPy | https://pypy.org |
| **pypy-tkinter** | 7.3.19-1 | Tkinter support for PyPy | https://pypy.org |
| **pypy3** | 7.3.15-4 | A fast, compliant alternative implementation of Python 3 | https://pypy.org |
...
| **python** | 3.12.9 | Python 3 programming language intended to enable clear programs | https://python.org/ |
| **python-apsw** | 3.48.0.0 | Another Python SQLite Wrapper | https://github.com/rogerbinns/apsw/ |
...
| **python-lxml** | 5.3.1 | Python binding for the libxml2 and libxslt libraries | https://github.com/lxml/lxml |
| **python-msgpack** | 1.1.0-1 | MessagePack serializer implementation for Python | https://github.com/msgpack/msgpack-python |
| **python-numpy** | 2.2.3 | The fundamental package for scientific computing with Python | https://numpy.org/ |
...
| **python-static** | 3.12.9 | Static libraries for python | https://python.org/ |
| **python-tflite-runtime** | 2.18.0 | TensorFlow Lite Python bindings | https://www.tensorflow.org/lite |
| **python-tkinter** | 3.12.9 | Tkinter support for Python 3 | https://python.org/ |
| **python-tldp** | 0.7.5-5 | Tools for publishing from TLDP sources | https://github.com/tLDP/python-tldp |
| **python-torch** | 2.5.0 | Tensors and Dynamic neural networks in Python | https://pytorch.org/ |
| **python-torch-static** | 2.5.0 | Static libraries for python-torch | https://pytorch.org/ |
| **python-torchaudio** | 2.5.0-1 | Data manipulation and transformation for audio signal processing, powered by PyTorch | https://github.com/pytorch/audio |
| **python-torchvision** | 0.20.0-1 | Datasets, Transforms and Models specific to Computer Vision | https://github.com/pytorch/vision |
...
| **qemu-system-i386-headless** | 1:8.2.6-2 | A generic and open source machine emulator and virtualizer (headless) | https://www.qemu.org |
| **qemu-system-m68k-headless** | 1:8.2.6-2 | A generic and open source machine emulator and virtualizer (headless) | https://www.qemu.org |
| **qemu-system-ppc-headless** | 1:8.2.6-2 | A generic and open source machine emulator and virtualizer (headless) | https://www.qemu.org |
| **qemu-system-ppc64-headless** | 1:8.2.6-2 | A generic and open source machine emulator and virtualizer (headless) | https://www.qemu.org |
| **qemu-system-riscv32-headless** | 1:8.2.6-2 | A generic and open source machine emulator and virtualizer (headless) | https://www.qemu.org |
| **qemu-system-riscv64-headless** | 1:8.2.6-2 | A generic and open source machine emulator and virtualizer (headless) | https://www.qemu.org |
| **qemu-system-x86-64-headless** | 1:8.2.6-2 | A generic and open source machine emulator and virtualizer (headless) | https://www.qemu.org |
| **qemu-system-x86-64-headless-static** | 1:8.2.5-1 | Static libraries for qemu-system-x86-64-headless | https://www.qemu.org |
| **qemu-user-aarch64** | 1:8.2.6-2 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-user-arm** | 1:8.2.6-2 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-user-i386** | 1:8.2.6-2 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-user-m68k** | 1:8.2.6-2 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-user-ppc** | 1:8.2.6-2 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-user-ppc64** | 1:8.2.6-2 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-user-riscv32** | 1:8.2.6-2 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-user-riscv64** | 1:8.2.6-2 | QEMU Linux user mode emulator | https://www.qemu.org |
| **qemu-user-x86-64** | 1:8.2.6-2 | QEMU Linux user mode emulator | https://www.qemu.org |
...
| **qpdf** | 11.10.1 | Content-Preserving PDF Transformation System | http://qpdf.sourceforge.net |
| **qpdf-static** | 11.10.1 | Static libraries for qpdf | http://qpdf.sourceforge.net |
...
| **rabbitmq-server** | 4.0.7 | Feature rich, multi-protocol messaging and streaming broker | https://github.com/rabbitmq/rabbitmq-server |
| **racket** | 8.16 | Full-spectrum programming language going beyond Lisp and Scheme | https://racket-lang.org |
| **racket-static** | 8.16 | Static libraries for racket | https://racket-lang.org |
...
| **railway-cli** | 3.21.0 | This is the command line interface for Railway | https://railway.app |
...
| **rav1e** | 0.7.1-2 | An AV1 encoder program focused on speed and safety | https://github.com/xiph/rav1e/ |
| **ravencoin** | 4.6.1-5 | A peer-to-peer blockchain, handling the efficient creation and transfer of assets from one party to another | https://ravencoin.org/ |
...
| **rdfind** | 1.7.0 | A tool for finding duplicate files | https://github.com/pauldreik/rdfind |
...
| **recoll** | 1.41.1 | Full-text search for your desktop | https://www.recoll.org/ |
| **recoll-python** | 1.41.1 | Python interface for Recoll | https://www.recoll.org/ |
...
| **remind** | 1:05.03.03 | Sophisticated calendar and alarm program | https://dianne.skoll.ca/projects/remind/ |
...
| **rip2** | 0.9.3 | A safe and ergonomic alternative to rm | https://github.com/MilesCranmer/rip2 |
...
| **roqet** | 0.9.33-2 | Standalone command line RDF query utility program | https://librdf.org/rasqal/ |
...
| **rsgain** | 3.6 | A simple audio normalizazion utility | https://github.com/complexlogic/rsgain |
...
| **rtorrent** | 0.15.1 | Ncurses BitTorrent client based on libTorrent | https://rakshasa.github.io/rtorrent/ |
...
| **ruff** | 0.9.9 | An extremely fast Python linter, written in Rust | https://github.com/charliermarsh/ruff |
...
| **rust-analyzer** | 20250224 | A Rust compiler front-end for IDEs | https://rust-analyzer.github.io/ |
...
| **samba** | 4.16.11-3 | SMB/CIFS fileserver | https://www.samba.org/ |
...
| **screen** | 5.0.0-1 | Terminal multiplexer with VT100/ANSI terminal emulation | https://www.gnu.org/software/screen/ |
...
| **seafile-client** | 9.0.12 | Seafile is a file syncing and sharing software with file encryption and group sharing | https://seafile.com |
| **seafile-client-static** | 9.0.12 | Static libraries for seafile-client | https://seafile.com |
| **seanime** | 2.7.5 | Self-hosted anime and manga server for sea rovers. | https://github.com/5rahim/seanime |
...
| **sensible-utils** | 0.0.24 | Small utilities used by programs to sensibly select and spawn an appropriate browser, editor, or pager | https://packages.debian.org/sid/sensible-utils |
| **serd** | 0.32.4 | A lightweight C library for RDF syntax | https://drobilla.net/software/serd.html |
| **serf** | 1.3.10-1 | High performance C-based HTTP client library | https://serf.apache.org/ |
| **serf-static** | 1.3.10-1 | Static libraries for serf | https://serf.apache.org/ |
| **sfeed** | 2.1 | Shell-script/crontab oriented feed aggregator and parser utility (curses-based reader included) | https://codemadness.org/sfeed-simple-feed-parser.html |
| **sftpgo** | 2.6.6 | Full-featured and highly configurable SFTP, HTTP/S, FTP/S and WebDAV server | https://sftpgo.com/ |
| **shaderc** | 2025.1 | Collection of tools, libraries, and tests for Vulkan shader compilation | https://github.com/google/shaderc |
...
| **sheldon** | 0.8.1 | Fast, configurable, shell plugin manager | https://sheldon.cli.rs/ |
...
| **simdjson** | 3.12.2 | A C++ library to see how fast we can parse JSON with complete validation | https://simdjson.org/ |
...
| **sing-box** | 1.11.4 | The universal proxy platform | https://sing-box.sagernet.org |
...
| **sleuthkit** | 4.12.1-1 | The Sleuth Kit® (TSK) is a library for digital forensics tools.  | https://sleuthkit.org/ |
| **sleuthkit-static** | 4.12.1-1 | Static libraries for sleuthkit | https://sleuthkit.org/ |
...
| **snapcast-client** | 0.31.0 | A multiroom client-server audio player (client) | https://github.com/badaix/snapcast |
| **snapcast-server** | 0.31.0 | A multiroom client-server audio player (server) | https://github.com/badaix/snapcast |
| **snmptt** | 1.5 | SNMP trap translator | http://www.snmptt.org/ |
| **snowflake** | 2.10.1 | Pluggable Transport using WebRTC, inspired by Flashproxy | https://snowflake.torproject.org/ |
| **snowflake-client** | 2.10.1 | Pluggable Transport using WebRTC, inspired by Flashproxy (Client) | https://snowflake.torproject.org/ |
| **snowflake-proxy** | 2.10.1 | Pluggable Transport using WebRTC, inspired by Flashproxy (Proxy) | https://snowflake.torproject.org/ |
| **socat** | 1.8.0.3 | Relay for bidirectional data transfer between two independent data channels | http://www.dest-unreach.org/socat/ |
...
| **sops** | 3.9.4 | Simple and flexible tool for managing secrets | https://github.com/getsops/sops |
| **sord** | 0.16.18 | A lightweight C library for storing RDF data in memory | https://drobilla.net/software/sord.html |
| **sox** | 14.4.2-27 | Command line utility for converting between and applying effects to various audio files formats | https://sox.sourceforge.net/ |
| **sox-static** | 14.4.2-27 | Static libraries for sox | https://sox.sourceforge.net/ |
...
| **spglib** | 2.5.0-1 | C library for finding and handling crystal symmetries | https://spglib.github.io/spglib/index.html |
| **spglib-static** | 2.0.2 | Static libraries for spglib | https://spglib.github.io/spglib/index.html |
| **spiped** | 1.6.3 | a utility for creating symmetrically encrypted and authenticated pipes between socket addresses | https://www.tarsnap.com/spiped.html |
| **spirv-headers** | 1.4.304.1 | SPIR-V Headers | https://github.com/KhronosGroup/SPIRV-Headers |
| **spirv-tools** | 1.4.304.1 | SPIR-V Tools | https://github.com/KhronosGroup/SPIRV-Tools |
...
| **sqlite** | 3.48.0 | Command line shell for SQLite | https://www.sqlite.org |
...
| **squid** | 7.0.1 | Full-featured Web proxy cache server | http://www.squid-cache.org |
...
| **srt2vobsub** | 1.0-4 | A command-line tool that generates a pair of .idx/.sub subtitle files from a textual subtitles file | https://srt2vobsub.sourceforge.io/ |
...
| **starship** | 1.22.1 | A minimal, blazing fast, and extremely customizable prompt for any shell | https://starship.rs |
...
| **step-cli** | 0.28.5 | An easy-to-use CLI tool for building, operating, and automating Public Key Infrastructure (PKI) systems and workflows | https://smallstep.com/cli |
...
| **storj-uplink** | 1.122.9 | Storj DCS Uplink CLI | https://www.storj.io/integrations/uplink-cli |
...
| **strace** | 6.13-1 | Debugging utility to monitor system calls and signals received | https://strace.io/ |
| **streamripper** | 1.64.6-2 | Records and splits streaming mp3 into tracks | http://streamripper.sourceforge.net/ |
| **stunnel** | 5.74 | Socket wrapper which can provide TLS support to ordinary applications | https://www.stunnel.org/ |
| **stunnel-static** | 5.74 | Static libraries for stunnel | https://www.stunnel.org/ |
| **stuntman** | 1.2.16-3 | An open source STUN server | https://www.stunprotocol.org/ |
| **stylua** | 2.0.2 | An opinionated Lua code formatter | https://github.com/JohnnyMorganz/StyLua |
| **subtitleripper** | 0.3.4 | DVD subtitle ripper for Linux | http://subtitleripper.sourceforge.net/ |
| **subversion** | 1.14.5 | Centralized version control system characterized by its simplicity | https://subversion.apache.org |
...
| **svt-av1** | 3.0.0 | Scalable Video Technology for AV1 (SVT-AV1 Encoder and Decoder) | https://gitlab.com/AOMediaCodec/SVT-AV1 |
| **swaks** | 20240103.0 | Swiss Army Knife for SMTP | http://jetmore.org/john/code/swaks/ |
| **swi-prolog** | 9.3.20-1 | Most popular and complete prolog implementation | https://swi-prolog.org/ |
...
| **swift-sdk-aarch64** | 6.0.3-1 | Swift SDK for Android AArch64 | https://swift.org/ |
| **swift-sdk-arm** | 6.0.3-1 | Swift SDK for Android armv7 | https://swift.org/ |
| **swift-sdk-x86-64** | 6.0.3-1 | Swift SDK for Android x86_64 | https://swift.org/ |
...
| **syncthing** | 1.29.2 | Decentralized file synchronization | https://syncthing.net/ |
...
| **taplo** | 0.9.3 | A TOML LSP and toolkit | https://taplo.tamasfe.dev/ |
...
| **termux-tools** | 1.44.6 | Basic system tools for Termux | https://termux.dev/ |
| **teseq** | 1.1.1-1 | Tool for analyzing control characters and terminal control sequences | https://www.gnu.org/software/teseq/ |
| **tesseract** | 5.5.0-1 | Tesseract is probably the most accurate open source OCR engine available | https://github.com/tesseract-ocr/tesseract |
...
| **texinfo** | 7.2-1 | Documentation system for on-line information and printed output | https://www.gnu.org/software/texinfo/ |
| **texlab** | 5.22.1 | A cross-platform implementation of the Language Server Protocol providing rich cross-editing support for the LaTeX typesetting system | https://texlab.netlify.app/ |
| **texlive-bin** | 20240310-2 | TeX Live is a distribution of the TeX typesetting system. This package contains architecture dependent binaries. | https://www.tug.org/texlive/ |
| **texlive-bin-static** | 20240310-2 | Static libraries for texlive-bin | https://www.tug.org/texlive/ |
| **texlive-installer** | 20240310-1 | Wrapper around texlive's install-tl script | https://www.tug.org/texlive/ |
...
| **timg** | 1.6.1 | A terminal image and video viewer | https://timg.sh/ |
...
| **tintin++** | 2.02.42 | Classic text-based MUD client | https://tintin.mudhalla.net |
| **tinyfugue** | 5.0b8-3 | Flexible, screen-oriented MUD client, for use with any type of MUD | https://tinyfugue.sourceforge.net/ |
| **tinygo** | 0.35.0 | Go compiler for microcontrollers, WASM, CLI tools | https://tinygo.org |
| **tinygo-common** | 0.35.0 | TinyGo common files | https://tinygo.org |
| **tinyproxy** | 1.11.2 | Light-weight HTTP proxy daemon for POSIX operating systems | https://tinyproxy.github.io/ |
| **tinyscheme** | 1.42-1 | Very small scheme implementation | http://tinyscheme.sourceforge.net/home.html |
| **tizonia** | 0.22.0-15 | A command-line streaming music client/server for Linux | https://github.com/tizonia/ |
...
| **tor** | 0.4.8.14 | The Onion Router anonymizing overlay network | https://www.torproject.org |
| **torchaudio-ffmpeg** | 2.5.0-1 | Minimal FFmpeg libraries for python-torchaudio | https://github.com/pytorch/audio |
...
| **totem-pl-parser** | 3.26.6 | Simple GObject-based library to parse and save a host of playlist formats | https://gitlab.gnome.org/GNOME/totem-pl-parser |
| **toxic** | 0.16.1 | A command line client for Tox | https://github.com/JFreegman/toxic |
...
| **tree-sitter-vimdoc-static** | 3.0.0-2 | Static libraries for tree-sitter-vimdoc | https://github.com/neovim/tree-sitter-vimdoc |
...
| **ttyd** | 1.7.7 | Command-line tool for sharing terminal over the web | https://tsl0922.github.io/ttyd/ |
| **ttyper** | 1.6.0 | Terminal-based typing test | https://github.com/max-niederman/ttyper |
| **ttyplot** | 1.7.0 | A realtime plotting utility for terminal with data input from stdin | https://github.com/tenox7/ttyplot |
...
| **typst** | 0.13.0 | A new markup-based typesetting system that is powerful and easy to learn | https://typst.app/ |
| **typst-lsp** | 0.13.0-1 | Language server for Typst | https://github.com/nvarner/typst-lsp |
...
| **ugrep** | 7.3.0 | A faster, user-friendly and compatible grep replacement | https://github.com/Genivia/ugrep |
| **unar** | 1.10.8 | Command line tools for archive and file unarchiving and extraction | https://theunarchiver.com/command-line |
...
| **unicorn** | 2.1.2 | Unicorn is a lightweight multi-platform, multi-architecture CPU emulator framework | https://www.unicorn-engine.org/ |
| **unicorn-static** | 2.1.2 | Static libraries for unicorn | https://www.unicorn-engine.org/ |
...
| **upx** | 5.0.0 | the Ultimate Packer for eXecutables | https://upx.github.io/ |
...
| **usql** | 0.19.19 | A universal command-line interface for SQL databases | https://github.com/xo/usql |
...
| **util-linux** | 2.40.2-3 | Miscellaneous system utilities | https://en.wikipedia.org/wiki/Util-linux |
...
| **uv** | 0.6.3 | An extremely fast Python package installer and resolver, written in Rust. | https://docs.astral.sh/uv/ |
...
| **vale** | 3.9.6 | A syntax-aware linter for prose built with speed and extensibility in mind | https://vale.sh |
...
| **vim** | 9.1.1150 | Vi IMproved - enhanced vi editor | https://www.vim.org |
...
| **vlc** | 3.0.21-5 | A popular libre and open source media player and multimedia engine | https://www.videolan.org/ |
...
| **vtm** | 0.9.99.67 | Terminal multiplexer with TUI window manager and multi-party session sharing | https://vtm.netxs.online/ |
...
| **vulkan-headers** | 1.4.309 | Vulkan Header files and API registry | https://github.com/KhronosGroup/Vulkan-Headers |
...
| **vulkan-loader-generic** | 1.4.309 | Vulkan Loader | https://github.com/KhronosGroup/Vulkan-Loader |
| **vulkan-tools** | 1.4.309 | Vulkan Tools and Utilities | https://github.com/KhronosGroup/Vulkan-Tools |
| **vulkan-utility-libraries** | 1.4.309 | Utility Libraries for Vulkan | https://github.com/KhronosGroup/Vulkan-Utility-Libraries |
| **vulkan-validation-layers** | 1.4.305 | Vulkan Validation Layers | https://github.com/KhronosGroup/Vulkan-ValidationLayers |
...
| **wasm-component-ld** | 0.5.12 | Command line linker for creating WebAssembly components | https://github.com/bytecodealliance/wasm-component-ld |
...
| **waypipe** | 0.10.3 | A proxy for Wayland clients | https://gitlab.freedesktop.org/mstoeckl/waypipe |
...
| **weechat** | 4.5.2 | Fast, light and extensible IRC chat client | https://weechat.org/ |
| **weechat-lua-plugin** | 4.5.2 | WeeChat Lua Plugin | https://weechat.org/ |
| **weechat-perl-plugin** | 4.5.2 | WeeChat Perl Plugin | https://weechat.org/ |
| **weechat-python-plugin** | 4.5.2 | WeeChat Python3 Plugin | https://weechat.org/ |
| **weechat-ruby-plugin** | 4.5.2 | WeeChat Ruby Plugin | https://weechat.org/ |
...
| **wireguard-tools** | 1.0.20210914-2 | Tools for the WireGuard secure network tunnel | https://www.wireguard.com |
| **wireproxy** | 1.0.10 | Wireguard client that exposes itself as a socks5 proxy | https://github.com/pufferffish/wireproxy |
...
| **xmake** | 2.9.8 | A cross-platform build utility based on Lua | https://xmake.io/ |
| **xmlsec** | 1.3.7 | XML Security Library | https://www.aleksey.com/xmlsec/ |
| **xmlsec-static** | 1.3.7 | Static libraries for xmlsec | https://www.aleksey.com/xmlsec/ |
| **xmlstarlet** | 1.6.1-6 | Command line XML toolkit | https://xmlstar.sourceforge.net/ |
| **xmlto** | 0.0.29-1 | Convert xml to many other formats | https://pagure.io/xmlto/ |
...
| **xsltproc** | 1.1.42-1 | XSLT command line processor | http://xmlsoft.org/libxslt/ |
...
| **xxd** | 9.1.1150 | Hexdump utility from vim | https://www.vim.org |
...
| **xz-utils** | 5.6.4 | XZ-format compression tools | https://tukaani.org/xz/ |
...
| **yazi** | 25.3.2 | Blazing fast terminal file manager written in Rust, based on async I/O | https://yazi-rs.github.io/ |
