...
| **pocketbase** | 0.22.26 | An open source Go backend | https://github.com/pocketbase/pocketbase |
...
| **uv** | 0.5.2 | An extremely fast Python package installer and resolver, written in Rust. | https://docs.astral.sh/uv/ |
