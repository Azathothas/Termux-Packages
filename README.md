...
| **chezmoi** | 2.51.0 | Manage your dotfiles across multiple machines | https://chezmoi.io |
...
| **eza** | 0.18.24 | A modern replacement for ls | https://github.com/eza-community/eza |
...
| **fastfetch** | 2.21.0 | A neofetch-like tool for fetching system information and displaying them in a pretty way | https://github.com/fastfetch-cli/fastfetch |
...
| **kcptun** | 20240730 | A Stable & Secure Tunnel based on KCP with N:M multiplexing and FEC | https://github.com/xtaci/kcptun |
...
| **libcoap** | 4.3.5-rc2-0 | Implementation of CoAP, a lightweight protocol for resource constrained devices | https://libcoap.net/ |
| **libcoap-static** | 4.3.5-rc2-0 | Static libraries for libcoap | https://libcoap.net/ |
...
| **libheif** | 1.18.1 | HEIF (HEIC/AVIF) image encoding and decoding library | https://github.com/strukturag/libheif |
| **libheif-progs** | 1.18.1 | Programs for manipulating HEIF (HEIC/AVIF) image files | https://github.com/strukturag/libheif |
...
| **libncnn** | 20230627-3 | A high-performance neural network inference framework optimized for the mobile platform | https://github.com/Tencent/ncnn |
| **libncnn-static** | 20230627-3 | Static libraries for libncnn | https://github.com/Tencent/ncnn |
...
| **libopencc** | 1.1.8 | An opensource project for conversions between Traditional Chinese, Simplified Chinese and Japanese Kanji (Shinjitai) | https://github.com/BYVoid/OpenCC |
...
| **libtdb** | 1.4.11 | A trivial database system | https://tdb.samba.org/ |
...
| **mdbook-graphviz** | 0.2.0 | mdbook preprocessor to add graphviz support | https://github.com/dylanowen/mdbook-graphviz |
...
| **mpg123** | 1.32.6 | Fast console MPEG Audio Player and decoder library | https://mpg123.org/ |
| **mpg123-static** | 1.32.6 | Static libraries for mpg123 | https://mpg123.org/ |
...
| **ndk-sysroot** | 26b-3 | System header and library files from the Android NDK needed for compiling C programs | https://developer.android.com/tools/sdk/ndk/index.html |
...
| **ngspice** | 43 | A mixed-level/mixed-signal circuit simulator | https://ngspice.sourceforge.net/ |
...
| **oh-my-posh** | 23.6.0 | A prompt theme engine for any shell. | https://ohmyposh.dev |
...
| **opencc-tools** | 1.1.8 | Command-line tools for OpenCC | https://github.com/BYVoid/OpenCC |
...
| **php** | 8.3.8 | Server-side, HTML-embedded scripting language | https://php.net |
| **php-apache** | 8.3.8 | Apache 2.0 Handler module for PHP | https://php.net |
| **php-apache-ldap** | 8.3.8 | LDAP module for PHP/Apache | https://php.net |
| **php-apache-opcache** | 8.3.8 | OPcache module for PHP/Apache | https://php.net |
| **php-apache-pgsql** | 8.3.8 | PostgreSQL modules for PHP/Apache | https://php.net |
| **php-apache-sodium** | 8.3.8 | Sodium module for PHP/Apache | https://php.net |
| **php-apcu** | 5.1.23-2 | APCu - APC User Cache | http://php.net/apcu |
| **php-fpm** | 8.3.8 | FastCGI Process Manager for PHP | https://php.net |
| **php-imagick** | 3.7.0-4 | The Imagick PHP extension | https://github.com/Imagick/imagick |
| **php-ldap** | 8.3.8 | LDAP module for PHP | https://php.net |
| **php-pgsql** | 8.3.8 | PostgreSQL modules for PHP | https://php.net |
...
| **php-sodium** | 8.3.8 | Sodium module for PHP | https://php.net |
...
| **python** | 3.11.9-3 | Python 3 programming language intended to enable clear programs | https://python.org/ |
...
| **radare2** | 5.9.2 | Advanced Hexadecimal Editor | https://rada.re |
...
| **readline** | 8.2.10 | Library that allow users to edit command lines as they are typed in | https://tiswww.case.edu/php/chet/readline/rltop.html |
...
| **spglib** | 2.5.0 | C library for finding and handling crystal symmetries | https://spglib.github.io/spglib/index.html |
...
| **tdb-tools** | 1.4.11 | Tools for TDB | https://tdb.samba.org/ |
...
| **telegram-bot-api** | 20240707 | Telegram Bot API server | https://github.com/tdlib/telegram-bot-api |
| **telegram-cli** | 1:1.4.1-6 | Telegram messenger CLI | https://github.com/vysheng/tg |
| **teleport-tsh** | 16.1.1 | Secure Access for Developers that doesn't get in the way | https://github.com/gravitational/teleport |
...
| **ugrep** | 6.3.0 | A faster, user-friendly and compatible grep replacement | https://github.com/Genivia/ugrep |
...
| **vtm** | 0.9.99.01 | Terminal multiplexer with TUI window manager and multi-party session sharing | https://vtm.netxs.online/ |
...
| **z-push** | 2.7.3 | An open-source application to synchronize ActiveSync compatible devices and Outlook | https://z-push.org/ |
