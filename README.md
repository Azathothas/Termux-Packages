...
| **cmake** | 3.30.1 | Family of tools designed to build, test and package software | https://cmake.org/ |
| **cmake-curses-gui** | 3.30.1 | Curses based user interface for CMake (ccmake) | https://cmake.org/ |
...
| **just** | 1.33.0 | A handy way to save and run project-specific commands | https://just.systems |
