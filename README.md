...
| **gleam** | 1.3.0 | A friendly language for building type-safe, scalable systems! | https://gleam.run |
...
| **oh-my-posh** | 21.23.0 | A prompt theme engine for any shell. | https://ohmyposh.dev |
