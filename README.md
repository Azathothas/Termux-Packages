...
| **command-not-found** | 2.4.0-16 | Suggest installation of packages in interactive shell sessions | https://github.com/termux/command-not-found |
...
| **vale** | 3.3.0 | A syntax-aware linter for prose built with speed and extensibility in mind | https://vale.sh |
...
| **yq** | 4.42.1 | A lightweight and portable command-line YAML, JSON and XML processor | https://mikefarah.gitbook.io/yq/ |
