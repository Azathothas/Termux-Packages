...
| **python-grpcio** | 1.61.1 | High performance, open source, general RPC framework that puts mobile and HTTP/2 first | https://grpc.io/ |
...
| **zoxide** | 0.9.3 | A faster way to navigate your filesystem | https://github.com/ajeetdsouza/zoxide |
