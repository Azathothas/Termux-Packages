...
| **angle-android** | 2.1.24318-9dd69aae-1 | A conformant OpenGL ES implementation for Windows, Mac, Linux, iOS and Android | https://chromium.googlesource.com/angle/angle |
...
| **aubio** | 0.4.9-3 | A library to label music and sounds | https://aubio.org/ |
| **aubio-static** | 0.4.9-3 | Static libraries for aubio | https://aubio.org/ |
...
| **chezmoi** | 2.55.0 | Manage your dotfiles across multiple machines | https://chezmoi.io |
...
| **clang** | 19.1.4 | C language frontend for LLVM | https://clang.llvm.org/ |
...
| **croc** | 1:10.1.1 | Easily and securely send things from one computer to another | https://github.com/schollz/croc |
...
| **emscripten** | 3.1.73 | Emscripten: An LLVM-to-WebAssembly Compiler | https://emscripten.org |
| **emscripten-binaryen** | 3.1.73 | Emscripten-compatible Binaryen | https://emscripten.org |
| **emscripten-llvm** | 3.1.73 | Emscripten-compatible LLVM | https://emscripten.org |
| **emscripten-tests-third-party** | 3.1.73 | Emscripten third party test suite files | https://emscripten.org |
...
| **exiftool** | 13.06 | Utility for reading, writing and editing meta information in a wide variety of files. | https://exiftool.org/ |
...
| **eza** | 0.20.11 | A modern replacement for ls | https://github.com/eza-community/eza |
...
| **forgejo** | 9.0.2 | Forgejo is a self-hosted lightweight software forge. | https://forgejo.org/ |
...
| **fzf** | 0.56.3 | Command-line fuzzy finder | https://junegunn.github.io/fzf/ |
...
| **gitea** | 1.22.4 | Git with a cup of tea, painless self-hosted git service | https://gitea.io |
...
| **goose** | 3.23.0 | A database migration tool. Supports SQL migrations and Go functions. | https://pressly.github.io/goose |
...
| **gst-libav** | 1.24.10 | GStreamer Libav plug-in contains one plugin with a set of elements using the Libav library code | https://gstreamer.freedesktop.org/modules/gst-libav.html |
...
| **haproxy** | 3.1.0 | The Reliable, High Performance TCP/HTTP Load Balancer | https://www.haproxy.org/ |
...
| **jq-lsp** | 0.1.9 | jq language server | https://github.com/wader/jq-lsp |
...
| **lesspipe** | 2.16 | An input filter for the pager less | http://www-zeuthen.desy.de/~friebel/unix/lesspipe.html |
...
| **libcompiler-rt** | 19.1.4 | Compiler runtime libraries for clang | https://clang.llvm.org/ |
...
| **libllvm** | 19.1.4 | Modular compiler and toolchain technologies library | https://clang.llvm.org/ |
| **libllvm-static** | 19.1.4 | Static libraries for libllvm | https://clang.llvm.org/ |
...
| **libmediainfo** | 24.11 | Library for reading information from media files | https://mediaarea.net/en/MediaInfo |
| **libmediainfo-static** | 24.11 | Static libraries for libmediainfo | https://mediaarea.net/en/MediaInfo |
...
| **libpolly** | 19.1.4 | High-level loop and data-locality optimizer for clang | https://clang.llvm.org/ |
...
| **libsqlite** | 3.47.1 | Library implementing a self-contained and transactional SQL database engine | https://www.sqlite.org |
| **libsqlite-static** | 3.47.1 | Static libraries for libsqlite | https://www.sqlite.org |
| **libsqlite-tcl** | 3.47.1 | tcl bindings for SQLite | https://www.sqlite.org |
...
| **lld** | 19.1.4 | LLVM-based linker | https://clang.llvm.org/ |
| **llvm** | 19.1.4 | LLVM modular compiler and toolchain executables | https://clang.llvm.org/ |
...
| **llvm-tools** | 19.1.4 | LLVM Development Tools | https://clang.llvm.org/ |
| **llvmgold** | 19.1.4 | LLVM gold plugin | https://clang.llvm.org/ |
...
| **lowdown** | 1.3.0 | Markdown utilities and library (fork of hoedown -> sundown -> libsoldout) | https://kristaps.bsd.lv/lowdown |
| **lowdown-static** | 1.3.0 | Static libraries for lowdown | https://kristaps.bsd.lv/lowdown |
...
| **matplotlib** | 3.9.3 | A comprehensive library for creating static, animated, and interactive visualizations in Python | https://matplotlib.org/ |
...
| **mautrix-whatsapp** | 0.11.1 | A Matrix-WhatsApp puppeting bridge | https://maunium.net/go/mautrix-whatsapp/ |
...
| **mdbook-katex** | 0.9.1 | A preprocessor for mdBook, pre-rendering LaTex equations to HTML at build time | https://github.com/lzanini/mdbook-katex |
...
| **mediainfo** | 24.11 | Command-line utility for reading information from media files | https://mediaarea.net/en/MediaInfo |
...
| **minio** | 2024.11.07.00.52.20 | Multi-Cloud Object Storage | https://min.io/ |
...
| **mlir** | 19.1.4 | A Multi-Level Intermediate Representation for compilers from LLVM | https://clang.llvm.org/ |
...
| **mpd** | 0.23.16 | Music player daemon | https://www.musicpd.org |
...
| **mpg123** | 1.32.9 | Fast console MPEG Audio Player and decoder library | https://mpg123.org/ |
| **mpg123-static** | 1.32.9 | Static libraries for mpg123 | https://mpg123.org/ |
...
| **mu** | 1.12.7 | Maildir indexer/searcher and Emacs client (mu4e) | https://www.djcbsoftware.nl/code/mu/ |
...
| **mympd** | 18.2.2 | A standalone and lightweight web-based MPD client | https://jcorporation.github.io/myMPD/ |
...
| **ncspot** | 1.2.1 | An ncurses Spotify client written in Rust | https://github.com/hrkfdn/ncspot |
...
| **nodejs** | 22.8.0-1 | Open Source, cross-platform JavaScript runtime environment | https://nodejs.org/ |
...
| **o-editor** | 2.68.4 | Small, fast and limited text editor | https://github.com/xyproto/o |
...
| **oh-my-posh** | 24.11.4 | A prompt theme engine for any shell. | https://ohmyposh.dev |
...
| **pet** | 1.0.0 | Simple command-line snippet manager | https://github.com/knqyf263/pet |
...
| **python-apsw** | 3.47.1.0 | Another Python SQLite Wrapper | https://github.com/rogerbinns/apsw/ |
| **python-apt** | 2.9.2 | Python bindings for APT | https://apt-team.pages.debian.net/python-apt/ |
...
| **rabbitmq-server** | 4.0.4 | Feature rich, multi-protocol messaging and streaming broker | https://github.com/rabbitmq/rabbitmq-server |
...
| **railway-cli** | 3.19.1 | This is the command line interface for Railway | https://railway.app |
...
| **re2c** | 4.0.1 | Lexer generator for C, C++ and Go. | https://re2c.org/ |
...
| **remind** | 1:05.01.01 | Sophisticated calendar and alarm program | https://dianne.skoll.ca/projects/remind/ |
...
| **rsgain** | 3.5.3 | A simple audio normalizazion utility | https://github.com/complexlogic/rsgain |
...
| **rust** | 1.83.0-1 | Systems programming language focused on safety, speed and concurrency | https://www.rust-lang.org/ |
| **rust-analyzer** | 20241202 | A Rust compiler front-end for IDEs | https://github.com/rust-lang/rust-analyzer |
...
| **rust-docs** | 1.83.0-1 | Rust documentation | https://www.rust-lang.org/ |
| **rust-src** | 1.83.0-1 | Rust source code files | https://www.rust-lang.org/ |
| **rust-std-aarch64-linux-android** | 1.83.0-1 | Rust std for target aarch64-linux-android | https://www.rust-lang.org/ |
| **rust-std-armv7-linux-androideabi** | 1.83.0-1 | Rust std for target armv7-linux-androideabi | https://www.rust-lang.org/ |
| **rust-std-i686-linux-android** | 1.83.0-1 | Rust std for target i686-linux-android | https://www.rust-lang.org/ |
| **rust-std-wasm32-unknown-unknown** | 1.83.0-1 | Rust std for target wasm32-unknown-unknown | https://www.rust-lang.org/ |
| **rust-std-wasm32-wasi** | 1.83.0-1 | Rust std for target wasm32-wasi | https://www.rust-lang.org/ |
| **rust-std-wasm32-wasip1** | 1.83.0-1 | Rust std for target wasm32-wasip1 | https://www.rust-lang.org/ |
| **rust-std-wasm32-wasip2** | 1.83.0-1 | Rust std for target wasm32-wasip2 | https://www.rust-lang.org/ |
| **rust-std-x86-64-linux-android** | 1.83.0-1 | Rust std for target x86_64-linux-android | https://www.rust-lang.org/ |
| **rustc-dev** | 1.83.0-1 | Rust compiler development libs | https://www.rust-lang.org/ |
| **rustc-src** | 1.83.0-1 | Rust compiler source code files | https://www.rust-lang.org/ |
...
| **simdjson** | 3.11.0 | A C++ library to see how fast we can parse JSON with complete validation | https://simdjson.org/ |
...
| **socat** | 1.8.0.1 | Relay for bidirectional data transfer between two independent data channels | http://www.dest-unreach.org/socat/ |
...
| **sqlite** | 3.47.1 | Command line shell for SQLite | https://www.sqlite.org |
...
| **stylua** | 2.0.1 | An opinionated Lua code formatter | https://github.com/JohnnyMorganz/StyLua |
...
| **subversion-perl-static** | 1.14.4 | Static libraries for subversion-perl | https://subversion.apache.org |
| **subversion-static** | 1.14.4 | Static libraries for subversion | https://subversion.apache.org |
...
| **teleport-tsh** | 17.0.4 | Secure Access for Developers that doesn't get in the way | https://github.com/gravitational/teleport |
...
| **termux-tools** | 1.44.4 | Basic system tools for Termux | https://termux.dev/ |
...
| **tree-sitter** | 0.24.4 | An incremental parsing system for programming tools | https://github.com/tree-sitter/tree-sitter |
| **tree-sitter-c** | 0.23.2 | C grammar for tree-sitter | https://github.com/tree-sitter |
...
| **tree-sitter-static** | 0.24.4 | Static libraries for tree-sitter | https://github.com/tree-sitter/tree-sitter |
...
| **uv** | 0.5.6 | An extremely fast Python package installer and resolver, written in Rust. | https://docs.astral.sh/uv/ |
...
| **vim** | 9.1.0900 | Vi IMproved - enhanced vi editor | https://www.vim.org |
...
| **vulkan-headers** | 1.4.303 | Vulkan Header files and API registry | https://github.com/KhronosGroup/Vulkan-Headers |
...
| **vulkan-loader-generic** | 1.4.303 | Vulkan Loader | https://github.com/KhronosGroup/Vulkan-Loader |
| **vulkan-tools** | 1.4.303 | Vulkan Tools and Utilities | https://github.com/KhronosGroup/Vulkan-Tools |
| **vulkan-utility-libraries** | 1.4.303 | Utility Libraries for Vulkan | https://github.com/KhronosGroup/Vulkan-Utility-Libraries |
...
| **xmake** | 2.9.6 | A cross-platform build utility based on Lua | https://xmake.io/ |
...
| **xxd** | 9.1.0900 | Hexdump utility from vim | https://www.vim.org |
...
| **yosys** | 0.47 | A framework for RTL synthesis tools | https://yosyshq.net/yosys/ |
| **youtubedr** | 2.10.1 | Download youtube video in Golang | https://github.com/kkdai/youtube |
| **yq** | 4.44.5 | A lightweight and portable command-line YAML, JSON and XML processor | https://mikefarah.gitbook.io/yq/ |
...
| **zrok** | 0.4.44 | An open source sharing solution built on OpenZiti. | https://zrok.io/ |
