...
| **bash** | 5.2.32 | A sh-compatible shell that incorporates useful features from the Korn shell (ksh) and C shell (csh) | https://www.gnu.org/software/bash/ |
...
| **bc-gh** | 7.0.2 | Unix dc and POSIX bc with GNU and BSD extensions | https://git.gavinhoward.com/gavin/bc |
...
| **binutils** | 2.43 | GNU Binutils (metapackage) | https://www.gnu.org/software/binutils/ |
| **binutils-bin** | 2.43 | Collection of binary tools, the main ones being ld, the GNU linker, and as, the GNU assembler | https://www.gnu.org/software/binutils/ |
| **binutils-cross** | 2.43 | GNU Binutils for cross build on the host (NOT for Termux) | https://www.gnu.org/software/binutils/ |
| **binutils-gold** | 2.43 | gold linker | https://www.gnu.org/software/binutils/ |
| **binutils-is-llvm** | 0.3-3 | Use llvm as binutils | https://github.com/trentbuck/binutils-is-llvm |
| **binutils-libs** | 2.43 | GNU Binutils libraries | https://www.gnu.org/software/binutils/ |
...
| **bitcoin** | 27.1 | Bitcoin Core | https://bitcoincore.org/ |
...
| **blk-utils** | 2.40.2 | Utilities for handling block device attributes | https://en.wikipedia.org/wiki/Util-linux |
...
| **c-ares** | 1.33.1 | Library for asynchronous DNS requests (including name resolves) | https://c-ares.haxx.se |
...
| **ccache** | 4.10.2 | Compiler cache for fast recompilation of C/C++ code | https://ccache.samba.org |
...
| **chezmoi** | 2.52.2 | Manage your dotfiles across multiple machines | https://chezmoi.io |
...
| **chrony** | 4.6 | chrony is an implementation of the Network Time Protocol (NTP) | https://chrony-project.org/ |
...
| **clifm** | 1.20 | The shell-like, command line terminal file manager: simple, fast, extensible, and lightweight as hell | https://github.com/leo-arch/clifm |
...
| **clvk** | 0.0.20240813.131531 | Experimental implementation of OpenCL on Vulkan | https://github.com/kpet/clvk |
...
| **command-not-found** | 2.4.0-43 | Suggest installation of packages in interactive shell sessions | https://github.com/termux/command-not-found |
...
| **coreutils** | 9.5-1 | Basic file, shell and text manipulation utilities from the GNU project | https://www.gnu.org/software/coreutils/ |
...
| **crawl** | 0.32.0 | Roguelike adventure through dungeons filled with dangerous monsters | https://crawl.develz.org/ |
...
| **curl** | 8.10.1 | Command line tool for transferring data with URL syntax | https://curl.se/ |
...
| **duckdb** | 1.1.0 | DuckDB Command Line Interface (CLI) shell | https://duckdb.org/ |
...
| **emscripten** | 3.1.67 | Emscripten: An LLVM-to-WebAssembly Compiler | https://emscripten.org |
| **emscripten-binaryen** | 3.1.67 | Emscripten-compatible Binaryen | https://emscripten.org |
| **emscripten-llvm** | 3.1.67 | Emscripten-compatible LLVM | https://emscripten.org |
| **emscripten-tests-third-party** | 3.1.67 | Emscripten third party test suite files | https://emscripten.org |
...
| **exiftool** | 12.96 | Utility for reading, writing and editing meta information in a wide variety of files. | https://exiftool.org/ |
...
| **eza** | 0.19.4 | A modern replacement for ls | https://github.com/eza-community/eza |
...
| **fastfetch** | 2.25.0 | A neofetch-like tool for fetching system information and displaying them in a pretty way | https://github.com/fastfetch-cli/fastfetch |
...
| **fdisk** | 2.40.2 | Utilities to manipulate disk partition tables | https://en.wikipedia.org/wiki/Util-linux |
...
| **fetchmail** | 6.4.39 | A remote-mail retrieval utility | https://www.fetchmail.info/ |
| **fetchmailconf** | 6.4.39 | A GUI configurator for generating fetchmail configuration files | https://www.fetchmail.info/ |
...
| **gdb** | 15.1 | The standard GNU Debugger that runs on many Unix-like systems and works for many programming languages | https://www.gnu.org/software/gdb/ |
...
| **gdbserver** | 15.1 | The gdbserver program | https://www.gnu.org/software/gdb/ |
...
| **geth** | 1.14.9 | Go implementation of the Ethereum protocol | https://geth.ethereum.org/ |
| **geth-utils** | 1.14.9 | Additional utilities for Geth (like abigen, bootnode, evm, puppeth) | https://geth.ethereum.org/ |
...
| **gh** | 2.57.0 | GitHub’s official command line tool | https://cli.github.com/ |
...
| **git** | 2.46.1 | Fast, scalable, distributed revision control system | https://git-scm.com/ |
...
| **git-gitk** | 2.46.1 | Git repository browser | https://git-scm.com/ |
| **git-gui** | 2.46.1 | A graphical interface to Git | https://git-scm.com/ |
...
| **git-svn** | 2.46.1 | Convert between Git and Subversion repositories | https://git-scm.com/ |
...
| **glab-cli** | 1.46.1 | A GitLab CLI tool bringing GitLab to your command line | https://gitlab.com/gitlab-org/cli |
| **gleam** | 1.5.0 | A friendly language for building type-safe, scalable systems! | https://gleam.run |
| **glib** | 2.80.5 | Library providing core building blocks for libraries and applications written in C | https://developer.gnome.org/glib/ |
| **glib-bin** | 2.80.5 | Programs for the GLib library | https://developer.gnome.org/glib/ |
| **glib-cross** | 2.80.5 | glib for host (NOT for Termux) | https://developer.gnome.org/glib/ |
...
| **golang** | 3:1.23.1 | Go programming language compiler | https://golang.org/ |
| **golang-doc** | 3:1.23.1 | Go programming language - documentation | https://golang.org/ |
...
| **gradle** | 1:8.10.1 | Powerful build system for the JVM | https://gradle.org/ |
...
| **graphviz** | 12.1.1 | Rich set of graph drawing tools | https://www.graphviz.org/ |
| **graphviz-static** | 12.1.1 | Static libraries for graphviz | https://www.graphviz.org/ |
...
| **groonga** | 14.0.7-1 | An embeddable fulltext search engine | https://github.com/groonga/groonga/ |
...
| **gst-python** | 1.24.8 | Python bindings for GStreamer | https://gstreamer.freedesktop.org/ |
...
| **harfbuzz** | 9.0.0 | OpenType text shaping engine | https://www.freedesktop.org/wiki/Software/HarfBuzz/ |
| **harfbuzz-icu** | 9.0.0 | OpenType text shaping engine ICU backend | https://www.freedesktop.org/wiki/Software/HarfBuzz/ |
| **harfbuzz-utils** | 9.0.0 | Tools using the harfbuzz library | https://www.freedesktop.org/wiki/Software/HarfBuzz/ |
...
| **hugo** | 0.134.3 | A fast and flexible static site generator | https://gohugo.io/ |
...
| **i2pd** | 2.53.1 | A full-featured C++ implementation of the I2P router | https://i2pd.website/ |
| **i2pd-static** | 2.53.1 | Static libraries for i2pd | https://i2pd.website/ |
...
| **imagemagick** | 7.1.1.38-1 | Suite to create, edit, compose, or convert images in a variety of formats | https://www.imagemagick.org/ |
| **imagemagick-static** | 7.1.1.38-1 | Static libraries for imagemagick | https://www.imagemagick.org/ |
...
| **jfrog-cli** | 2.68.0 | A CLI for JFrog products | https://jfrog.com/getcli |
...
| **kubelogin** | 1.30.0 | A kubectl plugin for Kubernetes OpenID Connect (OIDC) authentication | https://github.com/int128/kubelogin |
...
| **lesspipe** | 2.14 | An input filter for the pager less | http://www-zeuthen.desy.de/~friebel/unix/lesspipe.html |
...
| **libarchive** | 3.7.5 | Multi-format archive and compression library | https://www.libarchive.org/ |
| **libarchive-static** | 3.7.5 | Static libraries for libarchive | https://www.libarchive.org/ |
...
| **libblkid** | 2.40.2 | Block device identification library | https://en.wikipedia.org/wiki/Util-linux |
...
| **libcurl** | 8.10.1 | Easy-to-use client-side URL transfer library | https://curl.se/ |
| **libcurl-static** | 8.10.1 | Static libraries for libcurl | https://curl.se/ |
...
| **libduckdb** | 1.1.0 | An in-process SQL OLAP database management system | https://duckdb.org/ |
| **libduckdb-static** | 1.1.0 | Static libraries for libduckdb | https://duckdb.org/ |
...
| **libfdisk** | 2.40.2 | Library for manipulating disk partition tables | https://en.wikipedia.org/wiki/Util-linux |
...
| **libgnt** | 2.14.3-3 | An ncurses toolkit for creating text-mode graphical user interfaces in a fast and easy way | https://keep.imfreedom.org/libgnt/libgnt |
...
| **libluajit** | 1:2.1.1725453128 | Just-In-Time Compiler for Lua | https://luajit.org/ |
| **libluajit-static** | 1:2.1.1725453128 | Static libraries for libluajit | https://luajit.org/ |
...
| **libmount** | 2.40.2 | Library for (un)mounting filesystems | https://en.wikipedia.org/wiki/Util-linux |
...
| **libnftnl** | 1.2.7 | Netfilter library providing interface to the nf_tables subsystem | https://www.netfilter.org/projects/libnftnl/ |
...
| **libsmartcols** | 2.40.2 | Library for smart adaptive formatting of tabular data | https://en.wikipedia.org/wiki/Util-linux |
...
| **libtsduck** | 3.38.3822 | An extensible toolkit for MPEG transport streams | https://tsduck.io/ |
| **libtsduck-static** | 3.38.3822 | Static libraries for libtsduck | https://tsduck.io/ |
...
| **libunbound** | 1.21.0 | A validating, recursive, caching DNS resolver | https://unbound.net/ |
| **libunbound-static** | 1.21.0 | Static libraries for libunbound | https://unbound.net/ |
...
| **libuuid** | 2.40.2 | Library for handling universally unique identifiers | https://en.wikipedia.org/wiki/Util-linux |
...
| **lua-language-server** | 3.10.6 | Sumneko Lua Language Server coded in Lua | https://github.com/sumneko/lua-language-server |
...
| **luajit** | 1:2.1.1725453128 | Just-In-Time compiler for Lua - command line tool | https://luajit.org/ |
...
| **mesa-dev** | 24.0.8 | Mesa's OpenGL headers | https://www.mesa3d.org |
...
| **miniflux** | 2.2.0 | A minimalist and opinionated feed reader | https://miniflux.app/ |
| **minimodem** | 0.24-1-0 | General-purpose software audio FSK modem | http://www.whence.com/minimodem/ |
| **minio** | 2024.09.13.20.26.02 | Multi-Cloud Object Storage | https://min.io/ |
...
| **mold** | 2.33.0 | mold: A Modern Linker | https://github.com/rui314/mold |
...
| **mount-utils** | 2.40.2 | Utilities for (un)mounting filesystems | https://en.wikipedia.org/wiki/Util-linux |
...
| **mpd** | 0.23.15-2 | Music player daemon | https://www.musicpd.org |
...
| **mpv** | 0.38.0-1 | Command-line media player | https://mpv.io/ |
...
| **navidrome** | 0.53.1 | 🎧☁️ Modern Music Server and Streamer compatible with Subsonic/Airsonic | https://www.navidrome.org/ |
...
| **ncurses** | 6.5.20240831 | Library for text-based user interfaces in a terminal-independent manner | https://invisible-island.net/ncurses/ |
| **ncurses-static** | 6.5.20240831 | Static libraries for ncurses | https://invisible-island.net/ncurses/ |
...
| **neocmakelsp** | 0.8.5 | a cmake lsp based on tower-lsp and treesitter | https://github.com/Decodetalkers/neocmakelsp |
...
| **newsboat** | 2.36 | RSS/Atom feed reader for the text console | https://newsboat.org/ |
| **nginx** | 1.27.1 | Lightweight HTTP server | https://www.nginx.org |
...
| **nushell** | 0.98.0 | A new type of shell operating on structured data | https://www.nushell.sh |
...
| **oh-my-posh** | 23.14.1 | A prompt theme engine for any shell. | https://ohmyposh.dev |
...
| **open-adventure** | 1.19 | Forward-port of the original Colossal Cave Adventure from 1976-77 | http://www.catb.org/~esr/open-adventure/ |
...
| **openjdk-17** | 17.0-35 | Java development kit and runtime | https://github.com/openjdk/mobile |
| **openjdk-17-source** | 17.0-35 | Source files for openjdk-17 | https://github.com/openjdk/mobile |
| **openjdk-17-x** | 17.0-35 | Portion of openjdk-17 requiring X11 functionality | https://github.com/openjdk/mobile |
...
| **openssh** | 9.9p1-2 | Secure shell for logging into a remote machine | https://www.openssh.com/ |
| **openssh-sftp-server** | 9.9p1-2 | OpenSSH SFTP server subsystem | https://www.openssh.com/ |
...
| **osmesa** | 24.0.8 | Mesa Off-screen Rendering Library | https://www.mesa3d.org |
...
| **pari** | 2.15.5 | A computer algebra system designed for fast computations in number theory | https://pari.math.u-bordeaux.fr/ |
| **pari-static** | 2.15.5 | Static libraries for pari | https://pari.math.u-bordeaux.fr/ |
...
| **pgroonga** | 3.2.2 | A PostgreSQL extension to use Groonga as index | https://github.com/pgroonga/pgroonga |
...
| **php-redis** | 6.1.0RC1 | PHP extension for interfacing with Redis | https://github.com/phpredis/phpredis |
...
| **postgis** | 3.4.3 | Spatial database extender for PostgreSQL object-relational database | https://postgis.net |
...
| **profanity** | 0.14.0-1 | Profanity is a console based XMPP client written in C using ncurses and libstrophe, inspired by Irssi | https://profanity-im.github.io |
...
| **python** | 3.11.9-5 | Python 3 programming language intended to enable clear programs | https://python.org/ |
| **python-apsw** | 3.46.1.0 | Another Python SQLite Wrapper | https://github.com/rogerbinns/apsw/ |
| **python-apt** | 2.9.0 | Python bindings for APT | https://apt-team.pages.debian.net/python-apt/ |
| **python-bcrypt** | 4.2.0 | Acceptable password hashing for your software and your servers | https://github.com/pyca/bcrypt |
| **python-contourpy** | 1.2.1 | Python library for calculating contours in 2D quadrilateral grids | https://contourpy.readthedocs.io/ |
...
| **python-greenlet** | 3.1.1 | Lightweight coroutines for in-process concurrent programming | https://github.com/python-greenlet/greenlet |
...
| **python-onnxruntime** | 1.19.0-1 | Cross-platform, high performance ML inferencing and training accelerator | https://onnxruntime.ai/ |
...
| **python-static** | 3.11.9-5 | Static libraries for python | https://python.org/ |
| **python-tkinter** | 3.11.9-5 | Tkinter support for Python 3 | https://python.org/ |
...
| **railway-cli** | 3.14.1 | This is the command line interface for Railway | https://railway.app |
...
| **rclone** | 1.68.0 | rsync for cloud storage | https://rclone.org/ |
...
| **recoll** | 1.40.1 | Full-text search for your desktop | https://www.recoll.org/ |
| **recoll-python** | 1.40.1 | Python interface for Recoll | https://www.recoll.org/ |
...
| **rsgain** | 3.5.2 | A simple audio normalizazion utility | https://github.com/complexlogic/rsgain |
...
| **rtorrent** | 0.9.8-3 | Ncurses BitTorrent client based on libTorrent | https://rakshasa.github.io/rtorrent/ |
...
| **ruff** | 0.6.7 | An extremely fast Python linter, written in Rust | https://github.com/charliermarsh/ruff |
...
| **rust** | 1.81.0 | Systems programming language focused on safety, speed and concurrency | https://www.rust-lang.org/ |
| **rust-analyzer** | 20240916 | A Rust compiler front-end for IDEs | https://github.com/rust-lang/rust-analyzer |
...
| **rust-docs** | 1.81.0 | Rust documentation | https://www.rust-lang.org/ |
| **rust-src** | 1.81.0 | Rust source code files | https://www.rust-lang.org/ |
| **rust-std-aarch64-linux-android** | 1.81.0 | Rust std for target aarch64-linux-android | https://www.rust-lang.org/ |
| **rust-std-armv7-linux-androideabi** | 1.81.0 | Rust std for target armv7-linux-androideabi | https://www.rust-lang.org/ |
| **rust-std-i686-linux-android** | 1.81.0 | Rust std for target i686-linux-android | https://www.rust-lang.org/ |
| **rust-std-wasm32-unknown-unknown** | 1.81.0 | Rust std for target wasm32-unknown-unknown | https://www.rust-lang.org/ |
| **rust-std-wasm32-wasi** | 1.81.0 | Rust std for target wasm32-wasi | https://www.rust-lang.org/ |
| **rust-std-wasm32-wasip1** | 1.81.0 | Rust std for target wasm32-wasip1 | https://www.rust-lang.org/ |
| **rust-std-wasm32-wasip2** | 1.81.0 | Rust std for target wasm32-wasip2 | https://www.rust-lang.org/ |
| **rust-std-x86-64-linux-android** | 1.81.0 | Rust std for target x86_64-linux-android | https://www.rust-lang.org/ |
| **rustc-dev** | 1.81.0 | Rust compiler development libs | https://www.rust-lang.org/ |
| **rustc-src** | 1.81.0 | Rust compiler source code files | https://www.rust-lang.org/ |
...
| **scc** | 3.3.5 | Counts physical the lines of code, blank lines, comment lines, and physical lines of source code | https://github.com/boyter/scc |
| **sccache** | 0.8.1 | sccache is ccache with cloud storage | https://github.com/mozilla/sccache |
...
| **seanime** | 2.1.1-1 | Self-hosted anime and manga server for sea rovers. | https://github.com/5rahim/seanime |
...
| **shaderc** | 2024.2 | Collection of tools, libraries, and tests for Vulkan shader compilation | https://github.com/google/shaderc |
...
| **silicon** | 0.5.2-1 | Silicon is an alternative to Carbon implemented in Rust | https://github.com/Aloxaf/silicon |
...
| **sing-box** | 1.9.6 | The universal proxy platform | https://sing-box.sagernet.org |
...
| **solidity** | 0.8.27 | An Ethereum smart contract-oriented language | https://solidity.readthedocs.io |
...
| **squid** | 6.11 | Full-featured Web proxy cache server | http://www.squid-cache.org |
...
| **storj-uplink** | 1.111.4 | Storj DCS Uplink CLI | https://www.storj.io/integrations/uplink-cli |
...
| **swi-prolog** | 9.3.11 | Most popular and complete prolog implementation | https://swi-prolog.org/ |
...
| **tdl** | 0.17.4 | Telegram downloader/tools written in Golang | https://docs.iyear.me/tdl/ |
...
| **teleport-tsh** | 16.4.0 | Secure Access for Developers that doesn't get in the way | https://github.com/gravitational/teleport |
...
| **termux-auth** | 1.4.1 | Password authentication library and utility for Termux | https://github.com/termux/termux-auth |
...
| **termux-tools** | 1.43.5 | Basic system tools for Termux | https://termux.dev/ |
...
| **tmux** | 3.4 | Terminal multiplexer | https://tmux.github.io/ |
...
| **tree-sitter** | 0.23.0 | An incremental parsing system for programming tools | https://github.com/tree-sitter/tree-sitter |
| **tree-sitter-c** | 0.23.0 | C grammar for tree-sitter | https://github.com/tree-sitter |
| **tree-sitter-c-static** | 0.23.0 | Static libraries for tree-sitter-c | https://github.com/tree-sitter |
...
| **tree-sitter-static** | 0.23.0 | Static libraries for tree-sitter | https://github.com/tree-sitter/tree-sitter |
...
| **tsduck-java** | 3.38.3822 | Java bindings for TSDuck | https://tsduck.io/ |
| **tsduck-plugins** | 3.38.3822 | Plugins for TSDuck | https://tsduck.io/ |
| **tsduck-python** | 3.38.3822 | Python bindings for TSDuck | https://tsduck.io/ |
| **tsduck-tools** | 3.38.3822 | Command line tools for TSDuck | https://tsduck.io/ |
...
| **unbound** | 1.21.0 | Unbound command-line tools | https://unbound.net/ |
...
| **unicorn** | 2.1.0 | Unicorn is a lightweight multi-platform, multi-architecture CPU emulator framework | https://www.unicorn-engine.org/ |
| **unicorn-static** | 2.1.0 | Static libraries for unicorn | https://www.unicorn-engine.org/ |
| **unifdef** | 2.12 | Remove #ifdef'ed lines | http://dotat.at/prog/unifdef/ |
| **units** | 2.23 | Converts between different systems of units | https://www.gnu.org/software/units/ |
| **units-cur** | 2.23 | units_cur Python script | https://www.gnu.org/software/units/ |
...
| **util-linux** | 2.40.2 | Miscellaneous system utilities | https://en.wikipedia.org/wiki/Util-linux |
| **util-linux-static** | 2.40.2 | Static libraries for util-linux | https://en.wikipedia.org/wiki/Util-linux |
| **uucp** | 1.07-1 | The standard UUCP package of the Free Software Foundation | https://www.airs.com/ian/uucp.html |
| **uuid-utils** | 2.40.2 | Utilities for handling universally unique identifiers | https://en.wikipedia.org/wiki/Util-linux |
| **uv** | 0.4.15 | An extremely fast Python package installer and resolver, written in Rust. | https://docs.astral.sh/uv/ |
...
| **viddy** | 1.1.2 | A modern watch command | https://github.com/sachaos/viddy |
...
| **vtm** | 0.9.99.13 | Terminal multiplexer with TUI window manager and multi-party session sharing | https://vtm.netxs.online/ |
...
| **wakatime-cli** | 1.102.0 | Command line interface used by all WakaTime text editor plugins | https://wakatime.com/plugins/ |
...
| **wasmedge** | 0.14.0-2 | A lightweight, high-performance, and extensible WebAssembly runtime | https://wasmedge.org/ |
...
| **weechat** | 4.4.2 | Fast, light and extensible IRC chat client | https://weechat.org/ |
| **weechat-lua-plugin** | 4.4.2 | WeeChat Lua Plugin | https://weechat.org/ |
| **weechat-perl-plugin** | 4.4.2 | WeeChat Perl Plugin | https://weechat.org/ |
| **weechat-python-plugin** | 4.4.2 | WeeChat Python3 Plugin | https://weechat.org/ |
| **weechat-ruby-plugin** | 4.4.2 | WeeChat Ruby Plugin | https://weechat.org/ |
...
| **z3** | 4.13.0-1 | Z3 is a theorem prover from Microsoft Research | https://github.com/Z3Prover/z3 |
...
| **zrok** | 0.4.40 | An open source sharing solution built on OpenZiti. | https://zrok.io/ |
